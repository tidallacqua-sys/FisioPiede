...
const PLANOS_INFO = [
  { nome:"Teste", cor:"#10B981", icon:"🧪", preco:0.99, precoLabel:"R$ 0,99", iaUsos:0, recursos:["Plano de teste de pagamento","Remover após o teste"] }, // TEMPORÁRIO
...
export default function App() {
  ...
  const persistirPedidos = (lista) => {
    ...
    if (!hidratadoRef.current) { LS.write("fp:pedidos", lista, true); return; }
