      ...
      {aba === "ia" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          ...
          <Card hover={false} p={20}>
            ...
            <Btn v="primary" full disabled={imgLoading || !imgPrompt.trim()} onClick={gerarImagem} style={{ background: C.purple }}>{imgLoading ? <><Spin sz={14} /> Gerando imagem (pode levar ~15s)...</> : "🎨 Gerar imagem (10 análises)"}</Btn>
