...
function PedidoModal({pedido,isAdmin,onClose,onUpdate}) {
  ...
  return (
    <Modal onClose={onClose}>
      ...
      {ver3D && <Viewer3D url={ver3D.url} nome={ver3D.nome} ext={ver3D.ext} onClose={()=>setVer3D(null)} />}
    </Modal>
  );
}
...
function Viewer3D({ url, nome, ext, onClose }) {
        ...
        <div style={{ position:"relative", width:"100%", height:380, background:"#0B0E15" }}>
          ...
          {estado==="erro" && (
            <div style={{ position:"absolute", inset:0, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:10, color:C.muted, padding:20, textAlign:"center" }}>
              ...
              <a href={url} download={nome} style={{ fontSize:11, fontWeight:700, color:C.green, textDecoration:"none", background:`${C.green}15`, padding:"6px 12px", borderRadius:8, border:`1px solid ${C.green}30` }}>⬇️ Baixar arquivo</a>
            </div>
          )}
        </div>
