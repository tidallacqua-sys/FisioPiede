              ...
              <Card key={p.id} p={0} hover style={{overflow:"hidden",cursor:"pointer",border:`1px solid ${C.border}`}} onClick={()=>setDetail(p)}>
                ...
                <div style={{padding:15}}>
                  ...
                  <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8,marginTop:10,paddingTop:11,borderTop:`1px solid ${C.border}`}}>
                    ...
                    {hr
                      ? <a href={`https://rastreamento.correios.com.br/app/index.php?objetos=${p.rastreio}`} target="_blank" rel="noreferrer" onClick={e=>e.stopPropagation()} style={{display:"inline-flex",alignItems:"center",gap:4,padding:"3px 9px",borderRadius:7,fontSize:10,fontWeight:700,background:`${C.green}13`,color:C.green,textDecoration:"none",border:`1px solid ${C.green}28`}}>🔗 Rastrear</a>
