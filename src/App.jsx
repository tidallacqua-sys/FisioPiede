...
// 🏭 Catálogo pronto de procedimentos clínicos (a clínica adiciona ao seu menu e ajusta)
const CATALOGO_PROCEDIMENTOS = [
  { id:"baropodometria", nome:"Baropodometria", icon:"🦶", duracao:40, valor:150, protocolo:"Avaliação computadorizada da distribuição de pressão plantar e da pisada." },
  { id:"avaliacaobiomecanica", nome:"Avaliação Biomecânica", icon:"🩺", duracao:60, valor:200, protocolo:"Avaliação postural e biomecânica completa para prescrição de palmilhas." },
  { id:"osteopatia", nome:"Osteopatia", icon:"🦴", duracao:50, valor:180, protocolo:"Avaliação e tratamento manual de disfunções articulares e viscerais." },
  { id:"quiropraxia", nome:"Quiropraxia", icon:"💥", duracao:40, valor:150, protocolo:"Ajustes da coluna e articulações para restaurar mobilidade." },
  { id:"miofascial", nome:"Liberação Miofascial", icon:"🖐️", duracao:50, valor:140, protocolo:"Liberação de restrições da fáscia e pontos-gatilho." },
  { id:"dryneedling", nome:"Dry Needling", icon:"💉", duracao:40, valor:160, protocolo:"Agulhamento a seco de pontos-gatilho miofasciais." },
  { id:"ventosa", nome:"Ventosaterapia", icon:"🟣", duracao:30, valor:120, protocolo:"Aplicação de ventosas para liberação e circulação." },
  { id:"manual", nome:"Terapia Manual", icon:"👐", duracao:50, valor:150, protocolo:"Técnicas manuais de mobilização e manipulação." },
  { id:"rpg", nome:"RPG", icon:"🧍", duracao:60, valor:170, protocolo:"Reeducação Postural Global — cadeias musculares." },
  { id:"pilates", nome:"Pilates Clínico", icon:"🤸", duracao:50, valor:130, protocolo:"Exercícios de controle, força e postura." },
  { id:"acupuntura", nome:"Acupuntura", icon:"📍", duracao:50, valor:160, protocolo:"Estimulação de pontos para alívio de dor e equilíbrio." },
  { id:"eletro", nome:"Eletroterapia", icon:"⚡", duracao:30, valor:90, protocolo:"TENS, ultrassom e correntes analésicas." },
];

// 📋 Modelos prontos de plano de tratamento (o fisioterapeuta escolhe e ajusta)
const MODELOS_PLANO = [
  { id:"fascite", nome:"Fascite Plantar", icon:"🦶", sessoes:8, reavaliacoes:2, palmilha:true,
    desc:"Protocolo para fascite plantar: liberação de cadeia posterior, fortalecimento e palmilha." },
  { id:"esporao", nome:"Esporão de Calcâneo", icon:"📌", sessoes:10, reavaliacoes:2, palmilha:true,
    desc:"Alívio de pressão no calcâneo, terapia manual e palmilha com descarga." },
  { id:"metatarsalgia", nome:"Metatarsalgia", icon:"👟", sessoes:6, reavaliacoes:1, palmilha:true,
    desc:"Redistribuição de carga no antepé, barra retrocapital e exercícios." },
  { id:"joanete", nome:"Joanete (Hálux Valgo)", icon:"🦶", sessoes:8, reavaliacoes:2, palmilha:true,
    desc:"Mobilização do hálux, fortalecimento intrínseco e órtese." },
  { id:"posturalgeral", nome:"Reeducação Postural", icon:"🧍", sessoes:12, reavaliacoes:3, palmilha:true,
    desc:"Correção postural global com palmilha postural e exercícios." },
  { id:"esportivo", nome:"Atleta / Corredor", icon:"🏃", sessoes:6, reavaliacoes:2, palmilha:true,
    desc:"Prevenção de lesões e performance para corredores." },
];
...
const ACADEMY_CURSOS = [
  ...
  {
    id:"avaliacaoclinica", titulo:"Avaliação Clínica Passo a Passo", trilha:"Avaliação Clínica",
    nivel:"Intermediário", cor:"#EC4899", icon:"🩺", obrigatorio:true, horas:10,
    desc:"O roteiro completo de avaliação do paciente para prescrição de palmilhas: anamnese, palpação, testes de mobilidade, avaliação em decúbito e em pé, marcha, testes ortopédicos e posturológicos, teste com elementos e o fechamento do tratamento. Baseado no protocolo clínico FisioPiede.",
    modulos:[
      { titulo:"Anamnese e Avaliação Inicial", aulas:[
        { t:"A consulta de avaliação: visão geral", txt:"A avaliação para palmilhas segue uma sequência lógica: anamnese, exame em decúbito dorsal (DD), exame em pé, marcha e testes específicos. O objetivo é identificar a origem biomecânica da queixa, não apenas o sintoma. Cada etapa adiciona uma peça ao raciocínio clínico que vai definir os elementos da palmilha." },
        { t:"Anamnese direcionada", txt:"Investigue a queixa principal (onde dói, quando começou, o que piora/melhora), hábitos (atividade física, calçados, profissão), histórico de lesões e cirurgias. Pergunte sobre dor em outras regiões da cadeia (joelho, quadril, coluna) — muitas vezes a origem está no pé. Uma boa anamnese direciona todo o exame físico seguinte." },
      ]},
      { titulo:"Exame em Decúbito Dorsal (DD)", aulas:[
        { t:"Palpação óssea", txt:"Com o paciente deitado, palpe as estruturas ósseas: cabeças dos metatarsos, base do 5º metatarso, maléolos, naviculartuberosidade. Identifique pontos dolorosos e proeminências. A palpação óssea localiza sobrecargas e orienta onde a palmilha precisará de alívio (descarga)." },
        { t:"Palpação muscular: panturrilha e plantares", txt:"Palpe a musculatura da panturrilha (gêmeos e sóleo) e a fáscia plantar. Tensão ou dor à palpação da cadeia posterior é achado frequente na fascite plantar e em pés com sobrecarga de antepé. Encurtamento da cadeia posterior é alvo de alongamento no tratamento." },
        { t:"Mobilidade em dorsiflexão e plantiflexão", txt:"Avalie a amplitude de movimento do tornozelo em dorsiflexão e plantiflexão. Déficit de dorsiflexão (menos de ~10°) sobrecarrega o antepé e altera a marcha, podendo exigir compensação na palmilha e alongamento da cadeia posterior." },
        { t:"Mobilidade do hálux", txt:"Teste a extensão do hálux (1ª articulação metatarsofalângica). A restrição (hallux limitus/rigidus) compromete a fase de propulsão da marcha. É um achado que muda a estratégia da palmilha (ex: barra retrocapital para poupar a articulação)." },
        { t:"Teste neural", txt:"Testes neurais básicos (sensibilidade, reflexos) ajudam a descartar componente neurológico na queixa. Importante diferenciar dor mecânica de dor neuroprática, pois a conduta muda completamente." },
        { t:"Altura de maléolos e dismetria", txt:"Compare a altura dos maléolos e use o teste em flexão de joelhos para investigar dismetria de membros inferiores. Diferenças de comprimento real ou funcional impactam a postura global e podem ser compensadas com elementos na palmilha." },
      ]},
      { titulo:"Exame em Pé (Ortostatismo)", aulas:[
        { t:"Avaliação com laser e pêndulo", txt:"Em pé, use referências verticais (laser ou fio de pêndulo) para avaliar o alinhamento postural global: cabeça, ombros, pelve, joelhos e pés. Desvios do eixo revelam compensações das cadeias e ajudam a conectar a queixa do pé ao restante do corpo." },
        { t:"Cristas ilíacas e nivelamento pélvico", txt:"Palpe as cristas ilíacas para avaliar o nivelamento da pelve. Uma báscula pélvica pode ter origem em dismetria, escoliose ou compensação ascendente de um pé pronado. Esse achado é chave na decisão de corrigir ou não no nível do pé." },
        { t:"Avaliação postural do pé", txt:"Observe o pé em carga: tipo de arco (normal, plano/cavo), posição do retropé (valgo/varo), antepé e dedos. Classifique o padrão de pisada. Essa fotografia do pé em pé é a base para definir o suporte de arco e as cunhas da palmilha." },
      ]},
      { titulo:"Marcha e Baropodometria", aulas:[
        { t:"Análise da marcha", txt:"Observe o paciente caminhando: contato do calcâneo, médio apoio, propulsão. Procure por pronel/supinação excessiva, rotações e assimetrias entre os lados. A marcha dinâmica revela o que o exame estático não mostra e confirma as hipóteses." },
        { t:"Baropodometria como apoio", txt:"A baropodometria quantifica objetivamente a distribuição de carga e os picos de pressão, validando os achados clínicos. Use-a como evidência para o paciente e como mapa para posicionar descargas e elementos na palmilha." },
      ]},
      { titulo:"Testes Ortopédicos", aulas:[
        { t:"Pé desabado: Drop Test (Navicular Drop)", txt:"O Navicular Drop mede a queda do navicular do sentado para o em pé. Queda maior que ~10mm indica pronel excessiva e colapso do arco medial. É um teste objetivo que justifica suporte de arco na palmilha." },
        { t:"Jack Test (teste de Hubscher)", txt:"Eleva-se o hálux com o paciente em pé: se o arco medial se forma (windlass), o pé plano é flexível; se não forma, é rígido. Diferenciar pé plano flexível de rígido muda completamente a abordagem da palmilha." },
        { t:"Lunge Test", txt:"Mede a dorsiflexão do tornozelo em carga (joelho à parede). Déficit indica restrição que sobrecarrega o antepé e a cadeia posterior. Orienta a necessidade de alongamento e possíveis ajustes na palmilha." },
        { t:"FootCore e teste de perna curta", txt:"Avalie a musculatura intrínseca do pé (footcore) e investigue perna curta funcional. Fraqueza intrínseca contribui para o colapso do arco e é alvo de exercícios específicos junto da palmilha." },
      ]},
      { titulo:"Testes Posturológicos", aulas:[
        { t:"Polegares ascendentes", txt:"Teste de Bassani (polegares ascendentes): compara a ascensão dos polegares ao flexionar o tronco, avaliando assimetrias de cadeia. Faz parte da triagem posturológica que conecta o pé ao sistema tônico postural." },
        { t:"Testes posturodinâmicos", txt:"Testes dinâmicos avaliam como o sistema postural responde a estímulos. Ajudam a identificar se o pé é entrada primária (causa) ou secundária (compensação) da disfunção postural." },
        { t:"Rotação da cabeça e extensores do punho", txt:"Testes de rotação cervical e força dos extensores do punho são usados na posturologia para detectar interferências do sistema tônico. Resultados alterados orientam se a correção podal melhora a resposta global." },
      ]},
      { titulo:"Teste com Elementos e Decisão", aulas:[
        { t:"Teste posturológico com elementos", txt:"Posicione elementos (cunhas, suportes) provisórios sob o pé e repita os testes posturais e a marcha. Se a correção melhora o alinhamento e os testes, confirma-se que aquele elemento deve entrar na palmilha. É a validação em tempo real da prescrição." },
        { t:"Correção visual e na marcha com elementos", txt:"Avalie visualmente e na marcha o efeito dos elementos: o paciente fica mais alinhado? A pisada melhora? A dor diminui? Essa resposta guia a combinação final de elementos da palmilha personalizada." },
        { t:"Manipulação leve e rápida", txt:"Quando indicado, manipulações leves e rápidas podem liberar restrições antes de reavaliar. Sempre dentro do escopo e formação do profissional, como parte do raiocínio integrado." },
      ]},
      { titulo:"Venda e Fechamento do Tratamento", aulas:[
        { t:"Apresentação do tratamento ao paciente", txt:"Tenha uma apresentação pronta para explicar a patologia (ex: o que é a fascite, como trata) de forma simples. Mostre o plano: liberar a cadeia posterior, liberar o quadril, usar a palmilha, fazer os exercícios. Pacientes que entendem o porquê aderem mais ao tratamento." },
        { t:"Plano de tratamento e adesão", txt:"Estruture o plano em sessões (ex: ~6 consultas para fascite), combinando terapia manual, palmilha e exercícios. Apoie-se em artigos e depoimentos para gerar confiança. Deixe claro o cronograma e os resultados esperados em cada fase." },
        { t:"Coleta de resultados e depoimentos", txt:"Crie um padrão para documentar a evolução: foto na entrega da palmilha, acompanhamento da melhora e pedido de um depoimento (de preferência gravado). A secretária pode coletar prints e organizar esse material — prova social que ajuda a atrair novos pacientes." },
        { t:"Reavaliação da palmilha e seguimento", txt:"Reavalie periodicamente: a palmilha resolveu? Os testes melhoraram? Se sim, mantenha e dê alta orientada; se não, ajuste os elementos. O seguimento estruturado garante resultado e fideliza o paciente." },
      ]},
    ],
    prova:[
      { q:"Qual a sequência lógica da avaliação para palmilhas?", opts:["Marcha → anamnese → palpação","Anamnese → exame em DD → em pé → marcha → testes","Apenas baropodometria","Venda → exame → anamnese"], correta:1 },
      { q:"O Navicular Drop maior que ~10mm indica o quê?", opts:["Pé cavo rígido","Pronel excessiva e colapso do arco medial","Encurtamento do hálux","Dismetria de membros"], correta:1 },
      { q:"Para que serve o Jack Test (Hubscher)?", opts:["Medir a pressão plantar","Diferenciar pé plano flexível de rígido","Avaliar a força do quadríceps","Medir a dorsiflexão"], correta:1 },
      { q:"Qual o objetivo do teste com elementos?", opts:["Vender mais palmilhas","Validar em tempo real se a correção melhora o paciente antes de prescrever","Substituir a anamnese","Medir o tamanho do calçado"], correta:1 },
      { q:"Por que coletar foto e depoimento na entrega?", opts:["Obrigação legal","Documentar evolução e gerar prova social que atrai pacientes","Para cobrar mais caro","Não tem utilidade"], correta:1 },
    ],
  },
  {
...
const ACADEMY_TRILHAS = [
  ...
  { nome:"Avaliação Clínica", icon:"🩺", cor:"#EC4899", cursos:["avaliacaoclinica"] },
  { nome:"Casos Clínicos", icon:"📋", cor:"#F472B6", cursos:[] },
...
// 🚚 monta o link de rastreio conforme a transportadora (ou usa o link colado direto)
const TRANSPORTADORAS_URL = {
  "Correios": (c) => `https://rastreamento.correios.com.br/app/index.php?objetos=${encodeURIComponent(c)}`,
  "Loggi": (c) => `https://www.loggi.com/rastreador/${encodeURIComponent(c)}`,
  "Melhor Envio": (c) => `https://melhorrastreio.com.br/rastreio/${encodeURIComponent(c)}`,
  "Jadlog": (c) => `https://www.jadlog.com.br/tracking?cte=${encodeURIComponent(c)}`,
};
function linkRastreioGlobal(cod, transp){
  if(!cod) return null;
  const c = String(cod).trim();
  if(/^https?:\/\//i.test(c)) return c;
  const fn = TRANSPORTADORAS_URL[transp] || TRANSPORTADORAS_URL["Correios"];
  return fn(c);
}
const STATUS_CFG = {
  ...
  return (
    <style>{`
      ...
      *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
      ...
      @keyframes recepGlow{0%,100%{box-shadow:0 0 0 0 #F9731600,0 1px 3px rgba(0,0,0,.04)}50%{box-shadow:0 0 0 4px #F9731622,0 1px 3px rgba(0,0,0,.04)}}
      @keyframes dotPulse{0%,100%{transform:scale(1);opacity:1}50%{transform:scale(1.35);opacity:.55}}
      ...
      @media (max-width: 760px){
        input,textarea,select{font-size:16px !important;}  /* evita zoom automático do iOS */
        table{font-size:12px !important;}
        th,td{padding:8px 9px !important;}
        h1{font-size:19px !important;}
        /* tabelas largas rolam horizontalmente sem quebrar o layout */
        .fp-scroll-x{overflow-x:auto;-webkit-overflow-scrolling:touch;}
      }
      @media (max-width: 480px){
        th,td{padding:7px 7px !important;font-size:11px !important;}
      }
      /* reduz o respiro lateral das páginas no celular para aproveitar a tela */
      @media (max-width: 600px){
        .fp-main > div > div[style*="padding: 20px"],
        .fp-main > div[style*="padding: 20px"]{padding:13px !important;}
      }
    `}</style>
  );
}
...
const NAV_CLINICA = [{id:"dashboard",icon:"⬡",label:"Dashboard"},{id:"pedidos",icon:"📦",label:"Meus Pedidos"},{id:"avaliacao",icon:"🩺",label:"Avaliação"},{id:"pacientes",icon:"👤",label:"Pacientes"},{id:"agenda",icon:"📅",label:"Agenda"},{id:"procedimentos",icon:"🏭",label:"Procedimentos"},{id:"mensagens",icon:"💬",label:"Mensagens"},{id:"financeiro",icon:"💳",label:"Financeiro"},{id:"ia",icon:"✦",label:"IA"},{id:"academy",icon:"🎓",label:"Academy"},{id:"marketing",icon:"📣",label:"Marketing"},{id:"config",icon:"⚙",label:"Config"}];
...
// 🔍 Busca global de pacientes (no topbar) — encontra e abre a ficha de qualquer tela
function BuscaPacientes({ pacientes, onAbrir, isMobile }) {
  const [q, setQ] = useState("");
  const [aberto, setAberto] = useState(false);
  const termo = q.trim().toLowerCase();
  const resultados = termo.length>=1 ? (pacientes||[]).filter(p => {
    const nome = `${p.nome||""} ${p.sobrenome||""}`.toLowerCase();
    return nome.includes(termo) || String(p.whatsapp||"").includes(termo) || String(p.cpf||"").includes(termo) || String(p.email||"").toLowerCase().includes(termo);
  }).slice(0, 8) : [];

  const abrir = (p) => { setQ(""); setAberto(false); onAbrir && onAbrir(p); };

  return (
    <div style={{ position:"relative", width:isMobile?150:260 }}>
      <div style={{ display:"flex", alignItems:"center", gap:7, background:C.bgGlass, border:`1px solid ${aberto?C.accent+"55":C.border}`, borderRadius:9, padding:"6px 11px" }}>
        <span style={{ fontSize:13, color:C.muted, flexShrink:0 }}>🔍</span>
        <input value={q} onChange={e=>{ setQ(e.target.value); setAberto(true); }} onFocus={()=>setAberto(true)} onBlur={()=>setTimeout(()=>setAberto(false),180)} placeholder={isMobile?"Buscar...":"Buscar paciente..."} style={{ flex:1, background:"none", border:"none", outline:"none", color:C.text, fontSize:12.5, padding:0, minWidth:0 }} />
        {q && <button onMouseDown={()=>setQ("")} style={{ background:"none", color:C.muted, fontSize:14, flexShrink:0, cursor:"pointer", padding:0 }}>×</button>}
      </div>
      {aberto && termo.length>=1 && (
        <div style={{ position:"absolute", top:"calc(100% + 6px)", left:0, right:0, background:C.bgCard, border:`1px solid ${C.border}`, borderRadius:11, boxShadow:"0 12px 32px rgba(0,0,0,.4)", overflow:"hidden", zIndex:100, maxHeight:340, overflowY:"auto" }}>
          {resultados.length===0 ? (
            <div style={{ padding:"14px 16px", fontSize:12, color:C.muted, textAlign:"center" }}>Nenhum paciente encontrado para "{q}".</div>
          ) : resultados.map((p,i)=>(
            <div key={p.id||i} onMouseDown={()=>abrir(p)} style={{ display:"flex", alignItems:"center", gap:10, padding:"10px 14px", borderTop:i>0?`1px solid ${C.border}`:"none", cursor:"pointer" }}>
              <div style={{ width:32, height:32, borderRadius:"50%", flexShrink:0, background:`linear-gradient(135deg,${C.accent},${C.purple})`, display:"flex", alignItems:"center", justifyContent:"center", fontWeight:800, color:"#fff", fontSize:13 }}>{(p.nome||"?").charAt(0).toUpperCase()}</div>
              <div style={{ flex:1, minWidth:0 }}>
                <div style={{ fontSize:12.5, fontWeight:700, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>{p.nome} {p.sobrenome}</div>
                <div style={{ fontSize:10.5, color:C.muted, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>{p.whatsapp||p.email||(p.numeracao?`Nº ${p.numeracao}`:"—")}</div>
              </div>
              <span style={{ fontSize:10, color:C.accent, fontWeight:700, flexShrink:0 }}>abrir →</span>
            </div>
          ))}
        </div>
      )}
...
function Topbar({title,sub,onLogout,clinicaName,isAdmin,notifDestino,onMenu,isMobile,onNavegar,notifCtx,buscaPacientes,onAbrirPaciente}) {
  return (
    <div style={{height:56,borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",justifyContent:"space-between",padding:isMobile?"0 12px":"0 20px",background:`${C.bgCard}dd`,backdropFilter:"blur(14px)",position:"sticky",top:0,zIndex:50}}>
      ...
      <div style={{display:"flex",alignItems:"center",gap:10,flexShrink:0}}>
        {buscaPacientes&&buscaPacientes.length>0&&<BuscaPacientes pacientes={buscaPacientes} onAbrir={onAbrirPaciente} isMobile={isMobile}/>}
        ...
        {notifDestino&&<NotifBell destino={notifDestino} onNavegar={onNavegar} ctx={notifCtx}/>}
...
function DashAdmin({pedidos,clinicas,onNavegar}) {
  ...
  return (
    <div style={{padding:20,display:"flex",flexDirection:"column",gap:18}}>
      ...
      {/* 📈 Métricas de negócio — visão executiva FisioPiede */}
      {(()=>{
        ...
        const mesDe = (p) => { const d = p.data ? new Date(p.data) : (p.criadoEm?new Date(p.criadoEm):null); return d&&!isNaN(d.getTime()) ? `${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,"0")}` : null; };
        const pedidosMes = pedidos.filter(p=>mesDe(p)===mesAtual);
        const pedidosMesPassado = pedidos.filter(p=>mesDe(p)===mesPassado);
        // crescimento de pedidos mês a mês
        const crescPedidos = pedidosMesPassado.length>0 ? Math.round(((pedidosMes.length-pedidosMesPassado.length)/pedidosMesPassado.length)*100) : (pedidosMes.length>0?100:0);
        // ticket médio (faturamento FisioPiede por pedido)
        const ticketMedio = PRECO;
        // receita recorrente (assinaturas ativas)
        const assinAtivas = (clinicas||[]).filter(c=>{ const st=ASSINATURA.calcular(c).status; return st==="Ativa"||st==="Em atraso"; });
        const mrr = assinAtivas.reduce((acc,c)=>{ const pl=(PLANOS_INFO||[]).find(x=>x.nome===(c.plano||"Básico")); return acc + (pl?pl.preco||0:0); }, 0);
        // taxa de conversão trial → pago
        const totalCom = (clinicas||[]).length;
        const pagantes = (clinicas||[]).filter(c=>{ const st=ASSINATURA.calcular(c).status; return st==="Ativa"; }).length;
        const conversao = totalCom>0 ? Math.round((pagantes/totalCom)*100) : 0;
        const cards = [
          { l:"Pedidos no mês", v:pedidosMes.length, sub:crescPedidos>=0?`↗ +${crescPedidos}% vs mês passado`:`↘ ${crescPedidos}% vs mês passado`, cor:crescPedidos>=0?C.green:C.amber, i:"📦" },
          { l:"Receita recorrente (MRR)", v:`R$ ${brl(mrr)}`, sub:`${assinAtivas.length} assinatura(s) ativa(s)`, cor:C.green, i:"💰" },
          { l:"Ticket por pedido", v:`R$ ${brl(ticketMedio)}`, sub:"faturamento por palmilha", cor:C.accent, i:"🏷️" },
          { l:"Conversão p/ pagante", v:`${conversao}%`, sub:`${pagantes} de ${totalCom} clínicas`, cor:C.purple, i:"📊" },
        ];
        return (
          <Card hover={false} p={0} style={{overflow:"hidden",border:`1px solid ${C.accent}25`}}>
            <div style={{padding:"11px 16px",borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",gap:8,background:`linear-gradient(135deg,${C.accent}08,${C.purple}05)`}}>
              <span style={{fontSize:15}}>📈</span><span style={{fontSize:12.5,fontWeight:800}}>Métricas de negócio</span>
              <span style={{fontSize:10,color:C.muted,marginLeft:"auto"}}>visão executiva</span>
            </div>
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(160px,1fr))",gap:1,background:C.border}}>
              {cards.map((x,i)=>(
                <div key={i} style={{background:C.bgCard,padding:"15px 16px"}}>
                  <div style={{display:"flex",alignItems:"center",gap:7,marginBottom:8}}><span style={{fontSize:15}}>{x.i}</span><span style={{fontSize:10,color:C.muted,fontWeight:600}}>{x.l}</span></div>
                  <div style={{fontSize:22,fontWeight:900,color:x.cor,lineHeight:1}}>{x.v}</div>
                  <div style={{fontSize:9.5,color:C.muted,marginTop:5,fontWeight:600}}>{x.sub}</div>
                </div>
              ))}
            </div>
          </Card>
...
function PedidoModal({pedido,isAdmin,onClose,onUpdate}) {
  ...
  // 🚚 transportadoras suportadas e como montar o link de rastreio
  const TRANSPORTADORAS = {
    "Correios": (cod) => `https://rastreamento.correios.com.br/app/index.php?objetos=${encodeURIComponent(cod)}`,
    "Loggi": (cod) => `https://www.loggi.com/rastreador/${encodeURIComponent(cod)}`,
    "Melhor Envio": (cod) => `https://melhorrastreio.com.br/rastreio/${encodeURIComponent(cod)}`,
    "Jadlog": (cod) => `https://www.jadlog.com.br/tracking?cte=${encodeURIComponent(cod)}`,
    "Outro / Link": (cod) => cod,
  };
  // monta o link final: se o que foi colado já é um link (http), usa direto; senão aplica a transportadora
  const linkRastreio = (cod, transp) => {
    if(!cod) return null;
    const c = String(cod).trim();
    if(/^https?:\/\//i.test(c)) return c; // colou um link completo
    const fn = TRANSPORTADORAS[transp] || TRANSPORTADORAS["Correios"];
    return fn(c);
  };
  const [saved,setSaved]     = useState(false);
  const sc = STATUS_CFG[status]||{color:C.sub};
  const isEnv = ["Enviado","Finalizado"].includes(status);
  // 🔒 Descrição travada após o envio (não pode mais ser alterada) — mas observações são sempre permitidas
  const descTravada = ["Em Produção","Impressão 3D","Acabamento","Enviado","Finalizado","Entregue"].includes(pedido.status);
  // ✏️ A clínica pode EDITAR os dados técnicos enquanto o pedido está "Recebido" (antes da análise)
  const clinicaPodeEditar = !isAdmin && pedido.status === "Recebido";
  const [editando, setEditando] = useState(false);
  const [ver3D, setVer3D] = useState(null); // 🧊 arquivo 3D aberto no visualizador
  const [subindoPalmilha, setSubindoPalmilha] = useState(false); // 🧊 upload da palmilha STL
  const [ed, setEd] = useState({
    tipoCalcado: pedido.tipoCalcado||"Tênis", tipoPalmilha: pedido.tipoPalmilha||"Inteira",
    flexibilidade: pedido.flexibilidade||"Normal", cobertura: pedido.cobertura||"EVA Perfurado",
    cor: pedido.cor||"Preto", espessura: pedido.espessura||"4mm", numeracao: pedido.numeracao||"",
    comprimento: pedido.comprimento||"", larguraAntePe: pedido.larguraAntePe||"", larguraCalcaneo: pedido.larguraCalcaneo||"",
    peso: pedido.peso||"", altura: pedido.altura||"", obsDireito: pedido.obsDireito||"", obsEsquerdo: pedido.obsEsquerdo||""
  });
  const CAMPOS_EDIT = [
    ["Tipo de Calçado","tipoCalcado",["Tênis","Social","Chinelo","Sandália"]],
    ["Tipo de Palmilha","tipoPalmilha",["Inteira","Fina","Chinelo"]],
    ["Flexibilidade","flexibilidade",["Flexível","Normal","Rígida"]],
    ["Cobertura","cobertura",["EVA Perfurado","Sintético","Tecido"]],
    ["Cor","cor",["Preto","Marrom","Bege","Branco"]],
  ];
  const salvarEdicaoClinica = () => {
    const t = nowTs();
    const novoLog = [...(pedido.log||[]), `${t} — Pedido editado pela clínica`];
    onUpdate({...pedido, ...ed, espessura: ed.espessura, updatedAt: t, log: novoLog});
    setEditando(false);
    try { pushNotif("admin", "✏️", `Pedido ${pedido.id} editado`, `${pedido.clinica} ajustou os dados de ${pedido.paciente} (ainda em Recebido)`, "pedidos"); } catch(e){}
  };
  const [novaObs, setNovaObs] = useState("");
  const observacoes = pedido.observacoes || [];
  const addObservacao = () => {
    if(!novaObs.trim()) return;
    const quem = isAdmin ? "FisioPiede (produção)" : (pedido.clinica || "Clínica");
    const obs = { texto: novaObs.trim(), autor: quem, ehAdmin: !!isAdmin, ts: Date.now() };
    const novas = [...observacoes, obs];
    onUpdate({...pedido, observacoes: novas});
    setNovaObs("");
    // notifica a outra ponta sobre a observação
    try {
      if(isAdmin && pedido.clinicaId) pushNotif("clinica:"+pedido.clinicaId, "📝", `Observação no pedido ${pedido.id}`, `${pedido.paciente}: ${obs.texto.slice(0,60)}`, "pedidos");
      if(!isAdmin) pushNotif("admin", "📝", `Observação da clínica — ${pedido.id}`, `${pedido.clinica}: ${obs.texto.slice(0,60)}`, "pedidos");
    } catch(e){}
  };
  ...
  const save = () => {
    ...
    if(mudouRastreio) newLog.push(`${t} — Rastreio (${transportadora}): ${rastreio}`);
    onUpdate({...pedido,status,rastreio,transportadora,updatedAt:t,log:newLog});
    ...
    <Modal onClose={onClose}>
      <Card hover={false} p={0} style={{width:"100%",maxWidth:660,maxHeight:"92vh",overflowY:"auto",animation:"fadeUp .22s ease"}}>
        ...
        <div style={{padding:20,display:"flex",flexDirection:"column",gap:16}}>
          {descTravada && !isAdmin && (
            <div style={{display:"flex",gap:10,alignItems:"center",padding:"12px 14px",background:`${C.amber}10`,border:`1px solid ${C.amber}40`,borderRadius:11}}>
              <span style={{fontSize:22,flexShrink:0}}>🔒</span>
              <div><div style={{fontSize:12.5,fontWeight:800,color:C.amber}}>Pedido em produção — dados travados</div><div style={{fontSize:10.5,color:C.muted,marginTop:2,lineHeight:1.45}}>Este pedido já saiu para produção, então a descrição técnica não pode mais ser alterada. Você pode registrar observações no fim da página.</div></div>
            </div>
          )}
          {/* ✏️ Banner: clínica pode editar enquanto "Recebido" */}
          {clinicaPodeEditar && !editando && (
            <div style={{display:"flex",gap:10,alignItems:"center",padding:"12px 14px",background:`${C.green}0C`,border:`1px solid ${C.green}35`,borderRadius:11,flexWrap:"wrap"}}>
              <span style={{fontSize:20,flexShrink:0}}>✏️</span>
              <div style={{flex:1,minWidth:160}}><div style={{fontSize:12.5,fontWeight:800,color:C.green}}>Você ainda pode editar este pedido</div><div style={{fontSize:10.5,color:C.muted,marginTop:2,lineHeight:1.45}}>O pedido ainda não entrou em análise. Assim que a FisioPiede começar a analisar, os dados serão travados.</div></div>
              <Btn v="primary" sz="sm" onClick={()=>setEditando(true)} style={{background:C.green,flexShrink:0}}>✏️ Editar pedido</Btn>
            </div>
          )}
          {!editando && (
          <div>
          ...
          {/* ✏️ Formulário de edição da clínica (só quando "Recebido") */}
          {editando && clinicaPodeEditar && (
            <div style={{border:`1px solid ${C.green}30`,borderRadius:12,padding:16,background:`${C.green}05`}}>
              <div style={{fontSize:12,fontWeight:800,color:C.green,marginBottom:12}}>✏️ Editando pedido — {pedido.paciente}</div>
              <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(150px,1fr))",gap:10,marginBottom:12}}>
                {CAMPOS_EDIT.map(([lbl,key,opts])=>(
                  <div key={key}>
                    <label>{lbl}</label>
                    <select value={ed[key]} onChange={e=>setEd({...ed,[key]:e.target.value})}>
                      {opts.map(o=><option key={o}>{o}</option>)}
                    </select>
                  </div>
                ))}
                <div><label>Espessura</label><select value={ed.espessura} onChange={e=>setEd({...ed,espessura:e.target.value})}>{["3mm","4mm","5mm","6mm"].map(o=><option key={o}>{o}</option>)}</select></div>
                <div><label>Nº Calçado</label><input value={ed.numeracao} onChange={e=>setEd({...ed,numeracao:e.target.value})} /></div>
              </div>
              <div style={{fontSize:10,color:C.muted,fontWeight:700,textTransform:"uppercase",letterSpacing:".05em",marginBottom:8}}>Medidas (cm/kg)</div>
              <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(110px,1fr))",gap:10,marginBottom:12}}>
                {[["Comprimento","comprimento"],["Larg. Antepé","larguraAntePe"],["Larg. Calcâneo","larguraCalcaneo"],["Peso","peso"],["Altura","altura"]].map(([lbl,key])=>(
                  <div key={key}><label>{lbl}</label><input type="number" value={ed[key]} onChange={e=>setEd({...ed,[key]:e.target.value})} /></div>
                ))}
              </div>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:14}}>
                <div><label>Obs. pé direito</label><textarea value={ed.obsDireito} onChange={e=>setEd({...ed,obsDireito:e.target.value})} style={{minHeight:48,resize:"vertical",fontSize:12}} /></div>
                <div><label>Obs. pé esquerdo</label><textarea value={ed.obsEsquerdo} onChange={e=>setEd({...ed,obsEsquerdo:e.target.value})} style={{minHeight:48,resize:"vertical",fontSize:12}} /></div>
              </div>
              <div style={{display:"flex",gap:8,justifyContent:"flex-end"}}>
                <Btn v="ghost" sz="sm" onClick={()=>setEditando(false)}>Cancelar</Btn>
                <Btn v="primary" sz="sm" onClick={salvarEdicaoClinica} style={{background:C.green}}>✓ Salvar alterações</Btn>
              </div>
            </div>
          )}
          {/* Discriminado por pé */}
          {(pedido.obsDireito||pedido.obsEsquerdo)&&(
            <div style={{background:`${C.accent}04`,border:`1px solid ${C.accent}15`,borderRadius:12,padding:14}}>
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8,marginBottom:12,flexWrap:"wrap"}}>
                <div style={{fontSize:10,color:C.accent,fontWeight:700,textTransform:"uppercase",letterSpacing:".07em"}}>Discriminado Técnico por Pé</div>
                {descTravada && <span style={{display:"inline-flex",alignItems:"center",gap:5,fontSize:9.5,fontWeight:800,color:C.amber,background:`${C.amber}12`,border:`1px solid ${C.amber}30`,padding:"3px 9px",borderRadius:99}}>🔒 Travado após envio — não pode ser alterado</span>}
              </div>
                            ...
                            return(
                              <div key={i} style={{display:"flex",alignItems:"center",gap:8,padding:"7px 10px",background:C.bgGlass,border:`1px solid ${C.border}`,borderRadius:8}}>
                                ...
                                <div style={{display:"flex",gap:5,flexShrink:0}}>
                                  {arq.dataUrl&&(arq.ext==="OBJ"||arq.ext==="STL")&&(
                                    <button onClick={()=>setVer3D({url:arq.dataUrl,nome:arq.nome,ext:arq.ext})} style={{display:"inline-flex",alignItems:"center",gap:3,padding:"3px 8px",borderRadius:6,fontSize:10,fontWeight:800,background:`${C.purple}18`,color:C.purple,border:`1px solid ${C.purple}35`,cursor:"pointer"}}>🧊 Ver em 3D</button>
                                  )}
                                  ...
                                  {arq.dataUrl
                                    ? (isAdmin || (arq.ext!=="STL"&&arq.ext!=="OBJ")
          ...
          {/* 🧊 PALMILHA 3D — anexar o STL da palmilha modelada e visualizar girando */}
          {(() => {
            const palmilha3d = pedido.palmilha3d || null; // {nome, ext, size, dataUrl/url}
            const subindoP = subindoPalmilha;
            return (
              <div style={{borderRadius:14,overflow:"hidden",border:`1px solid ${C.purple}30`,background:`linear-gradient(160deg,${C.purple}08,${C.bgCard})`}}>
                <div style={{padding:"12px 15px",borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",gap:9}}>
                  <span style={{fontSize:17}}>🧊</span>
                  <div style={{flex:1}}>
                    <div style={{fontSize:12.5,fontWeight:800}}>Palmilha 3D do paciente</div>
                    <div style={{fontSize:10,color:C.muted}}>Anexe o arquivo .STL (ou .OBJ) da palmilha modelada para visualizar em 3D</div>
                  </div>
                </div>
                <div style={{padding:15}}>
                  {palmilha3d ? (
                    <div style={{display:"flex",alignItems:"center",gap:12,padding:"12px 14px",borderRadius:11,background:C.bgCard,border:`1px solid ${C.border}`,flexWrap:"wrap"}}>
                      <div style={{width:46,height:46,borderRadius:11,background:`${C.green}15`,border:`1px solid ${C.green}30`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:900,color:C.green,flexShrink:0}}>{palmilha3d.ext||"STL"}</div>
                      <div style={{flex:1,minWidth:120}}>
                        <div style={{fontSize:12.5,fontWeight:700,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{palmilha3d.nome}</div>
                        <div style={{fontSize:10,color:C.muted}}>{palmilha3d.size||""} {palmilha3d.url||palmilha3d.dataUrl?"· ☁️ na nuvem":""}</div>
                      </div>
                      <div style={{display:"flex",gap:7,flexShrink:0}}>
                        {(palmilha3d.url||palmilha3d.dataUrl) && <button onClick={()=>setVer3D({url:palmilha3d.url||palmilha3d.dataUrl,nome:palmilha3d.nome,ext:palmilha3d.ext})} style={{display:"inline-flex",alignItems:"center",gap:5,padding:"8px 16px",borderRadius:9,fontSize:12,fontWeight:800,background:`linear-gradient(120deg,${C.purple},${C.accent})`,color:"#fff",border:"none",cursor:"pointer",boxShadow:`0 4px 16px ${C.purple}40`}}>🧊 Ver palmilha em 3D</button>}
                        {isAdmin && (palmilha3d.url||palmilha3d.dataUrl) && <a href={palmilha3d.url||palmilha3d.dataUrl} download={palmilha3d.nome} style={{display:"inline-flex",alignItems:"center",gap:3,padding:"8px 12px",borderRadius:9,fontSize:11,fontWeight:700,background:`${C.green}15`,color:C.green,textDecoration:"none",border:`1px solid ${C.green}30`}} title="Baixar (somente admin)">⬇️</a>}
                        {(!descTravada || isAdmin) && <button onClick={()=>onUpdate({...pedido, palmilha3d:null})} style={{background:"none",color:C.muted,fontSize:14,cursor:"pointer",padding:"0 4px"}} title="Remover">×</button>}
                      </div>
                    </div>
                  ) : (
                    <div>
                      {(!descTravada || isAdmin) ? (
                        <label style={{display:"flex",flexDirection:"column",alignItems:"center",gap:9,padding:"24px 18px",borderRadius:12,border:`2px dashed ${C.purple}40`,background:`${C.purple}05`,cursor:subindoP?"wait":"pointer",textAlign:"center"}}>
                          {subindoP ? (
                            <><Spin sz={20}/><span style={{fontSize:12,color:C.purple,fontWeight:700}}>☁️ Enviando palmilha para a nuvem...</span></>
                          ) : (
                            <><span style={{fontSize:30}}>🧊</span><span style={{fontSize:12.5,fontWeight:700,color:C.purple}}>Anexar palmilha 3D (.STL ou .OBJ)</span><span style={{fontSize:10.5,color:C.muted}}>Clique para escolher o arquivo da palmilha modelada</span></>
                          )}
                          <input type="file" accept=".stl,.obj" style={{display:"none"}} disabled={subindoP} onChange={async (e)=>{
                            const file = e.target.files && e.target.files[0];
                            if(!file) return;
                            const ext = (file.name.split(".").pop()||"").toUpperCase();
                            if(!["STL","OBJ"].includes(ext)){ alert("Envie um arquivo .STL ou .OBJ da palmilha."); return; }
                            const tamMB = file.size/(1024*1024);
                            setSubindoPalmilha(true);
                            try {
                              const url = await STORAGE_FP.upload(file, "palmilhas");
                              onUpdate({...pedido, palmilha3d:{ nome:file.name, ext, size: tamMB.toFixed(1)+"MB", url }});
                            } catch(err) {
                              alert("Não foi possível enviar agora. Tente novamente.");
                            }
                            setSubindoPalmilha(false);
                          }}/>
                        </label>
                      ) : (
                        <div style={{padding:"18px",textAlign:"center",fontSize:11.5,color:C.muted,fontStyle:"italic",border:`1px dashed ${C.border}`,borderRadius:11}}>Nenhuma palmilha 3D anexada.</div>
                      )}
                    </div>
                  )}
                </div>
          ...
          <div style={{padding:14,background:isEnv?`${C.green}06`:C.bgGlass,border:`1px solid ${isEnv?C.green+"25":C.border}`,borderRadius:11}}>
            ...
            {isAdmin
              ? <div style={{display:"flex",flexDirection:"column",gap:9}}>
                  <div>
                    <label style={{fontSize:9,marginBottom:5}}>Transportadora</label>
                    <div style={{display:"flex",gap:5,flexWrap:"wrap"}}>
                      {Object.keys(TRANSPORTADORAS).map(tp=>(
                        <button key={tp} onClick={()=>setTransportadora(tp)} style={{padding:"5px 11px",borderRadius:7,fontSize:10.5,fontWeight:700,border:`1px solid ${transportadora===tp?C.green:C.border}`,background:transportadora===tp?`${C.green}15`:"transparent",color:transportadora===tp?C.green:C.muted,cursor:"pointer"}}>{tp}</button>
                      ))}
                    </div>
                  </div>
                  <div style={{display:"flex",gap:8,alignItems:"center"}}>
                    <input value={rastreio} onChange={e=>setRastreio(e.target.value)} placeholder={transportadora==="Outro / Link"?"Cole o link de rastreio completo (https://...)":"Cole o código OU o link de rastreio"}/>
                    {rastreio&&<a href={linkRastreio(rastreio,transportadora)} target="_blank" rel="noreferrer" style={{padding:"10px 14px",borderRadius:8,fontSize:12,fontWeight:700,background:C.green,color:"#fff",textDecoration:"none",whiteSpace:"nowrap",flexShrink:0}}>🔗 Testar</a>}
                  </div>
                  <div style={{fontSize:9.5,color:C.muted}}>💡 Pode colar só o código (e escolher a transportadora) ou o link completo de qualquer site.</div>
                </div>
              : rastreio
                ? <div style={{display:"flex",alignItems:"center",gap:12,flexWrap:"wrap"}}><div><div style={{fontSize:9,color:C.muted,fontWeight:700,marginBottom:2}}>{pedido.transportadora||transportadora}</div><span style={{fontFamily:"'Space Mono',monospace",fontSize:12,color:C.green,fontWeight:700,wordBreak:"break-all"}}>{/^https?:/i.test(rastreio)?"Link de rastreio disponível":rastreio}</span></div><a href={linkRastreio(rastreio,pedido.transportadora||transportadora)} target="_blank" rel="noreferrer" style={{padding:"7px 13px",borderRadius:8,fontSize:12,fontWeight:700,background:`${C.green}16`,color:C.green,textDecoration:"none",border:`1px solid ${C.green}30`,flexShrink:0}}>🔗 Rastrear →</a></div>
          ...
          {/* 📝 Observações registradas (com data e hora) — histórico imutável */}
          <div style={{background:`${C.purple}05`,border:`1px solid ${C.purple}20`,borderRadius:12,padding:14}}>
            <div style={{fontSize:10,color:C.purple,fontWeight:700,textTransform:"uppercase",letterSpacing:".07em",marginBottom:4}}>📝 Observações</div>
            <div style={{fontSize:10.5,color:C.muted,marginBottom:12,lineHeight:1.5}}>{descTravada?"A descrição técnica não pode mais ser alterada, mas você pode registrar observações aqui. Cada uma fica gravada com data e hora.":"Registre observações sobre este pedido. Cada uma fica gravada com data e hora."}</div>
            {observacoes.length>0 ? (
              <div style={{display:"flex",flexDirection:"column",gap:8,marginBottom:13}}>
                {observacoes.map((o,i)=>{
                  const dt=new Date(o.ts);
                  const quandoTxt=dt.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"})+" às "+dt.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"});
                  return (
                    <div key={i} style={{padding:"10px 12px",background:C.bgCard,border:`1px solid ${o.ehAdmin?C.gold+"30":C.accent+"25"}`,borderRadius:9}}>
                      <div style={{display:"flex",alignItems:"center",gap:7,marginBottom:5,flexWrap:"wrap"}}>
                        <span style={{fontSize:9.5,fontWeight:800,color:o.ehAdmin?C.gold:C.accent,background:o.ehAdmin?`${C.gold}15`:`${C.accent}15`,padding:"2px 8px",borderRadius:99}}>{o.ehAdmin?"🏭 "+o.autor:"🏥 "+o.autor}</span>
                        <span style={{fontSize:9.5,color:C.muted,marginLeft:"auto"}}>🕐 {quandoTxt}</span>
                      </div>
                      <div style={{fontSize:12.5,color:C.text,lineHeight:1.55}}>{o.texto}</div>
                    </div>
                  );
                })}
              </div>
            ) : <div style={{fontSize:11.5,color:C.muted,fontStyle:"italic",marginBottom:13,padding:"8px 0"}}>Nenhuma observação registrada ainda.</div>}
            {descTravada && !isAdmin && (
              <div style={{display:"flex",gap:9,alignItems:"flex-start",padding:"11px 13px",background:`${C.amber}10`,border:`1px solid ${C.amber}35`,borderRadius:9,marginBottom:12}}>
                <span style={{fontSize:17,flexShrink:0}}>⚠️</span>
                <div style={{fontSize:11,color:C.amber,lineHeight:1.5}}><strong>Atenção:</strong> este pedido já está em produção e a palmilha pode já ter sido impressa. Mudanças na descrição não são mais possíveis. Se precisar de algo urgente, registre abaixo — mas pode não dar tempo de aplicar nesta produção.</div>
              </div>
            )}
            <div style={{display:"flex",gap:8,alignItems:"flex-end",flexWrap:"wrap"}}>
              <div style={{flex:1,minWidth:180}}>
                <textarea value={novaObs} onChange={e=>setNovaObs(e.target.value)} placeholder={isAdmin?"Observação da produção...":"Adicionar uma observação..."} style={{width:"100%",minHeight:54,resize:"vertical",fontSize:13}} />
              </div>
              <Btn v="primary" sz="sm" disabled={!novaObs.trim()} onClick={addObservacao} style={{background:C.purple,flexShrink:0}}>📝 Registrar</Btn>
            </div>
          </div>
          <div style={{display:"flex",gap:8,justifyContent:"flex-end"}}>
      ...
      {ver3D && <Viewer3D url={ver3D.url} nome={ver3D.nome} ext={ver3D.ext} isAdmin={isAdmin} onClose={()=>setVer3D(null)} />}
    </Modal>
  );
}

// ─── UPLOAD ZONE por pé ───────────────────────────────────────────────────────
// 🧊 Visualizador 3D da palmilha — renderiza .obj/.stl girando no navegador (Three.js via CDN)
function Viewer3D({ url, nome, ext, isAdmin, onClose }) {
  const mountRef = useRef(null);
  const [estado, setEstado] = useState("carregando"); // carregando | ok | erro
  const [erroMsg, setErroMsg] = useState("");

  useEffect(() => {
    let renderer, animId, scene, camera, controls, frame=0, disposed=false;
    const mount = mountRef.current;
    if(!mount) return;

    // carrega um script via CDN e resolve quando pronto
    const carregarScript = (src) => new Promise((res, rej) => {
      if([...document.querySelectorAll("script")].some(sc=>sc.src===src)) return res();
      const sc = document.createElement("script");
      sc.src = src; sc.onload = ()=>res(); sc.onerror = ()=>rej(new Error("falha ao carregar "+src));
      document.head.appendChild(sc);
    });

    (async () => {
      try {
        // Three.js + loaders (r128 — compatível com THREE global)
        await carregarScript("https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js");
        const THREE = window.THREE;
        if(!THREE) throw new Error("Three.js não carregou");
        const ehStl = /stl/i.test(ext||"") || /\.stl$/i.test(url||"");
        if(ehStl) await carregarScript("https://cdn.jsdelivr.net/npm/three@0.128.0/examples/js/loaders/STLLoader.js");
        else await carregarScript("https://cdn.jsdelivr.net/npm/three@0.128.0/examples/js/loaders/OBJLoader.js");
        ...
        const fill = new THREE.DirectionalLight(0x60A5FA, 0.4); fill.position.set(-1,0.5,-1); scene.add(fill);

        if(window.THREE.OrbitControls){ controls = new THREE.OrbitControls(camera, renderer.domElement); controls.enableDamping = true; controls.dampingFactor = 0.08; }
        ...
        const matPalmilha = new THREE.MeshPhongMaterial({ color:0x3B82F6, specular:0x222222, shininess:25, side:THREE.DoubleSide });
        ...
        const onLoaded = (obj3d) => {
          ...
          enquadrar(obj3d);
          setEstado("ok");
          const animate = () => { if(disposed) return; animId = requestAnimationFrame(animate); obj3d.rotation.y += 0.004; if(controls) controls.update(); renderer.render(scene, camera); };
          animate();
        };

        if(ehStl){
          const loader = new THREE.STLLoader();
          loader.load(url, (geo)=>{ geo.computeVertexNormals(); const mesh = new THREE.Mesh(geo, matPalmilha); onLoaded(mesh); }, undefined, (e)=>{ if(!disposed){ setEstado("erro"); setErroMsg("Não foi possível carregar o arquivo STL."); } });
        } else {
          const loader = new THREE.OBJLoader();
          loader.load(url, (obj)=>{ obj.traverse(ch=>{ if(ch.isMesh) ch.material = matPalmilha; }); onLoaded(obj); }, undefined, (e)=>{ if(!disposed){ setEstado("erro"); setErroMsg("Não foi possível carregar o arquivo OBJ."); } });
        }

        const onResize = () => { if(disposed||!mount) return; const w=mount.clientWidth, h=mount.clientHeight||360; renderer.setSize(w,h); camera.aspect=w/h; camera.updateProjectionMatrix(); };
        window.addEventListener("resize", onResize);
        mount._cleanupResize = () => window.removeEventListener("resize", onResize);
      } catch(e) {
        if(!disposed){ setEstado("erro"); setErroMsg(e.message||"Erro ao iniciar o visualizador 3D."); }
      }
    })();
    ...
    return () => {
      ...
      if(mount && mount._cleanupResize) mount._cleanupResize();
  ...
  return (
    <Modal onClose={onClose}>
      <Card hover={false} p={0} style={{ width:"100%", maxWidth:640, overflow:"hidden", animation:"scaleIn .25s ease" }}>
        <div style={{ padding:"14px 18px", borderBottom:`1px solid ${C.border}`, display:"flex", alignItems:"center", justifyContent:"space-between", gap:10, background:`linear-gradient(135deg,${C.accent}10,${C.purple}06)` }}>
          <div style={{ display:"flex", alignItems:"center", gap:10 }}>
            <span style={{ fontSize:20 }}>🧊</span>
            <div><div style={{ fontSize:14, fontWeight:800 }}>Visualização 3D da palmilha</div><div style={{ fontSize:10.5, color:C.muted, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap", maxWidth:380 }}>{nome}</div></div>
          </div>
          <button onClick={onClose} style={{ background:"none", color:C.muted, fontSize:20, cursor:"pointer" }}>✕</button>
        </div>
        <div style={{ position:"relative", width:"100%", height:380, background:"#0B0E15" }}>
          ...
          {estado==="carregando" && (
            <div style={{ position:"absolute", inset:0, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:12, color:C.muted, pointerEvents:"none" }}>
              <div style={{ width:38, height:38, border:`3px solid ${C.border}`, borderTopColor:C.accent, borderRadius:"50%", animation:"spin .8s linear infinite" }} />
              <div style={{ fontSize:12 }}>Carregando modelo 3D...</div>
            </div>
          )}
          {estado==="erro" && (
            <div style={{ position:"absolute", inset:0, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:10, color:C.muted, padding:20, textAlign:"center" }}>
              <span style={{ fontSize:32 }}>⚠️</span>
              <div style={{ fontSize:12.5, fontWeight:700, color:C.sub }}>{erroMsg||"Não foi possível exibir o modelo 3D"}</div>
              {isAdmin && <a href={url} download={nome} style={{ fontSize:11, fontWeight:700, color:C.green, textDecoration:"none", background:`${C.green}15`, padding:"6px 12px", borderRadius:8, border:`1px solid ${C.green}30` }}>⬇️ Baixar arquivo</a>}
            </div>
          )}
        </div>
        <div style={{ padding:"10px 16px", display:"flex", alignItems:"center", justifyContent:"space-between", gap:10, borderTop:`1px solid ${C.border}`, flexWrap:"wrap" }}>
          <span style={{ fontSize:10.5, color:C.muted }}>🖱️ Arraste para girar · role para dar zoom</span>
          {isAdmin
            ? <a href={url} download={nome} style={{ fontSize:11, fontWeight:700, color:C.accent, textDecoration:"none" }}>⬇️ Baixar {ext||"modelo"}</a>
            : <span style={{ fontSize:10, color:C.muted, fontStyle:"italic" }}>🔒 Visualização protegida</span>}
        </div>
      </Card>
    </Modal>
  );
...
function RemessaModal({cesta,onClose,onConfirm,onAddMais}) {
  ...
  // 🚚 Agrupa os pedidos POR CLÍNICA — cada clínica é um destino/endereço diferente,
  // então cada uma vira uma remessa com seu próprio frete.
  const grupos = React.useMemo(() => {
    const map = {};
    cesta.forEach(p => {
      const chave = p.clinicaId != null ? String(p.clinicaId) : ("nome:" + (p.clinica||"—"));
      if(!map[chave]) map[chave] = { clinicaId: p.clinicaId??null, clinica: p.clinica||"—", itens: [] };
      map[chave].itens.push({ ...p, valor: precoPalmilha(p.produto||p.tipo, antecipado) });
    });
    return Object.values(map);
  }, [cesta, antecipado]);

  // frete escolhido por clínica (cada grupo tem o seu)
  const [fretes, setFretes] = useState(() => {
    const init = {}; grupos.forEach((g,i)=>{ init[i] = "sedex"; }); return init;
  });
  const setFreteGrupo = (i, k) => setFretes(prev => ({ ...prev, [i]: k }));

  // cálculo por grupo + total geral
  const resumoGrupos = grupos.map((g,i) => {
    const sub = g.itens.reduce((a,p)=>a+p.valor,0);
    const fk = fretes[i] || "sedex";
    const vf = (FRETE_FP[fk]||FRETE_FP["sedex"]).valor;
    return { ...g, idx:i, subtotal:sub, freteKey:fk, freteValor:vf, total:sub+vf };
  });
  const totalGeral = resumoGrupos.reduce((a,g)=>a+g.total,0);
  const totalFrete = resumoGrupos.reduce((a,g)=>a+g.freteValor,0);
  const totalPalmilhas = cesta.length;
  const pagarDepois = !antecipado;

  // confirma TODAS as remessas (uma por clínica) de uma vez
  const confirmar = () => {
    const remessas = resumoGrupos.map(g => ({
      clinicaId: g.clinicaId, clinica: g.clinica,
      ids: g.itens.map(p=>p.id),
      valores: g.itens.reduce((m,p)=>{m[p.id]=p.valor;return m;},{}),
      freteLabel:(FRETE_FP[g.freteKey]||{}).label||"", freteValor:g.freteValor,
      subtotal:g.subtotal, total:g.total
    }));
    onConfirm({
      remessas,
      ids: cesta.map(p=>p.id),
      valores: cesta.reduce((m,p)=>{m[p.id]=precoPalmilha(p.produto||p.tipo, antecipado);return m;},{}),
      pagamento, pagamentoLabel:(PAGAMENTO_OPCOES[pagamento]||{}).label||"", antecipado,
      subtotalGeral: resumoGrupos.reduce((a,g)=>a+g.subtotal,0),
      totalFrete, total: totalGeral, pagarDepois,
      multiplas: remessas.length > 1
    });
  };

  return (
    <Modal onClose={onClose}>
      <Card hover={false} p={0} style={{width:"94vw",maxWidth:540,maxHeight:"88vh",overflowY:"auto",animation:"slideUp .3s"}}>
        <div style={{padding:"16px 18px",borderBottom:`1px solid ${C.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          <div>
            ...
            <div style={{fontSize:12,color:C.muted,marginTop:2}}>{totalPalmilhas} pedido{totalPalmilhas!==1?"s":""} {grupos.length>1?`· ${grupos.length} clínicas`:""}</div>
          </div>
          <div onClick={onClose} style={{cursor:"pointer",fontSize:20,color:C.muted}}>✕</div>
        </div>
        <div style={{padding:18,display:"flex",flexDirection:"column",gap:14}}>

          {/* aviso quando há mais de uma clínica */}
          {grupos.length > 1 && (
            <div style={{display:"flex",gap:9,alignItems:"flex-start",padding:"11px 13px",background:`${C.accent}0A`,border:`1px solid ${C.accent}30`,borderRadius:10}}>
              <span style={{fontSize:16,flexShrink:0}}>📍</span>
              <div style={{fontSize:11,color:C.sub,lineHeight:1.55}}>Os pedidos são de <strong style={{color:C.text}}>clínicas diferentes</strong>, com endereços diferentes. Por isso, cada clínica tem o <strong style={{color:C.accent}}>seu próprio frete</strong> e vira uma remessa separada.</div>
            </div>
          )}

          {/* forma de pagamento (geral) */}
          <div>
            ...
            <div style={{fontSize:11,color:C.amber,marginTop:8}}>⏳ {grupos.length>1?"Estas remessas serão cobradas":"Esta remessa será cobrada"} no fechamento do mês.</div>
          </div>

          {/* um bloco por clínica */}
          {resumoGrupos.map(g => (
            <div key={g.idx} style={{border:`1px solid ${C.border}`,borderRadius:13,overflow:"hidden"}}>
              {/* cabeçalho da clínica */}
              <div style={{padding:"10px 13px",background:C.bgGlass,borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",gap:8}}>
                <span style={{fontSize:14}}>🏥</span>
                <span style={{fontSize:12.5,fontWeight:800,color:C.text,flex:1}}>{g.clinica}</span>
                <span style={{fontSize:10,color:C.muted,fontWeight:600}}>{g.itens.length} palmilha{g.itens.length!==1?"s":""}</span>
              </div>
              {/* itens da clínica */}
              <div style={{maxHeight:110,overflowY:"auto"}}>
                {g.itens.map(p=>(
                  <div key={p.id} style={{display:"flex",justifyContent:"space-between",padding:"7px 13px",borderBottom:`1px solid ${C.border}`,fontSize:11.5}}>
              ...
              <div style={{padding:"11px 13px"}}>
                <div style={{fontSize:9.5,color:C.accent,fontWeight:700,textTransform:"uppercase",letterSpacing:".06em",marginBottom:7}}>▸ Frete para esta clínica</div>
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:7}}>
                  {Object.entries(FRETE_FP).map(([k,o])=>(
                    <div key={k} onClick={()=>setFreteGrupo(g.idx,k)} style={{padding:"9px 11px",borderRadius:8,cursor:"pointer",border:`2px solid ${g.freteKey===k?C.green:C.border}`,background:g.freteKey===k?`${C.green}10`:"transparent"}}>
                      <div style={{fontSize:11.5,fontWeight:700,color:g.freteKey===k?C.green:C.text}}>{o.label}</div>
                      <div style={{fontSize:13,fontWeight:900,color:g.freteKey===k?C.green:C.sub,marginTop:2}}>R$ {brl(o.valor)}</div>
                    </div>
                  ))}
                </div>
                {/* subtotal da clínica */}
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:11,paddingTop:9,borderTop:`1px solid ${C.border}`}}>
                  <span style={{fontSize:11,color:C.muted}}>Subtotal + frete</span>
                  <span style={{fontSize:15,fontWeight:900,color:C.green}}>R$ {brl(g.total)}</span>
                </div>
              </div>
            </div>
          ))}
          ...
          <div style={{padding:14,background:`${C.green}07`,border:`1px solid ${C.green}22`,borderRadius:10}}>
            <div style={{display:"flex",justifyContent:"space-between",fontSize:12,color:C.sub,marginBottom:5}}><span>{totalPalmilhas} palmilha{totalPalmilhas!==1?"s":""}</span><span>R$ {brl(resumoGrupos.reduce((a,g)=>a+g.subtotal,0))}</span></div>
            <div style={{display:"flex",justifyContent:"space-between",fontSize:12,color:C.sub,marginBottom:8}}><span>Frete{grupos.length>1?`s (${grupos.length} clínicas)`:""}</span><span>R$ {brl(totalFrete)}</span></div>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",borderTop:`1px solid ${C.green}22`,paddingTop:8}}>
              <div style={{fontSize:13,fontWeight:800,color:C.text}}>Total {grupos.length>1?"geral":"da remessa"}</div>
              <div style={{fontSize:24,fontWeight:900,color:C.green}}>R$ {brl(totalGeral)}</div>
            </div>
          </div>
          ...
          <div style={{display:"flex",gap:10,flexWrap:"wrap"}}>
            ...
            <Btn v="primary" onClick={confirmar} style={{flex:2,justifyContent:"center",minWidth:200}}>{grupos.length>1?`Confirmar ${grupos.length} remessas`:"Confirmar envio"} · R$ {brl(totalGeral)}</Btn>
          </div>
        </div>
      </Card>
    </Modal>
...
function PedidosPage({pedidos,setPedidos,isAdmin,clinicaId,clinicaName,pacientes,onRecarregar,onExcluir}) {
  ...
  const fecharRemessa = (dados) => {
    ...
    // 🚚 Cada clínica vira uma remessa própria (com frete e ID separados).
    // Compatível com o formato antigo: se não vier "remessas", trata como remessa única.
    const remessas = dados.remessas || [{
      clinicaId:null, ids:dados.ids, valores:dados.valores,
      freteLabel:dados.freteLabel, freteValor:dados.freteValor,
      subtotal:dados.subtotal, total:dados.total
    }];
    // monta um mapa: pedidoId -> dados da sua remessa
    const base = Date.now().toString(36).toUpperCase();
    const porPedido = {};
    remessas.forEach((r, i) => {
      const rid = "REM-" + base + (remessas.length>1 ? "-" + (i+1) : "");
      (r.ids||[]).forEach(id => { porPedido[id] = { rid, freteLabel:r.freteLabel, freteValor:r.freteValor, valores:r.valores }; });
    });
    setPedidos(prev=>prev.map(p=>{
      const r = porPedido[p.id];
      if(!r) return p;
      return {
        ...p, enviado:true, remessaId:r.rid,
        freteLabel:r.freteLabel, freteValor:r.freteValor,
        pagamento:dados.pagamento, pagamentoLabel:dados.pagamentoLabel,
        antecipado:dados.antecipado, pagarDepois:dados.pagarDepois,
        valorPalmilha:(r.valores&&r.valores[p.id])!=null?r.valores[p.id]:precoPalmilha(p.produto||p.tipo, dados.antecipado),
  ...
  return (
    <div style={{padding:20}}>
      ...
      {/* 🎨 Faixa de status clicável */}
      <div style={{display:"flex",gap:7,flexWrap:"wrap",marginBottom:14}}>
        {[{k:"Todos",lbl:"Todos",ic:"📋",cor:C.accent,n:base.length}, ...STATUS_FLOW.map(st=>{ const cfg=STATUS_CFG[st]||{color:C.sub,icon:"•"}; return {k:st,lbl:st,ic:cfg.icon,cor:cfg.color,n:counts[st]||0}; })].map(t=>{
          const at = fSt===t.k;
          return (
            <button key={t.k} onClick={()=>setFSt(t.k)} style={{display:"flex",alignItems:"center",gap:7,padding:"7px 13px",borderRadius:10,border:`1px solid ${at?t.cor:C.border}`,background:at?`${t.cor}15`:C.bgGlass,cursor:"pointer",transition:"all .15s"}}>
              <span style={{fontSize:13}}>{t.ic}</span>
              <span style={{fontSize:12,fontWeight:at?800:600,color:at?t.cor:C.sub}}>{t.lbl}</span>
              <span style={{fontSize:10.5,fontWeight:900,color:at?t.cor:C.muted,background:at?`${t.cor}20`:C.border,borderRadius:99,padding:"1px 7px",minWidth:18,textAlign:"center"}}>{t.n}</span>
            </button>
          );
        })}
      </div>
      ...
      {vis.length===0 ? (
        <Card hover={false}><div style={{textAlign:"center",padding:44,color:C.muted}}><div style={{fontSize:38,marginBottom:12}}>📦</div><div style={{fontSize:14,fontWeight:700,color:C.sub}}>{isAdmin?"Nenhum pedido encontrado":"Sua clínica ainda não tem pedidos"}</div><div style={{fontSize:12,marginTop:5}}>{isAdmin?"Ajuste os filtros ou aguarde novos pedidos.":"Clique em + Novo Pedido para começar."}</div></div></Card>
      ) : (
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(290px,1fr))",gap:13}}>
          {vis.map(p=>{
            const hr=!!p.rastreio;
            const cfg=STATUS_CFG[p.status]||{color:C.sub,icon:"•"};
            const ehChinelo=/hinelo/i.test(p.produto||p.tipo||"");
            return (
              <Card key={p.id} p={0} hover style={{overflow:"hidden",cursor:"pointer",border:`1px solid ${C.border}`}} onClick={()=>setDetail(p)}>
                {/* faixa colorida de status no topo do card */}
                <div style={{height:4,background:cfg.color}}/>
                <div style={{padding:15}}>
                  <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:10,marginBottom:12}}>
                    <div style={{display:"flex",alignItems:"center",gap:10,minWidth:0}}>
                      <div style={{width:40,height:40,borderRadius:11,flexShrink:0,background:`linear-gradient(135deg,${C.accent}30,${C.purple}25)`,border:`1px solid ${C.accent}25`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:15,fontWeight:900,color:C.soft}}>{(p.paciente||"?").charAt(0).toUpperCase()}</div>
                      <div style={{minWidth:0}}>
                        <div style={{fontSize:14,fontWeight:800,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{p.paciente||"(sem nome)"}</div>
                        <div style={{fontSize:10,color:C.accent,fontFamily:"'Space Mono',monospace",fontWeight:700}}>{p.id}</div>
                      </div>
                    </div>
                    <SBadge status={p.status}/>
                  </div>
                  <div style={{display:"flex",alignItems:"center",gap:8,fontSize:12,color:C.sub,marginBottom:6}}>
                    <span style={{fontSize:15}}>{ehChinelo?"🩴":"👟"}</span>
                    <span style={{fontWeight:600}}>{p.tipoPalmilha||p.tipo||"Palmilha"}</span>
                  </div>
                  {isAdmin&&p.clinica&&<div style={{fontSize:11,color:C.muted,marginBottom:8,display:"flex",alignItems:"center",gap:5}}>🏥 {p.clinica}</div>}
                  <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8,marginTop:10,paddingTop:11,borderTop:`1px solid ${C.border}`}}>
                    <span style={{fontSize:10.5,color:C.muted}}>📅 {fmtD(p.data)}</span>
                    {hr
                      ? <a href={linkRastreioGlobal(p.rastreio,p.transportadora)} target="_blank" rel="noreferrer" onClick={e=>e.stopPropagation()} style={{display:"inline-flex",alignItems:"center",gap:4,padding:"3px 9px",borderRadius:7,fontSize:10,fontWeight:700,background:`${C.green}13`,color:C.green,textDecoration:"none",border:`1px solid ${C.green}28`}}>🔗 Rastrear</a>
                      : <span style={{fontSize:10.5,color:C.muted,fontStyle:"italic"}}>sem rastreio</span>}
                  </div>
                  <div style={{display:"flex",gap:6,marginTop:11}} onClick={e=>e.stopPropagation()}>
                    <Btn v="subtle" sz="sm" style={{flex:1,justifyContent:"center"}} onClick={()=>setDetail(p)}>{isAdmin?"✏️ Editar":"👁 Ver detalhes"}</Btn>
                    {isAdmin&&<button onClick={()=>delPedido(p)} style={{background:"none",color:C.red,fontSize:13,padding:"0 9px",cursor:"pointer"}}>🗑️</button>}
                  </div>
                </div>
              </Card>
            );
                      ...
                      {expandedId===c.id&&(
                        <tr style={{borderBottom:`1px solid ${C.border}`}}>
                          <td colSpan={8} style={{padding:"0 14px 14px 14px",background:"rgba(255,255,255,.015)"}}>
                            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(120px,1fr))",gap:8,paddingTop:12}}>
                              {[
                                ["📄 CNPJ",c.cnpj||"—"],
                                ["🪪 CPF Resp.",c.cpf||"—"],
                                ["📍 CEP",c.cep||"—"],
...
function ProducaoPage({pedidos,setPedidos}) {
  ...
  const emAndamento = pedidos.filter(p=>!["Recebido","Finalizado","Entregue"].includes(p.status)).length;
  const finalizados = pedidos.filter(p=>p.status==="Finalizado").length;
  const enviados = pedidos.filter(p=>p.status==="Enviado").length;
  // próxima etapa no fluxo de produção
  const proxEtapa = (atual) => { const i=STATUS_FLOW.indexOf(atual); return (i>=0 && i<STATUS_FLOW.length-1) ? STATUS_FLOW[i+1] : null; };
  // há quanto tempo está na etapa (a partir do updatedAt)
  const tempoNaEtapa = (ts) => {
    if(!ts) return null;
    const ms = Date.now() - (typeof ts==="number"?ts:new Date(ts).getTime());
    if(isNaN(ms)||ms<0) return null;
    const h = Math.floor(ms/3600000); const dias = Math.floor(h/24);
    if(dias>=1) return `${dias}d`; if(h>=1) return `${h}h`; return `${Math.max(1,Math.floor(ms/60000))}min`;
  };
  return (
    <div style={{padding:20}}>
      <SH title="🏭 Painel de Produção" sub="Arraste os cartões entre as colunas ou use o botão de avançar"/>
      {/* Resumo da produção */}
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(130px,1fr))",gap:10,marginBottom:16}}>
        {[
          {l:"Em andamento",v:emAndamento,i:"⚙️",c:C.amber},
          {l:"Prontos p/ envio",v:pedidos.filter(p=>p.status==="Acabamento").length,i:"📦",c:C.accent},
          {l:"Enviados",v:enviados,i:"🚚",c:C.soft},
          {l:"Finalizados",v:finalizados,i:"✅",c:C.green},
        ].map((x,i)=>(
          <Card key={i} p={14} hover={false} style={{border:`1px solid ${x.c}20`}}>
            <div style={{display:"flex",alignItems:"center",gap:9}}>
              <div style={{width:36,height:36,borderRadius:10,background:`${x.c}15`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:17,flexShrink:0}}>{x.i}</div>
              <div><div style={{fontSize:22,fontWeight:900,color:x.c,lineHeight:1}}>{x.v}</div><div style={{fontSize:10,color:C.muted,marginTop:2,fontWeight:600}}>{x.l}</div></div>
            </div>
          </Card>
        ))}
      </div>
      {/* Kanban */}
      <div style={{display:"grid",gridTemplateColumns:"repeat(6,minmax(168px,1fr))",gap:11,overflowX:"auto",paddingBottom:8}}>
        {cols.map(col=>{
          const sc=STATUS_CFG[col]||{color:C.sub,icon:"•"};
          const items=pedidos.filter(p=>p.status===col);
          const ehDrag = drag && pedidos.find(x=>x.id===drag)?.status!==col;
          return (
            <div key={col} onDragOver={e=>e.preventDefault()} onDrop={()=>drag&&move(drag,col)} style={{borderRadius:12,padding:ehDrag?6:0,background:ehDrag?`${sc.color}08`:"transparent",border:ehDrag?`2px dashed ${sc.color}50`:"2px dashed transparent",transition:"all .15s"}}>
              <div style={{padding:"9px 12px",borderRadius:10,marginBottom:9,background:`${sc.color}12`,border:`1px solid ${sc.color}28`,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                <span style={{fontSize:11,fontWeight:800,color:sc.color,display:"flex",alignItems:"center",gap:5}}><span style={{fontSize:13}}>{sc.icon}</span>{col}</span>
                <span style={{minWidth:20,height:20,borderRadius:99,background:sc.color,display:"flex",alignItems:"center",justifyContent:"center",fontSize:10,fontWeight:900,color:"#fff",padding:"0 6px"}}>{items.length}</span>
              </div>
              <div style={{display:"flex",flexDirection:"column",gap:8,minHeight:60}}>
                {items.length===0 && <div style={{textAlign:"center",padding:"18px 8px",fontSize:10,color:C.muted,fontStyle:"italic",border:`1px dashed ${C.border}`,borderRadius:9}}>vazio</div>}
                {items.map(p=>{
                  const ehChinelo=/hinelo/i.test(p.produto||p.tipo||"");
                  const prox=proxEtapa(p.status);
                  const tempo=tempoNaEtapa(p.updatedAt);
                  return (
                    <div key={p.id} draggable onDragStart={()=>setDrag(p.id)} onDragEnd={()=>setDrag(null)}>
                      <Card hover style={{padding:0,cursor:"grab",userSelect:"none",overflow:"hidden",border:`1px solid ${C.border}`}}>
                        <div style={{height:3,background:sc.color}}/>
                        <div style={{padding:11}}>
                          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:6,marginBottom:6}}>
                            <span style={{fontFamily:"'Space Mono',monospace",fontSize:9,color:sc.color,fontWeight:700}}>{p.id}</span>
                            {tempo&&<span style={{fontSize:8.5,color:C.muted,background:C.bgGlass,borderRadius:99,padding:"1px 6px"}}>⏱ {tempo}</span>}
                          </div>
                          <div style={{display:"flex",alignItems:"center",gap:7,marginBottom:7}}>
                            <span style={{fontSize:15}}>{ehChinelo?"🩴":"👟"}</span>
                            <div style={{minWidth:0}}>
                              <div style={{fontWeight:800,fontSize:12,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{p.paciente}</div>
                              <div style={{fontSize:9.5,color:C.muted,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{p.clinica}</div>
                            </div>
                          </div>
                          <div style={{fontSize:9.5,color:C.sub,marginBottom:9,fontWeight:600}}>{p.tipoPalmilha||p.tipo||"Palmilha"}</div>
                          {prox && <button onClick={()=>move(p.id,prox)} style={{width:"100%",padding:"6px",borderRadius:7,fontSize:10,fontWeight:800,background:`${(STATUS_CFG[prox]||{}).color||C.accent}15`,color:(STATUS_CFG[prox]||{}).color||C.accent,border:`1px solid ${(STATUS_CFG[prox]||{}).color||C.accent}35`,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:4}}>{(STATUS_CFG[prox]||{}).icon} Avançar → {prox}</button>}
                        </div>
                      </Card>
                    </div>
                  );
...
// ─── PRONTUÁRIO ────────────────────────────────────────────────────────────────
function ProntuarioModal({paciente,onClose,clinicaId,planoIA,pedidosReais}) {
  ...
  // 💰 Recebimentos do paciente (a recepção marca o que foi pago — SEM ver faturamento da clínica)
  const KEY_PAG_PAC = "fp:pagpac:" + paciente.id;
  const [pagPac, setPagPac] = useState(() => LS.read(KEY_PAG_PAC) || {});
  const FORMAS_PAG = ["PIX","Dinheiro","Cartão","Transferência","Boleto"];
  const ITENS_PAG = [{id:"consulta",label:"Consulta",icon:"🩺"},{id:"avaliacao",label:"Avaliação",icon:"📋"},{id:"palmilha",label:"Palmilha",icon:"🦶"}];
  const marcarPagPac = (item, forma) => { const n = {...pagPac, [item]:{ts:Date.now(), forma:forma||"PIX"}}; setPagPac(n); LS.write(KEY_PAG_PAC, n); };
  const desmarcarPagPac = (item) => { const n = {...pagPac}; delete n[item]; setPagPac(n); LS.write(KEY_PAG_PAC, n); };
  // 📋 Plano de tratamento do paciente (persistido por paciente)
  const KEY_PLANO = "fp:plano:" + paciente.id;
  const [plano, setPlano] = useState(() => LS.read(KEY_PLANO) || null);
  const salvarPlano = (p) => { setPlano(p); LS.write(KEY_PLANO, p); };
  // cria um plano a partir de um modelo (ou em branco)
  const criarPlanoDeModelo = (mod) => {
    const etapas = [];
    for(let i=1;i<=mod.sessoes;i++) etapas.push({ id:"s"+i, tipo:"Sessão", rotulo:`Sessão ${i}`, feito:false, data:null });
    for(let i=1;i<=mod.reavaliacoes;i++) etapas.push({ id:"r"+i, tipo:"Reavaliação", rotulo:`Reavaliação ${i}`, feito:false, data:null });
    if(mod.palmilha) etapas.push({ id:"palm", tipo:"Palmilha", rotulo:"Entrega da palmilha", feito:false, data:null });
    salvarPlano({ nome:mod.nome, icon:mod.icon, desc:mod.desc, criadoEm:Date.now(), etapas });
  };
  const toggleEtapa = (eid) => {
    if(!plano) return;
    const etapas = plano.etapas.map(e => e.id===eid ? {...e, feito:!e.feito, data:!e.feito?new Date().toISOString().split("T")[0]:null} : e);
    salvarPlano({...plano, etapas});
  };
  // 🏭 procedimentos cadastrados pela clínica (Centro de Procedimentos)
  const [procsClin, setProcsClin] = useState(() => LS.read("fp:procedimentos:" + clinicaId) || []);
  const [showAddProc, setShowAddProc] = useState(false);
  useEffect(() => { (async () => { const l = await LS.readAsync("fp:procedimentos:" + clinicaId); if (l) setProcsClin(l); })(); }, [clinicaId]);
  const adicionarProcedimento = (proc) => {
    if(!plano) return;
    salvarPlano({...plano, etapas:[...plano.etapas, { id:"proc"+Date.now(), tipo:"Procedimento", rotulo:proc.nome, icon:proc.icon, feito:false, data:null }]});
    setShowAddProc(false);
  };
  const removerEtapa = (eid) => {
    if(!plano) return;
    salvarPlano({...plano, etapas: plano.etapas.filter(e => e.id !== eid)});
  };
  const ABAS = [{id:"timeline",icon:"🕒",label:"Timeline 360°"},{id:"resumo",icon:"⬡",label:"Resumo"},{id:"plano",icon:"📋",label:"Plano de Tratamento"},{id:"consultas",icon:"🎙️",label:"Consultas"},{id:"avaliacoes",icon:"🩺",label:"Avaliações"},{id:"evolucao",icon:"📋",label:"Evolução"},{id:"dor",icon:"📈",label:"Evolução da Dor"},{id:"pedidos",icon:"📦",label:"Pedidos"},{id:"pagamentos",icon:"💰",label:"Pagamentos"},{id:"exames",icon:"🔬",label:"Exames"},{id:"chat",icon:"💬",label:"Chat"},{id:"prescricoes",icon:"💊",label:"Prescrições"}];
  ...
  // ── Exames arquivados na nuvem (persistidos na ficha do paciente) ──
  const [examesArq, setExamesArq] = useState(() => paciente.examesArquivo || []);
  const [subindoExame, setSubindoExame] = useState(false);
  const exameInputRef = useRef(null);

  const arquivarExame = async (file) => {
    if(!file) return;
    setSubindoExame(true);
    try {
      const url = await STORAGE_FP.upload(file, "exames");
      const ext = (file.name.split(".").pop()||"").toUpperCase();
      const novo = { id:"EX-"+Date.now().toString(36), nome:file.name, tipo:(ext==="PDF"?"PDF":(["STL","OBJ"].includes(ext)?"3D":"IMG")), data:new Date().toISOString().split("T")[0], url, tamanho:Math.round(file.size/1024) };
      const lista = [novo, ...examesArq];
      setExamesArq(lista);
      // persiste na ficha do paciente
      if(typeof setPacientesGlobal==="function"){ setPacientesGlobal(prev=>prev.map(p=>p.id===paciente.id?{...p,examesArquivo:lista}:p)); }
    } catch(e) { alert("Não foi possível enviar o exame agora. Tente novamente."); }
    setSubindoExame(false);
  };

  // ── 🧬 IA DE EVOLUÇÃO: analisa a linha do tempo e gera parecer de progresso ──
  const [evoIA, setEvoIA] = useState(null);
  const [loadingEvoIA, setLoadingEvoIA] = useState(false);
  const [erroEvoIA, setErroEvoIA] = useState("");
  ...
  // 🧬 PRONTUÁRIO BIOMECÂNICO: reúne os eventos REAIS que o paciente acumula ao longo do tempo
  const prontsEscriba = paciente.prontuarios || [];
  const pedidosDoPac = (pedidosReais||[]).filter(p => p.pacienteId===paciente.id || (p.paciente && `${paciente.nome} ${paciente.sobrenome||""}`.trim().toLowerCase()===String(p.paciente).toLowerCase()));
  const descBaro = (b) => { if(b.result && typeof b.result==="object"){ return b.result.diagnostico || b.result.distribuicao || "Análise baropodométrica realizada"; } return (typeof b.result==="string"? b.result.slice(0,140) : "Análise baropodométrica realizada"); };
  const eventosTimeline = [
    // Consultas gravadas pelo Escriba (queixa principal vira o resumo do evento)
    ...prontsEscriba.map(n=>({tipo:"Consulta",icon:"🩺",cor:C.purple,data:n.data,desc:(n.secoes&&(n.secoes.queixa||n.secoes.conduta))||"Consulta registrada pelo Escriba",link:n.laudoUrl,linkLabel:"🧾 Laudo"})),
    // Baropodometrias (com link do exame e do laudo na nuvem)
    ...baros.map(b=>({tipo:"Baropodometria",icon:"🦶",cor:C.soft,data:b.data,desc:descBaro(b),link:b.laudoUrl||b.exameUrl,linkLabel:b.laudoUrl?"🧾 Laudo":"📎 Exame"})),
    // Pedidos de palmilha REAIS do paciente
    ...pedidosDoPac.map(p=>({tipo:"Palmilha",icon:"📦",cor:C.green,data:p.data||p.criadoEm,desc:`${p.tipoCalcado||p.tipo||"Palmilha"}${p.status?" — "+p.status:""}`})),
    // Evoluções manuais e dor (quando registradas)
    ...(evos||[]).map(e=>({tipo:"Evolução",icon:"📋",cor:C.accent,data:e.data,desc:e.texto,extra:e.prof})),
    ...dorReg.map(d=>({tipo:"Dor",icon:"📈",cor:C.amber,data:d.data,desc:`Nível de dor: ${d.nivel??d.valor??d.intensidade??"—"}/10${d.local?` — ${d.local}`:""}`})),
    // Exames arquivados na nuvem
    ...((paciente.examesArquivo)||[]).map(x=>({tipo:"Exame",icon:"📎",cor:C.gold,data:x.data,desc:x.nome||"Exame arquivado",link:x.url,linkLabel:"👁️ Abrir"})),
    // Dados de mock legados (se existirem) — não atrapalham
    ...(dados.avaliacoes||[]).map(a=>({tipo:"Avaliação",icon:"🩺",cor:C.accent,data:a.data,desc:a.tipo||a.queixa||a.texto||"Avaliação clínica"})),
    ...(dados.exames||[]).map(x=>({tipo:"Exame",icon:"🔬",cor:C.gold,data:x.data,desc:x.nome||x.tipo||"Exame anexado"})),
  ].filter(e=>e.desc && e.data).sort((a,b)=>parseData(b.data)-parseData(a.data));
  ...
  // IA DE EVOLUCAO: analisa o historico do paciente ao longo do tempo
  const analisarEvolucao = async () => {
    const permIA = podeUsarIAqtd(clinicaId, planoIA, 2);
    if(!permIA.ok){ setErroEvoIA(permIA.msg); return; }
    setLoadingEvoIA(true); setErroEvoIA(""); setEvoIA(null);
    const linha = [...eventosTimeline].reverse().map(ev=>({ data:ev.data, tipo:ev.tipo, resumo:ev.desc }));
    const ctx = {
      paciente: (paciente.nome+" "+(paciente.sobrenome||"")).trim(),
      patologia: paciente.patologia || "nao informada",
      baropodometrias: (baros||[]).map(b=>({ data:b.data, achados: (b.result&&typeof b.result==="object")?(b.result.diagnostico||b.result.distribuicao):b.result })),
      consultas: (paciente.prontuarios||[]).map(n=>({ data:n.data, queixa:n.secoes&&n.secoes.queixa, avaliacao:n.secoes&&n.secoes.avaliacao, conduta:n.secoes&&n.secoes.conduta })),
      evolucao_dor: dorReg,
      linha_do_tempo: linha,
    };
    const PROMPT = "Voce e um fisioterapeuta especialista em biomecanica da FisioPiede analisando a EVOLUCAO de um paciente ao longo do tempo. Compare os registros do mais antigo ao mais recente e descreva o progresso. NUNCA invente dados que nao estao no historico; se houver poucos registros, diga que ainda ha poucos dados para conclusoes. Dados: "+JSON.stringify(ctx)+". Responda SOMENTE um JSON valido (sem markdown): {\"panorama\":\"paragrafo sobre como o paciente evoluiu do inicio ate agora\",\"melhoras\":[\"ponto de melhora 1\",\"ponto 2\"],\"atencao\":[\"ponto que ainda precisa de atencao 1\"],\"tendencia\":\"uma palavra: Melhorando, Estavel ou Piorando\",\"recomendacao\":\"proximo passo recomendado\"}";
    try {
      const res = await fetch("/api/ia", {
        method:"POST", headers:{"Content-Type":"application/json"},
        body: JSON.stringify({ model:"claude-opus-4-7", max_tokens:1200, messages:[{role:"user",content:[{type:"text",text:PROMPT}]}] }),
      });
      const data = await res.json();
      if(!res.ok) throw new Error("falha");
      let txt = (data.content||[]).map(b=>b.text||"").join("").replace(/```json|```/g,"").trim();
      const mm = txt.match(/\{[\s\S]*\}/);
      setEvoIA(JSON.parse(mm?mm[0]:txt));
    } catch(e) {
      setErroEvoIA("Nao foi possivel analisar a evolucao agora. Verifique se o sistema esta publicado e tente novamente.");
    }
    setLoadingEvoIA(false);
  };
        ...
        <div style={{flex:1,overflowY:"auto",padding:22}}>
          {aba==="timeline"&&(
            <div>
              <div style={{marginBottom:18}}>
                <div style={{fontSize:16,fontWeight:800,display:"flex",alignItems:"center",gap:8}}>🧬 Prontuário Biomecânico</div>
                <div style={{fontSize:11.5,color:C.muted,marginTop:3}}>A evolução biomecânica completa do paciente — consultas, baropodometrias e palmilhas — em ordem cronológica.{eventosTimeline.length>0?` ${eventosTimeline.length} marco(s) registrado(s).`:""}</div>
              </div>
                  ...
                  {eventosTimeline.map((ev,i)=>(
                    <div key={i} style={{position:"relative",marginBottom:14,animation:`fadeUp .4s ${i*0.04}s ease both`,opacity:0}}>
                      ...
                      <Card p={14} style={{border:`1px solid ${ev.cor}25`}}>
                        ...
                        {ev.link&&<a href={ev.link} target="_blank" rel="noreferrer" style={{display:"inline-block",marginTop:7,fontSize:11,fontWeight:700,color:ev.cor,textDecoration:"none"}}>{ev.linkLabel||"Abrir"} →</a>}
                      </Card>
                    </div>
                  ))}
                </div>
          ...
          {aba==="plano"&&(
            <div style={{display:"flex",flexDirection:"column",gap:14}}>
              {!plano ? (
                <>
                  <Card hover={false} p={16} style={{background:`linear-gradient(135deg,${C.accent}0A,${C.purple}06)`,border:`1px solid ${C.accent}25`}}>
                    <div style={{fontSize:13.5,fontWeight:800,color:C.accent}}>📋 Plano de Tratamento</div>
                    <div style={{fontSize:11.5,color:C.muted,marginTop:3,lineHeight:1.5}}>Escolha um modelo pronto ou crie do zero. O sistema acompanha cada sessão, reavaliação e a entrega da palmilha.</div>
                  </Card>
                  <div style={{fontSize:11,color:C.muted,fontWeight:700,textTransform:"uppercase",letterSpacing:".06em"}}>Modelos prontos</div>
                  <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(240px,1fr))",gap:10}}>
                    {MODELOS_PLANO.map(mod=>(
                      <Card key={mod.id} p={15} hover style={{cursor:"pointer"}} onClick={()=>criarPlanoDeModelo(mod)}>
                        <div style={{display:"flex",alignItems:"center",gap:9,marginBottom:6}}><span style={{fontSize:22}}>{mod.icon}</span><div style={{fontSize:13.5,fontWeight:800}}>{mod.nome}</div></div>
                        <div style={{fontSize:11,color:C.muted,lineHeight:1.5,marginBottom:9}}>{mod.desc}</div>
                        <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
                          <span style={{fontSize:9.5,fontWeight:700,color:C.accent,background:`${C.accent}15`,padding:"2px 8px",borderRadius:99}}>{mod.sessoes} sessões</span>
                          <span style={{fontSize:9.5,fontWeight:700,color:C.purple,background:`${C.purple}15`,padding:"2px 8px",borderRadius:99}}>{mod.reavaliacoes} reaval.</span>
                          {mod.palmilha&&<span style={{fontSize:9.5,fontWeight:700,color:C.green,background:`${C.green}15`,padding:"2px 8px",borderRadius:99}}>🦶 palmilha</span>}
                        </div>
                      </Card>
                    ))}
                  </div>
                  <Card hover p={15} style={{cursor:"pointer",border:`1px dashed ${C.border}`,textAlign:"center"}} onClick={()=>salvarPlano({nome:"Plano personalizado",icon:"📋",desc:"Plano criado do zero",criadoEm:Date.now(),etapas:[{id:"s1",tipo:"Sessão",rotulo:"Sessão 1",feito:false,data:null}]})}>
                    <div style={{fontSize:13,fontWeight:700,color:C.sub}}>➕ Criar plano do zero</div>
                    <div style={{fontSize:10.5,color:C.muted,marginTop:2}}>Começa com 1 sessão e você adiciona o que quiser</div>
                  </Card>
                </>
              ) : (()=>{
                const feitas = plano.etapas.filter(e=>e.feito).length;
                const total = plano.etapas.length;
                const pct = total>0 ? Math.round(feitas/total*100) : 0;
                const corEtapa = (t) => t==="Reavaliação"?C.purple:t==="Palmilha"?C.green:t==="Procedimento"?C.gold:C.accent;
                const iconEtapa = (t) => t==="Reavaliação"?"🔄":t==="Palmilha"?"🦶":t==="Procedimento"?"🏭":"🩺";
                return (
                  <>
                    <Card hover={false} p={18} style={{background:`linear-gradient(135deg,${C.accent}0C,${C.purple}06)`,border:`1px solid ${C.accent}30`}}>
                      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,flexWrap:"wrap"}}>
                        <div style={{display:"flex",alignItems:"center",gap:11}}>
                          <span style={{fontSize:26}}>{plano.icon}</span>
                          <div><div style={{fontSize:15,fontWeight:900}}>{plano.nome}</div><div style={{fontSize:11,color:C.muted,marginTop:1}}>{plano.desc}</div></div>
                        </div>
                        <button onClick={()=>{ if(confirm("Trocar o plano? O progresso atual será apagado.")) salvarPlano(null); }} style={{background:"none",color:C.muted,fontSize:11,fontWeight:700,textDecoration:"underline",cursor:"pointer"}}>trocar plano</button>
                      </div>
                      <div style={{marginTop:16}}>
                        <div style={{display:"flex",justifyContent:"space-between",fontSize:11,fontWeight:700,marginBottom:6}}><span style={{color:C.sub}}>{feitas} de {total} etapas concluídas</span><span style={{color:pct===100?C.green:C.accent}}>{pct}%</span></div>
                        <div style={{height:10,background:C.border,borderRadius:99,overflow:"hidden"}}><div style={{height:"100%",width:`${pct}%`,background:pct===100?`linear-gradient(90deg,${C.green},${C.accent})`:`linear-gradient(90deg,${C.accent},${C.purple})`,borderRadius:99,transition:"width .5s ease"}}/></div>
                        {pct===100&&<div style={{fontSize:11.5,color:C.green,fontWeight:700,marginTop:8,textAlign:"center"}}>🎉 Plano de tratamento concluído!</div>}
                      </div>
                    </Card>
                    <div style={{display:"flex",flexDirection:"column",gap:7}}>
                      {plano.etapas.map(e=>(
                        <Card key={e.id} p={13} style={{border:e.feito?`1px solid ${corEtapa(e.tipo)}40`:`1px solid ${C.border}`,background:e.feito?`${corEtapa(e.tipo)}07`:undefined}}>
                          <div style={{display:"flex",alignItems:"center",gap:11}}>
                            <button onClick={()=>toggleEtapa(e.id)} style={{width:26,height:26,borderRadius:7,flexShrink:0,border:e.feito?"none":`2px solid ${C.border}`,background:e.feito?corEtapa(e.tipo):"transparent",color:"#fff",fontSize:14,fontWeight:900,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"}}>{e.feito?"✓":""}</button>
                            <span style={{fontSize:16}}>{e.icon||iconEtapa(e.tipo)}</span>
                            <div style={{flex:1}}>
                              <div style={{fontSize:13,fontWeight:700,textDecoration:e.feito?"line-through":"none",opacity:e.feito?.7:1}}>{e.rotulo}</div>
                              {e.feito&&e.data&&<div style={{fontSize:10,color:corEtapa(e.tipo),fontWeight:600,marginTop:1}}>✓ {e.data.split("-").reverse().join("/")}</div>}
                            </div>
                            <span style={{fontSize:9.5,fontWeight:700,color:corEtapa(e.tipo),background:`${corEtapa(e.tipo)}15`,padding:"2px 8px",borderRadius:99}}>{e.tipo}</span>
                            <button onClick={()=>removerEtapa(e.id)} style={{background:"none",color:C.muted,fontSize:13,cursor:"pointer",padding:"0 2px"}} title="Remover etapa">×</button>
                          </div>
                        </Card>
                      ))}
                    </div>
                    <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
                      <button onClick={()=>{ const n=plano.etapas.filter(x=>x.tipo==="Sessão").length+1; salvarPlano({...plano,etapas:[...plano.etapas,{id:"s"+Date.now(),tipo:"Sessão",rotulo:`Sessão ${n}`,feito:false,data:null}]}); }} style={{flex:1,minWidth:140,padding:"10px",borderRadius:9,border:`1px dashed ${C.border}`,background:"transparent",color:C.sub,fontSize:12,fontWeight:700,cursor:"pointer"}}>➕ Adicionar sessão</button>
                      {procsClin.length>0 && <button onClick={()=>setShowAddProc(s=>!s)} style={{flex:1,minWidth:140,padding:"10px",borderRadius:9,border:`1px dashed ${C.gold}55`,background:showAddProc?`${C.gold}10`:"transparent",color:C.gold,fontSize:12,fontWeight:700,cursor:"pointer"}}>🏭 Adicionar procedimento</button>}
                    </div>
                    {showAddProc && procsClin.length>0 && (
                      <Card hover={false} p={13} style={{border:`1px solid ${C.gold}30`,background:`${C.gold}06`}}>
                        <div style={{fontSize:11,fontWeight:700,color:C.gold,marginBottom:8}}>Escolha um procedimento da sua clínica:</div>
                        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(170px,1fr))",gap:7}}>
                          {procsClin.map(proc=>(
                            <button key={proc.id} onClick={()=>adicionarProcedimento(proc)} style={{textAlign:"left",padding:"8px 11px",borderRadius:8,background:C.bgCard,border:`1px solid ${C.border}`,cursor:"pointer"}}>
                              <div style={{display:"flex",alignItems:"center",gap:7}}><span style={{fontSize:15}}>{proc.icon}</span><span style={{fontSize:12,fontWeight:700}}>{proc.nome}</span></div>
                              <div style={{fontSize:9.5,color:C.muted,marginTop:3}}>{proc.duracao}min{proc.valor?` · R$ ${brl(proc.valor)}`:""}</div>
                            </button>
                          ))}
                        </div>
                      </Card>
          ...
          {aba==="consultas"&&(() => {
            const consultas = [...(paciente.prontuarios||[])].sort((a,b)=>(b.data||"").localeCompare(a.data||""));
            const SECOES = [
              ["queixa","🗣️ Queixa principal",C.accent],
              ["historia","📜 História clínica",C.soft],
              ["exame","🔍 Exame físico",C.cyan||C.soft],
              ["avaliacao","🧠 Avaliação / hipótese",C.purple],
              ["conduta","💡 Conduta",C.green],
              ["orientacoes","🏠 Orientações",C.gold],
              ["retorno","🔄 Retorno",C.pink],
            ];
            return (
              <div style={{display:"flex",flexDirection:"column",gap:14}}>
                <div style={{display:"flex",gap:9,alignItems:"flex-start",padding:"11px 14px",background:`${C.purple}0A`,border:`1px solid ${C.purple}25`,borderRadius:10}}>
                  <span style={{fontSize:17,flexShrink:0}}>🎙️</span>
                  <div style={{fontSize:11.5,color:C.sub,lineHeight:1.55}}>Aqui ficam as consultas gravadas pelo <strong style={{color:C.text}}>Escriba</strong>: a transcrição e o prontuário estruturado pela IA. Para gravar uma nova, vá em <strong style={{color:C.purple}}>IA → Escriba da Consulta</strong>.</div>
                </div>
                {consultas.length===0 && (
                  <div style={{textAlign:"center",padding:44,color:C.muted}}>
                    <div style={{fontSize:40,marginBottom:12}}>🎙️</div>
                    <div style={{fontSize:14,fontWeight:700,color:C.sub}}>Nenhuma consulta gravada ainda</div>
                    <div style={{fontSize:12,marginTop:5}}>Use o Escriba (em IA) para gravar e transcrever uma consulta — ela aparece aqui automaticamente.</div>
                  </div>
                )}
                {consultas.map(n=>{
                  const sec = n.secoes||{};
                  const temConteudo = SECOES.some(([k])=>sec[k]);
                  return (
                    <Card key={n.id} p={0} style={{overflow:"hidden",border:`1px solid ${C.purple}25`}}>
                      <div style={{padding:"12px 16px",background:`linear-gradient(135deg,${C.purple}10,${C.accent}06)`,borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,flexWrap:"wrap"}}>
                        <div style={{display:"flex",alignItems:"center",gap:10}}>
                          <span style={{fontSize:18}}>🩺</span>
                          <div>
                            <div style={{fontSize:13,fontWeight:800}}>Consulta · {n.data?n.data.split("-").reverse().join("/"):"—"}</div>
                            <div style={{fontSize:10,color:C.muted}}>{n.editadoEm?"editada":"registrada pelo Escriba"}</div>
                          </div>
                        </div>
                        {n.laudoUrl && <a href={n.laudoUrl} target="_blank" rel="noreferrer" style={{fontSize:11,fontWeight:700,color:C.purple,textDecoration:"none",background:`${C.purple}15`,padding:"5px 12px",borderRadius:8,border:`1px solid ${C.purple}30`}}>🧾 Ver laudo</a>}
                      </div>
                      <div style={{padding:16,display:"flex",flexDirection:"column",gap:12}}>
                        {temConteudo ? SECOES.map(([k,lbl,cor])=> sec[k] && (
                          <div key={k}>
                            <div style={{fontSize:10,color:cor,fontWeight:700,textTransform:"uppercase",marginBottom:4}}>{lbl}</div>
                            <div style={{fontSize:13,color:C.sub,lineHeight:1.6,padding:"9px 12px",background:C.bgGlass,borderRadius:8,border:`1px solid ${C.border}`}}>{sec[k]}</div>
                          </div>
                        )) : <div style={{fontSize:12,color:C.muted,fontStyle:"italic"}}>Sem seções estruturadas.</div>}
                        {n.transcricao && (
                          <details style={{marginTop:4}}>
                            <summary style={{fontSize:11,fontWeight:700,color:C.muted,cursor:"pointer",padding:"6px 0"}}>📝 Ver transcrição completa do áudio</summary>
                            <div style={{fontSize:12,color:C.sub,lineHeight:1.65,padding:"11px 13px",background:C.bgGlass,borderRadius:8,border:`1px solid ${C.border}`,marginTop:6,whiteSpace:"pre-wrap"}}>{n.transcricao}</div>
                          </details>
                        )}
                      </div>
                    </Card>
          ...
          {aba==="pagamentos"&&(
            <div style={{display:"flex",flexDirection:"column",gap:14}}>
              <Card hover={false} p={16} style={{background:`linear-gradient(135deg,${C.green}0A,${C.accent}06)`,border:`1px solid ${C.green}25`}}>
                <div style={{fontSize:13,fontWeight:800,color:C.green,display:"flex",alignItems:"center",gap:8}}>💰 Recebimentos do paciente</div>
                <div style={{fontSize:11,color:C.muted,marginTop:3,lineHeight:1.5}}>Marque o que o paciente já pagou. Serve para a recepção controlar os pagamentos deste paciente — sem precisar abrir o financeiro da clínica.</div>
              </Card>
              <div style={{display:"flex",flexDirection:"column",gap:10}}>
                {ITENS_PAG.map(it=>{
                  const pg = pagPac[it.id];
                  return (
                    <Card key={it.id} p={15} style={{border:pg?`1px solid ${C.green}45`:`1px solid ${C.border}`,background:pg?`${C.green}07`:undefined}}>
                      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,flexWrap:"wrap"}}>
                        <div style={{display:"flex",alignItems:"center",gap:11}}>
                          <div style={{width:40,height:40,borderRadius:10,background:pg?`${C.green}18`:C.bgGlass,display:"flex",alignItems:"center",justifyContent:"center",fontSize:19}}>{pg?"✅":it.icon}</div>
                          <div>
                            <div style={{fontSize:13.5,fontWeight:800}}>{it.label}</div>
                            {pg
                              ? <div style={{fontSize:11,color:C.green,fontWeight:600,marginTop:1}}>Pago via {pg.forma} · {new Date(pg.ts).toLocaleDateString("pt-BR")}</div>
                              : <div style={{fontSize:11,color:C.muted,marginTop:1}}>Ainda não pago</div>}
                          </div>
                        </div>
                        {pg
                          ? <button onClick={()=>{ if(confirm(`Desfazer o pagamento de "${it.label}"?`)) desmarcarPagPac(it.id); }} style={{background:"none",color:C.muted,fontSize:11,fontWeight:700,textDecoration:"underline",cursor:"pointer"}}>desfazer</button>
                          : <div style={{display:"flex",gap:5,flexWrap:"wrap"}}>{FORMAS_PAG.map(fm=>(<button key={fm} onClick={()=>marcarPagPac(it.id,fm)} style={{padding:"6px 11px",borderRadius:8,fontSize:11,fontWeight:700,background:C.bgGlass,border:`1px solid ${C.border}`,color:C.sub,cursor:"pointer"}}>{fm}</button>))}</div>}
                      </div>
                    </Card>
                  );
                })}
              </div>
              {(()=>{ const pagos=ITENS_PAG.filter(it=>pagPac[it.id]); if(pagos.length===0) return null; return (
                <Card hover={false} p={14} style={{background:`${C.green}08`,border:`1px solid ${C.green}25`}}>
                  <div style={{fontSize:11.5,color:C.sub,fontWeight:600}}>✅ {pagos.length} de {ITENS_PAG.length} pago{pagos.length!==1?"s":""}: {pagos.map(it=>it.label).join(" · ")}</div>
                </Card>
              );})()}
            </div>
          )}
          {aba==="exames"&&(
            <div style={{display:"flex",flexDirection:"column",gap:14}}>
              {/* 🧬 IA DE EVOLUÇÃO */}
              <Card p={16} style={{background:`linear-gradient(135deg,${C.purple}0C,${C.accent}08)`,border:`1px solid ${C.purple}30`}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:8}}>
                  <div>
                    <div style={{fontSize:13,fontWeight:800,color:C.purple}}>🧬 Análise de Evolução por IA</div>
                    <div style={{fontSize:11,color:C.muted,marginTop:2,maxWidth:430,lineHeight:1.5}}>A IA compara todos os registros do paciente (consultas, baropodometrias, dor) do mais antigo ao mais recente e mostra como ele evoluiu ao longo do tempo. <strong style={{color:C.amber}}>Consome 2 análises.</strong></div>
                  </div>
                  <Btn v="primary" sz="sm" disabled={loadingEvoIA} onClick={analisarEvolucao} style={{background:C.purple}}>{loadingEvoIA?<><Spin sz={13}/> Analisando...</>:"🧬 Analisar evolução"}</Btn>
                </div>
                {erroEvoIA&&<div style={{marginTop:10,fontSize:12,color:C.red}}>{erroEvoIA}</div>}
                {evoIA&&(
                  <div style={{marginTop:14,display:"flex",flexDirection:"column",gap:11}}>
                    {evoIA.tendencia&&(()=>{ const t=String(evoIA.tendencia).toLowerCase(); const cor=t.includes("melhor")?C.green:t.includes("piora")?C.red:C.amber; const ico=t.includes("melhor")?"📈":t.includes("piora")?"📉":"➡️"; return (
                      <div style={{display:"inline-flex",alignItems:"center",gap:8,alignSelf:"flex-start",padding:"6px 14px",borderRadius:99,background:`${cor}18`,border:`1px solid ${cor}45`}}><span style={{fontSize:16}}>{ico}</span><span style={{fontSize:13,fontWeight:800,color:cor}}>Tendência: {evoIA.tendencia}</span></div>
                    );})()}
                    {evoIA.panorama&&<div style={{background:C.bgCard,border:`1px solid ${C.purple}22`,borderRadius:9,padding:13}}><div style={{fontSize:10,color:C.purple,fontWeight:700,textTransform:"uppercase",marginBottom:5}}>📊 Panorama da evolução</div><div style={{fontSize:12.5,color:C.sub,lineHeight:1.7}}>{evoIA.panorama}</div></div>}
                    {Array.isArray(evoIA.melhoras)&&evoIA.melhoras.length>0&&<div style={{background:`${C.green}08`,border:`1px solid ${C.green}25`,borderRadius:9,padding:13}}><div style={{fontSize:10,color:C.green,fontWeight:700,textTransform:"uppercase",marginBottom:6}}>✅ Pontos de melhora</div>{evoIA.melhoras.map((x,i)=><div key={i} style={{fontSize:12,color:C.sub,lineHeight:1.6,paddingLeft:14,position:"relative"}}><span style={{position:"absolute",left:0,color:C.green}}>•</span>{x}</div>)}</div>}
                    {Array.isArray(evoIA.atencao)&&evoIA.atencao.length>0&&<div style={{background:`${C.amber}08`,border:`1px solid ${C.amber}25`,borderRadius:9,padding:13}}><div style={{fontSize:10,color:C.amber,fontWeight:700,textTransform:"uppercase",marginBottom:6}}>⚠️ Pontos de atenção</div>{evoIA.atencao.map((x,i)=><div key={i} style={{fontSize:12,color:C.sub,lineHeight:1.6,paddingLeft:14,position:"relative"}}><span style={{position:"absolute",left:0,color:C.amber}}>•</span>{x}</div>)}</div>}
                    {evoIA.recomendacao&&<div style={{background:`${C.accent}08`,border:`1px solid ${C.accent}25`,borderRadius:9,padding:13}}><div style={{fontSize:10,color:C.accent,fontWeight:700,textTransform:"uppercase",marginBottom:5}}>🎯 Próximo passo recomendado</div><div style={{fontSize:12.5,color:C.sub,lineHeight:1.7}}>{evoIA.recomendacao}</div></div>}
                    <div style={{fontSize:9.5,color:C.muted,fontStyle:"italic"}}>Análise gerada por IA como apoio clínico — requer validação do profissional.</div>
                  </div>
                )}
              </Card>
              ...
              {/* 📁 EXAMES ARQUIVADOS NA NUVEM */}
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:8}}>
                <div style={{fontSize:12.5,fontWeight:800}}>📁 Exames arquivados <span style={{fontSize:11,color:C.muted,fontWeight:600}}>({examesArq.length})</span></div>
                <input ref={exameInputRef} type="file" accept=".stl,.obj,.jpg,.jpeg,.png,.pdf" style={{display:"none"}} onChange={e=>{ const f=e.target.files&&e.target.files[0]; if(f) arquivarExame(f); e.target.value=""; }} />
                <Btn v="primary" sz="sm" disabled={subindoExame} onClick={()=>exameInputRef.current&&exameInputRef.current.click()}>{subindoExame?<><Spin sz={12}/> Enviando...</>:"📎 Arquivar exame"}</Btn>
              </div>
              {examesArq.length===0
                ? <div onClick={()=>exameInputRef.current&&exameInputRef.current.click()} style={{border:`2px dashed ${C.border}`,borderRadius:11,padding:30,textAlign:"center",color:C.muted,fontSize:12,cursor:"pointer"}}><div style={{fontSize:34,marginBottom:8}}>📎</div><div style={{fontWeight:600,marginBottom:2}}>Clique para arquivar um exame na nuvem</div><div style={{fontSize:10}}>STL · OBJ · JPG · PNG · PDF — guardado para sempre na ficha</div></div>
                : <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(220px,1fr))",gap:10}}>
                    {examesArq.map(ex=>(
                      <Card key={ex.id} p={14}>
                        <div style={{display:"flex",alignItems:"flex-start",gap:10}}>
                          <div style={{width:36,height:36,borderRadius:9,background:ex.tipo==="PDF"?`${C.red}18`:ex.tipo==="3D"?`${C.purple}18`:`${C.accent}18`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,flexShrink:0}}>{ex.tipo==="PDF"?"📄":ex.tipo==="3D"?"🦶":"🖼️"}</div>
                          <div style={{flex:1,minWidth:0}}><div style={{fontSize:12,fontWeight:700,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{ex.nome}</div><div style={{fontSize:10,color:C.muted,marginTop:1}}>{ex.data?ex.data.split("-").reverse().join("/"):""} · {ex.tamanho}KB</div></div>
                        </div>
                        {ex.url
                          ? <a href={ex.url} target="_blank" rel="noreferrer" style={{display:"block",textAlign:"center",marginTop:10,padding:"7px",borderRadius:8,background:`${C.accent}15`,border:`1px solid ${C.accent}35`,color:C.accent,fontSize:11.5,fontWeight:700,textDecoration:"none"}}>👁️ Abrir / Baixar</a>
                          : <div style={{textAlign:"center",marginTop:10,fontSize:10.5,color:C.muted}}>arquivo local</div>}
                      </Card>
                    ))}
                  </div>}
            </div>
...
function PacientesPage({pacientes,setPacientes,isAdmin,clinicaId,clinicaName,planoClinica,planoIA,pedidosReais,abrirPacienteId,onAbriu}) {
  const portalLiberado = planoClinica==="Premium" || planoClinica==="Enterprise";
  const [search,setSearch]   = useState("");
  const [showForm,setShowForm] = useState(false);
  const [pront,setPront]     = useState(null);
  // 🔍 busca global: abre a ficha do paciente solicitado
  useEffect(() => {
    if(abrirPacienteId!=null){
      const alvo = (pacientes||[]).find(p => p.id===abrirPacienteId);
      if(alvo) setPront(alvo);
      onAbriu && onAbriu();
    }
  }, [abrirPacienteId]);
  ...
  // 🔍 Detecta nome repetido/duplicado antes de salvar (evita "João Silva Silva")
  const checarNomeDuplicado = (nome, sobrenome) => {
    const n = (nome||"").trim().toLowerCase().replace(/\s+/g," ");
    const sob = (sobrenome||"").trim().toLowerCase().replace(/\s+/g," ");
    if(!n) return null;
    // caso 1: o sobrenome já aparece dentro do nome (ex: nome "João Antunes Dias", sobrenome "Antunes Dias")
    if(sob && n.includes(sob)) return "O sobrenome “"+sobrenome.trim()+"” já está escrito no campo Nome.";
    // caso 2: o nome inteiro repetido dentro de si (ex: "Maria Souza Maria Souza")
    ...
    if(palavras.length>=4 && palavras.length%2===0){
      ...
      if(p1===p2) return "O nome parece estar digitado em dobro: “"+p1+"”.";
    }
    // caso 3: palavra repetida em sequência (ex: "Ana Ana Lima")
    for(let i=0;i<palavras.length-1;i++){ if(palavras[i] && palavras[i]===palavras[i+1]) return "A palavra “"+palavras[i]+"” está repetida no nome."; }
    // caso 4: nome + sobrenome formam repetição (ex: nome "Ana Lima", sobrenome "Ana Lima")
    if(sob && n===sob) return "Nome e sobrenome estão iguais.";
    return null;
  };
  ...
  const save = async () => {
    ...
    // 🔍 aviso de nome duplicado (não bloqueia — pede confirmação, pois pode ser legítimo)
    const aviso = checarNomeDuplicado(f.nome, f.sobrenome);
    if(aviso){
      const ok = confirm("⚠️ Possível nome duplicado\n\n"+aviso+"\n\nNome: "+(f.nome||"").trim()+"\nSobrenome: "+(f.sobrenome||"").trim()+"\n\nDeseja salvar assim mesmo?\n(Cancele para corrigir os campos)");
      if(!ok) return;
    }
    const cred = f.senha ? await SENHA_FP.criar(f.senha) : {};
  ...
  return (
    <div style={{padding:20}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))",gap:10,marginBottom:18}}>
        {[{l:"Total",v:base.length,c:C.accent,i:"👥"},{l:"Com Pedido",v:base.filter(p=>p.pedidos>0).length,c:C.green,i:"📦"},{l:"Aguardando avaliação",v:base.filter(p=>p.ultimaConsulta==="—").length,c:C.amber,i:"⏳"},{l:isAdmin?"Clínicas":"Minha Clínica",v:isAdmin?new Set(base.map(p=>p.clinica)).size:1,c:C.purple,i:"🏥"}].map((s,i)=>(
      ...
      {(() => {
        const PacCard = (p, i) => (
          <Card key={p.id} style={{padding:16,animation:`fadeUp .4s ${i*.04}s ease both`,opacity:0}}>
            ...
            {p.ultimaConsulta==="—" && (
              <div style={{display:"flex",alignItems:"center",gap:6,padding:"6px 10px",background:`${C.amber}12`,border:`1px solid ${C.amber}35`,borderRadius:8,marginBottom:11}}>
                <span style={{width:7,height:7,borderRadius:"50%",background:C.amber,flexShrink:0,animation:"dotPulse 1.4s ease-in-out infinite"}}/>
                <span style={{fontSize:10.5,fontWeight:700,color:C.amber}}>⏳ Aguardando avaliação</span>
              </div>
            )}
      ...
      {pront&&<ProntuarioModal paciente={pront} onClose={()=>setPront(null)} clinicaId={clinicaId} planoIA={planoIA||(isAdmin?"admin":planoClinica)} pedidosReais={pedidosReais}/>}
      {exercPac&&<ExerciciosPersonalizadosModal paciente={exercPac} onClose={()=>setExercPac(null)}/>}
      {showForm&&(
        <Modal onClose={()=>setShowForm(false)}>
          <Card hover={false} p={0} style={{width:"100%",maxWidth:640,maxHeight:"92vh",overflowY:"auto",animation:"fadeUp .25s ease"}}>
            <div style={{padding:"16px 20px",borderBottom:`1px solid ${C.border}`,display:"flex",justifyContent:"space-between",alignItems:"center",background:`linear-gradient(135deg,${C.accent}08,transparent)`}}>
              <div><div style={{fontSize:16,fontWeight:800}}>👤 Novo Paciente</div><div style={{fontSize:11,color:C.muted,marginTop:2}}>A recepção preenche os dados de cadastro · o fisioterapeuta completa a parte clínica</div></div>
              <button onClick={()=>setShowForm(false)} style={{background:"none",color:C.muted,fontSize:18}}>✕</button>
            </div>
            <div style={{padding:20,display:"flex",flexDirection:"column",gap:18}}>
              {/* 🧑‍💼 BLOCO DA RECEPÇÃO */}
              <div style={{padding:"4px 0 2px",borderLeft:`3px solid ${C.accent}`,paddingLeft:13,marginLeft:-3}}>
                <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:3}}>
                  <span style={{fontSize:14}}>🧑‍💼</span>
                  <span style={{fontSize:12.5,fontWeight:800,color:C.accent}}>Dados de cadastro</span>
                  <span style={{fontSize:9.5,color:C.muted,fontWeight:600,background:`${C.accent}12`,padding:"2px 8px",borderRadius:99}}>RECEPÇÃO</span>
                </div>
                <div style={{fontSize:10.5,color:C.muted}}>Informações administrativas coletadas na chegada do paciente.</div>
              </div>
              <div>
              ...
              <div>
                <div style={{fontSize:10,color:C.accent,fontWeight:700,textTransform:"uppercase",marginBottom:10}}>▸ Medidas (Nº do calçado é essencial para a palmilha)</div>
                <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(130px,1fr))",gap:10}}>
                  {[{l:"Peso (kg)",k:"peso"},{l:"Altura (cm)",k:"altura"},{l:"Nº Calçado *",k:"numeracao",req:true},{l:"Atividade",k:"atividade"}].map(fi=>(
                    <div key={fi.k}><label style={fi.req?{color:C.amber}:undefined}>{fi.l}</label><input value={f[fi.k]} onChange={e=>sf(fi.k,e.target.value)} style={fi.req&&!f[fi.k]?{borderColor:`${C.amber}66`}:undefined}/></div>
                  ))}
                </div>
              </div>
              <div>
              ...
              {/* 🩺 BLOCO DO FISIOTERAPEUTA */}
              <div style={{padding:"4px 0 2px",borderLeft:`3px solid ${C.purple}`,paddingLeft:13,marginLeft:-3,marginTop:4}}>
                <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:3}}>
                  <span style={{fontSize:14}}>🩺</span>
                  <span style={{fontSize:12.5,fontWeight:800,color:C.purple}}>Avaliação clínica</span>
                  <span style={{fontSize:9.5,color:C.muted,fontWeight:600,background:`${C.purple}12`,padding:"2px 8px",borderRadius:99}}>FISIOTERAPEUTA</span>
                </div>
                <div style={{fontSize:10.5,color:C.muted}}>Pode ser preenchido agora ou durante o atendimento. A secretária pode deixar em branco.</div>
              </div>
              <div>
              ...
              <div style={{display:"flex",gap:8,justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",paddingTop:4,borderTop:`1px solid ${C.border}`}}>
                <span style={{fontSize:10.5,color:C.muted}}>💡 A patologia e a avaliação podem ser completadas depois pelo fisioterapeuta.</span>
                <div style={{display:"flex",gap:8}}><Btn v="ghost" onClick={()=>setShowForm(false)}>Cancelar</Btn><Btn v="primary" disabled={!f.nome} onClick={save}>✓ Salvar paciente</Btn></div>
              </div>
            </div>
          </Card>
        </Modal>
...
function NovaConsultaModal({onClose, onSave, pacientes, clinicaId, editData}) {
  ...
  const [f, setF] = useState(editData || {
    ...
    tipo:"Consulta Inicial", notas:"", status:"Agendada", procedimento:""
  });
  const [err, setErr] = useState("");
  // 🏭 procedimentos que a clínica cadastrou no Centro de Procedimentos
  const [procs, setProcs] = useState(() => LS.read("fp:procedimentos:" + clinicaId) || []);
  useEffect(() => { (async () => { const l = await LS.readAsync("fp:procedimentos:" + clinicaId); if (l) setProcs(l); })(); }, [clinicaId]);
  const sf = (k,v) => { setF(p=>({...p,[k]:v})); setErr(""); };
  // ao escolher um procedimento, preenche a duração automaticamente
  const escolherProc = (nome) => {
    const p = procs.find(x => x.nome === nome);
    setF(prev => ({ ...prev, procedimento: nome, duracao: (p && p.duracao) ? String(p.duracao) : prev.duracao }));
    setErr("");
  };
      ...
      <Card hover={false} p={0} style={{width:"100%",maxWidth:520,animation:"fadeUp .22s ease"}}>
        ...
        <div style={{padding:20,display:"flex",flexDirection:"column",gap:12}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
            ...
            {procs.length>0 && (
              <div style={{gridColumn:"1 / -1"}}>
                <label>🏭 Procedimento <span style={{color:C.muted,fontWeight:400}}>(opcional)</span></label>
                <select value={f.procedimento||""} onChange={e=>escolherProc(e.target.value)}>
                  <option value="">— Nenhum / consulta comum —</option>
                  {procs.map(p=><option key={p.id} value={p.nome}>{p.icon} {p.nome} ({p.duracao}min{p.valor?` · R$ ${brl(p.valor)}`:""})</option>)}
                </select>
              </div>
            )}
            <div>
...
function AgendaPage({consultas, setConsultas, pacientes, clinicaId, isAdmin}) {
  ...
  const [monthOffset, setMonthOffset] = useState(0);     // navegação por mês
  ...
  const statusColor = s => s==="Concluída"?C.green:s==="Cancelada"?C.red:s==="Em atendimento"?C.purple:s==="Aguardando"?"#F97316":s==="Confirmada"?C.accent:C.amber;

  return (
    <div style={{padding:20}}>
      <SH title="Agenda de Consultas"
        sub={viewMode==="mes" ? (()=>{ const d=new Date(today.getFullYear(),today.getMonth()+monthOffset,1); return d.toLocaleDateString("pt-BR",{month:"long",year:"numeric"}); })() : semanaLabel()}
        right={
          <div style={{display:"flex",gap:8,alignItems:"center"}}>
            <div style={{display:"flex",background:C.bgGlass,border:`1px solid ${C.border}`,borderRadius:8,overflow:"hidden"}}>
              <button onClick={()=>setViewMode("mes")} style={{padding:"7px 14px",background:viewMode==="mes"?`${C.accent}20`:"transparent",color:viewMode==="mes"?C.accent:C.muted,fontSize:12,fontWeight:600,border:"none",cursor:"pointer"}}>Mês</button>
            ...
            <Btn v="ghost" sz="sm" onClick={()=>viewMode==="mes"?setMonthOffset(mo=>mo-1):setWeekOffset(w=>w-1)}>← Anterior</Btn>
            <Btn v="ghost" sz="sm" onClick={()=>{setWeekOffset(0);setMonthOffset(0);}}>Hoje</Btn>
            <Btn v="ghost" sz="sm" onClick={()=>viewMode==="mes"?setMonthOffset(mo=>mo+1):setWeekOffset(w=>w+1)}>Próxima →</Btn>
            <Btn v="primary" sz="sm" onClick={()=>{setEditData(null);setShowModal(true);}}>+ Agendar</Btn>
          </div>
        }
      />

      {/* 🚪 PAINEL DE RECEPÇÃO — sala de espera digital (quem chegou hoje) */}
      {(()=>{
        const hojeIso = fmtDate(today);
        const consultasHoje = minhas.filter(c=>c.data===hojeIso && c.status!=="Cancelada" && c.status!=="Concluída");
        const aguardando = consultasHoje.filter(c=>c.status==="Aguardando").sort((a,b)=>String(a.hora||"").localeCompare(String(b.hora||"")));
        const atendendo = consultasHoje.filter(c=>c.status==="Em atendimento");
        const aChegar = consultasHoje.filter(c=>c.status==="Agendada"||c.status==="Confirmada").sort((a,b)=>String(a.hora||"").localeCompare(String(b.hora||"")));
        if(consultasHoje.length===0) return null;
        const Pessoa = ({c, acao, acaoLabel, acaoCor})=>(
          <div style={{display:"flex",alignItems:"center",gap:9,padding:"8px 11px",background:C.bgCard,border:`1px solid ${C.border}`,borderRadius:9,flexWrap:"wrap"}}>
            <span style={{fontFamily:"'Space Mono',monospace",fontSize:11,fontWeight:800,color:C.sub,flexShrink:0}}>{c.hora}</span>
            <span style={{fontSize:12.5,fontWeight:700,flex:1,minWidth:90,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{c.paciente}</span>
            {c.tipo&&<span style={{fontSize:9.5,color:C.muted,fontWeight:600,flexShrink:0}}>{c.tipo}</span>}
            {acao&&<button onClick={()=>acao(c)} style={{padding:"5px 11px",borderRadius:7,fontSize:11,fontWeight:800,background:`${acaoCor}18`,border:`1px solid ${acaoCor}45`,color:acaoCor,cursor:"pointer",flexShrink:0}}>{acaoLabel}</button>}
          </div>
        );
        const temEspera = aguardando.length>0;
        return (
          <Card hover={false} p={0} style={{overflow:"hidden",marginBottom:14,border:`1px solid ${temEspera?"#F97316":"#F9731635"}`,animation:temEspera?"recepGlow 2.2s ease-in-out infinite":"none"}}>
            <div style={{padding:"12px 16px",background:`linear-gradient(135deg,#F9731610,${C.accent}06)`,borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,flexWrap:"wrap"}}>
              <div style={{display:"flex",alignItems:"center",gap:10}}>
                <span style={{fontSize:20}}>🚪</span>
                <div>
                  <div style={{fontSize:13.5,fontWeight:800,display:"flex",alignItems:"center",gap:8}}>Recepção de hoje{temEspera&&<span style={{display:"inline-flex",alignItems:"center",gap:5,fontSize:10.5,fontWeight:800,color:"#F97316",background:"#F9731618",padding:"2px 9px",borderRadius:99}}><span style={{width:7,height:7,borderRadius:"50%",background:"#F97316",display:"inline-block",animation:"dotPulse 1s ease-in-out infinite"}}/>{aguardando.length} esperando</span>}</div>
                  <div style={{fontSize:10.5,color:C.muted}}>{aguardando.length} na sala de espera · {atendendo.length} em atendimento · {aChegar.length} a chegar</div>
                </div>
              </div>
              <span style={{fontSize:10.5,color:C.muted}}>{today.toLocaleDateString("pt-BR",{weekday:"long",day:"numeric",month:"long"})}</span>
            </div>
            <div style={{padding:14,display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(230px,1fr))",gap:14}}>
              {/* Coluna: aguardando na recepção */}
              <div>
                <div style={{fontSize:10.5,fontWeight:800,color:"#F97316",textTransform:"uppercase",letterSpacing:".04em",marginBottom:7,display:"flex",alignItems:"center",gap:6}}>⏳ Na sala de espera {aguardando.length>0&&<span style={{background:"#F9731620",borderRadius:99,padding:"0 7px",fontSize:10}}>{aguardando.length}</span>}</div>
                <div style={{display:"flex",flexDirection:"column",gap:6}}>
                  {aguardando.length===0?<div style={{fontSize:11,color:C.muted,fontStyle:"italic",padding:"4px 0"}}>Ninguém esperando.</div>:aguardando.map(c=><Pessoa key={c.id} c={c} acao={(x)=>handleStatus(x.id,"Em atendimento")} acaoLabel="🩺 Chamar" acaoCor={C.purple}/>)}
                </div>
              </div>
              {/* Coluna: em atendimento */}
              <div>
                <div style={{fontSize:10.5,fontWeight:800,color:C.purple,textTransform:"uppercase",letterSpacing:".04em",marginBottom:7,display:"flex",alignItems:"center",gap:6}}>🩺 Em atendimento {atendendo.length>0&&<span style={{background:`${C.purple}20`,borderRadius:99,padding:"0 7px",fontSize:10}}>{atendendo.length}</span>}</div>
                <div style={{display:"flex",flexDirection:"column",gap:6}}>
                  {atendendo.length===0?<div style={{fontSize:11,color:C.muted,fontStyle:"italic",padding:"4px 0"}}>Nenhum atendimento em curso.</div>:atendendo.map(c=><Pessoa key={c.id} c={c} acao={(x)=>handleStatus(x.id,"Concluída")} acaoLabel="✅ Concluir" acaoCor={C.green}/>)}
                </div>
              </div>
              {/* Coluna: a chegar */}
              <div>
                <div style={{fontSize:10.5,fontWeight:800,color:C.accent,textTransform:"uppercase",letterSpacing:".04em",marginBottom:7,display:"flex",alignItems:"center",gap:6}}>📅 A chegar {aChegar.length>0&&<span style={{background:`${C.accent}20`,borderRadius:99,padding:"0 7px",fontSize:10}}>{aChegar.length}</span>}</div>
                <div style={{display:"flex",flexDirection:"column",gap:6}}>
                  {aChegar.length===0?<div style={{fontSize:11,color:C.muted,fontStyle:"italic",padding:"4px 0"}}>Todos chegaram!</div>:aChegar.map(c=><Pessoa key={c.id} c={c} acao={(x)=>handleStatus(x.id,"Aguardando")} acaoLabel="🚪 Chegou" acaoCor="#F97316"/>)}
                </div>
              </div>
            </div>
          </Card>
      ...
      {/* Stats rápidos da semana (semana/lista) */}
      {viewMode!=="mes" && <div style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:8,marginBottom:14}}>
        {[
      ...
      {/* 🗓️ VISÃO MÊS — calendário mensal com panorama dos atendimentos */}
      {viewMode==="mes" && (()=>{
        ...
        const hojeIso = fmtDate(today);
        // monta as células (espaços vazios antes do dia 1 + dias do mês)
        const celulas = [];
        for(let i=0;i<primeiroDiaSemana;i++) celulas.push(null);
        for(let d=1;d<=diasNoMes;d++) celulas.push(new Date(ano,mes,d));
        const consultasDoDia = (dt) => { const iso=fmtDate(dt); return minhas.filter(c=>c.data===iso).sort((a,b)=>String(a.hora||"").localeCompare(String(b.hora||""))); };
        const corStatus = (st) => st==="Confirmada"?C.accent:st==="Concluída"?C.green:st==="Cancelada"?C.red:C.amber;
        const totalMes = minhas.filter(c=>{ const dt=new Date(c.data+"T00:00:00"); return dt.getMonth()===mes && dt.getFullYear()===ano; }).length;
        return (
          <Card hover={false} p={0} style={{overflow:"hidden"}}>
            <div style={{padding:"10px 14px",borderBottom:`1px solid ${C.border}`,display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:8}}>
              <span style={{fontSize:12,fontWeight:700,color:C.sub,textTransform:"capitalize"}}>{base.toLocaleDateString("pt-BR",{month:"long",year:"numeric"})}</span>
              <span style={{fontSize:11,color:C.muted}}>{totalMes} consulta{totalMes!==1?"s":""} no mês</span>
            </div>
            {/* cabeçalho dos dias da semana */}
            <div style={{display:"grid",gridTemplateColumns:"repeat(7,1fr)",borderBottom:`1px solid ${C.border}`}}>
              {["Dom","Seg","Ter","Qua","Qui","Sex","Sáb"].map((d,i)=>(
                <div key={i} style={{padding:"8px 4px",textAlign:"center",fontSize:10.5,fontWeight:800,color:i===0||i===6?C.muted:C.sub,textTransform:"uppercase",letterSpacing:".03em"}}>{d}</div>
              ))}
            </div>
            {/* grade do mês */}
            <div style={{display:"grid",gridTemplateColumns:"repeat(7,1fr)"}}>
              {celulas.map((dt,i)=>{
                if(!dt) return <div key={i} style={{minHeight:88,background:C.bgGlass,borderRight:`1px solid ${C.border}`,borderBottom:`1px solid ${C.border}`}}/>;
                const lista = consultasDoDia(dt);
                const ehHoje = fmtDate(dt)===hojeIso;
                const fds = dt.getDay()===0||dt.getDay()===6;
                return (
                  <div key={i} onClick={()=>{ setEditData({data:fmtDate(dt)}); setShowModal(true); }} style={{minHeight:88,padding:"5px 6px",borderRight:`1px solid ${C.border}`,borderBottom:`1px solid ${C.border}`,background:ehHoje?`${C.accent}0A`:fds?C.bgGlass:"transparent",cursor:"pointer",position:"relative",transition:"background .15s"}}>
                    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:3}}>
                      <span style={{fontSize:11.5,fontWeight:ehHoje?900:700,color:ehHoje?C.accent:fds?C.muted:C.sub,width:ehHoje?20:"auto",height:ehHoje?20:"auto",borderRadius:"50%",background:ehHoje?C.accent:"transparent",color:ehHoje?"#fff":undefined,display:"inline-flex",alignItems:"center",justifyContent:"center"}}>{dt.getDate()}</span>
                      {lista.length>0&&<span style={{fontSize:9,fontWeight:800,color:C.accent,background:`${C.accent}18`,borderRadius:99,padding:"0 5px"}}>{lista.length}</span>}
                    </div>
                    <div style={{display:"flex",flexDirection:"column",gap:2}}>
                      {lista.slice(0,3).map((c,j)=>(
                        <div key={j} onClick={(e)=>{e.stopPropagation();setSelC(c);}} style={{fontSize:9.5,padding:"1px 4px",borderRadius:4,background:`${corStatus(c.status)}1a`,color:corStatus(c.status),fontWeight:600,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",cursor:"pointer"}} title={`${c.hora} ${c.paciente}`}>{c.hora} {String(c.paciente||"").split(" ")[0]}</div>
                      ))}
                      {lista.length>3&&<div style={{fontSize:9,color:C.muted,fontWeight:600,paddingLeft:4}}>+{lista.length-3} mais</div>}
                    </div>
                  </div>
                );
              })}
            </div>
            <div style={{padding:"9px 14px",borderTop:`1px solid ${C.border}`,fontSize:10.5,color:C.muted,display:"flex",gap:14,flexWrap:"wrap",alignItems:"center"}}>
              <span style={{display:"flex",alignItems:"center",gap:4}}><span style={{width:9,height:9,borderRadius:2,background:C.amber}}/>Agendada</span>
              <span style={{display:"flex",alignItems:"center",gap:4}}><span style={{width:9,height:9,borderRadius:2,background:C.accent}}/>Confirmada</span>
              <span style={{display:"flex",alignItems:"center",gap:4}}><span style={{width:9,height:9,borderRadius:2,background:C.green}}/>Concluída</span>
              <span style={{marginLeft:"auto",fontStyle:"italic"}}>Clique num dia para agendar · clique numa consulta para ver detalhes</span>
            </div>
          </Card>
        );
      })()}
          ...
          <Card hover={false} p={0} style={{width:"100%",maxWidth:440,animation:"fadeUp .22s ease"}}>
            ...
            <div style={{padding:18,display:"flex",flexDirection:"column",gap:12}}>
              <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
                ...
                {selC.procedimento && <Badge label={`🏭 ${selC.procedimento}`} color={C.purple}/>}
              ...
              <div>
                ...
                <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
                  {["Agendada","Confirmada","Aguardando","Em atendimento","Concluída","Cancelada"].map(s=>(
                    <button key={s}
                    ...
                    >{s==="Aguardando"?"🚪 Chegou":s==="Em atendimento"?"🩺 Atendendo":s}</button>
                  ))}
                </div>
              </div>
  ...
  async function estruturarConsulta(texto){
    ...
    try{
      const res = await fetch("/api/ia",{ method:"POST", headers:{"Content-Type":"application/json"},
        body: JSON.stringify({
          model:"claude-fable-5", max_tokens:1400,
...
function DashClinica({pedidos,pacientes,clinicaObj,hideValues,onNavegar,planoIA,consultas}) {
  ...
  // 🔍 janela ajustável de retornos (7/15/30 dias) — persiste a preferência
  const [janelaRet, setJanelaRet] = useState(() => Number(LS.read("fp:retorno_janela")) || 7);
  const mudarJanela = (d) => { setJanelaRet(d); LS.write("fp:retorno_janela", d); };
  const em7 = new Date(hoje0.getTime() + janelaRet*86400000);
  ...
  const retornosTodos = (pacientes||[])
    ...
    .map(x=>{
      ...
      const diasAtraso = Math.round((hoje0 - x.dt)/86400000);
      // 💬 mensagem que se ADAPTA ao contexto do retorno
      let msg;
      if(status==="atrasado"){
        msg = `Olá, ${x.p.nome}! 👋 Aqui é da ${clinicaName}. Notamos que a data do seu retorno já passou${diasAtraso>=1?` (há ${diasAtraso} dia${diasAtraso!==1?"s":""})`:""}. É importante manter o acompanhamento da sua evolução e das suas palmilhas. Vamos remarcar seu horário? 🦶`;
      } else if(status==="hoje"){
        msg = `Olá, ${x.p.nome}! 👋 Passando para lembrar que seu retorno na ${clinicaName} é HOJE. Estamos te esperando para acompanhar sua evolução! Qualquer coisa, me avise. 🦶✨`;
      } else {
        const dataF = x.dt.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"});
        msg = `Olá, ${x.p.nome}! 👋 Aqui é da ${clinicaName}. Está chegando a data do seu retorno (${dataF}) para acompanharmos sua evolução e suas palmilhas. Vamos confirmar seu horário? 🦶✨`;
      }
      const zap = fone ? `https://wa.me/${fone}?text=${encodeURIComponent(msg)}` : null;
      const chave = chaveRet(x.p.id, x.dt);
      return { id:x.p.id, nome, dt:x.dt, dataTxt:x.dt.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}), status, zap, chave, msg, diasAtraso, contatado: !!contatados[chave], quandoContatado: contatados[chave] };
    });
  // 📄 Relatório mensal da clínica em PDF (marca FisioPiede)
  const gerarRelatorioMensal = () => {
    try {
      ...
      const meus = (pedidos||[]);
      const pedidosMes = meus.filter(p=>String(p.data||p.criadoEm||"").startsWith(mesAtual));
      const porStatus = {};
      meus.forEach(p=>{ porStatus[p.status]=(porStatus[p.status]||0)+1; });
      const entreguesMes = pedidosMes.filter(p=>p.status==="Entregue").length;
      const consMes = (consultas||[]).filter(c=>String(c.data||"").startsWith(mesAtual)&&c.status!=="Cancelada").length;
      const novosPac = (pacientes||[]).filter(p=>String(p.cadastro||p.criadoEm||"").startsWith(mesAtual)).length;
      const totalProntuarios = (pacientes||[]).reduce((a,p)=>a+((p.prontuarios||[]).filter(n=>String(n.data||"").startsWith(mesAtual)).length),0);
      const esc=(t)=>String(t==null?"":t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");
      const linhasStatus = STATUS_FLOW.map(st=>{ const n=meus.filter(p=>p.status===st).length; if(n===0)return ""; return `<tr><td>${esc(st)}</td><td style="text-align:right">${n}</td></tr>`; }).join("");

      const html = `<!DOCTYPE html><html lang="pt-BR"><head><meta charset="utf-8"/><title>Relatório Mensal — FisioPiede</title><style>
        *{margin:0;padding:0;box-sizing:border-box;} body{font-family:Arial,Helvetica,sans-serif;color:#1a2333;padding:40px 46px;background:#fff;}
        .topo{display:flex;justify-content:space-between;align-items:flex-end;border-bottom:3px solid #F59E0B;padding-bottom:16px;margin-bottom:8px;}
        .marca{font-weight:800;font-size:24px;color:#0f1729;} .marca span{color:#F59E0B;}
        .sub{font-size:10px;letter-spacing:2px;color:#6b7689;text-transform:uppercase;margin-top:3px;}
        .meta{text-align:right;font-size:12px;color:#3d4a61;line-height:1.7;}
        h1{font-size:17px;color:#0f1729;margin:22px 0 4px;} .periodo{font-size:13px;color:#8B5CF6;font-weight:700;text-transform:capitalize;margin-bottom:18px;}
        .cards{display:flex;gap:12px;flex-wrap:wrap;margin-bottom:24px;}
        .card{flex:1;min-width:120px;border:1px solid #e3e7ef;border-radius:11px;padding:15px 16px;background:#f9fafc;}
        .card .n{font-size:26px;font-weight:900;color:#0f1729;} .card .l{font-size:10.5px;color:#6b7689;margin-top:3px;text-transform:uppercase;letter-spacing:.04em;}
        h2{font-size:13px;color:#8B5CF6;text-transform:uppercase;letter-spacing:1px;border-bottom:1px solid #e3e7ef;padding-bottom:6px;margin:22px 0 10px;}
        table{width:100%;border-collapse:collapse;font-size:13px;} td{padding:7px 4px;border-bottom:1px solid #eef1f6;}
        .rodape{margin-top:34px;border-top:1px solid #e3e7ef;padding-top:12px;font-size:9.5px;color:#8a93a6;line-height:1.7;}
        @media print{body{padding:24px 28px;}}
      </style></head><body>
        <div class="topo">
          <div><div class="marca">Fisio<span>Piede</span></div><div class="sub">Health Tech Platform</div></div>
          <div class="meta"><strong>${esc(clinicaName||"Clínica")}</strong><br/>Relatório gerado em ${agora.toLocaleDateString("pt-BR")}</div>
        </div>
        <h1>Relatório Mensal de Atividades</h1>
        <div class="periodo">${esc(nomeMes)}</div>
        <div class="cards">
          <div class="card"><div class="n">${pedidosMes.length}</div><div class="l">Pedidos no mês</div></div>
          <div class="card"><div class="n">${entreguesMes}</div><div class="l">Entregues</div></div>
          <div class="card"><div class="n">${consMes}</div><div class="l">Consultas</div></div>
          <div class="card"><div class="n">${totalProntuarios}</div><div class="l">Prontuários</div></div>
          <div class="card"><div class="n">${novosPac}</div><div class="l">Novos pacientes</div></div>
        </div>
        <h2>Resumo geral da clínica</h2>
        <table>
          <tr><td>Total de pacientes cadastrados</td><td style="text-align:right"><strong>${(pacientes||[]).length}</strong></td></tr>
          <tr><td>Total de pedidos (histórico)</td><td style="text-align:right"><strong>${meus.length}</strong></td></tr>
          <tr><td>Pedidos entregues (histórico)</td><td style="text-align:right"><strong>${meus.filter(p=>p.status==="Entregue").length}</strong></td></tr>
        </table>
        ${linhasStatus?`<h2>Pedidos por status</h2><table>${linhasStatus}</table>`:""}
        <div class="rodape">Documento gerado automaticamente pela plataforma FisioPiede a partir dos dados da clínica. Valores e quantitativos refletem os registros até a data de emissão. Uso interno e contábil. Tratado conforme a LGPD.</div>
        <script>window.onload=function(){setTimeout(function(){window.print();},400);};<\/script>
      </body></html>`;
      const w = window.open("", "_blank");
      if(w){ w.document.open(); w.document.write(html); w.document.close(); }
      else { alert("Permita pop-ups para gerar o relatório."); }
    } catch(e) { alert("Não foi possível gerar o relatório agora."); }
  };

  // 🚪 Pacientes na sala de espera AGORA (status Aguardando hoje)
  const hojeRecepIso = (()=>{ const d=new Date(); return `${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,"0")}-${String(d.getDate()).padStart(2,"0")}`; })();
  const naSalaEspera = (consultas||[]).filter(c=>c.data===hojeRecepIso && c.status==="Aguardando");
  // 📊 Resumo executivo do dia
  const consultasHoje = (consultas||[]).filter(c=>c.data===hojeRecepIso && c.status!=="Cancelada");
  const procsHoje = consultasHoje.filter(c=>c.procedimento).length;
  const atendidosHoje = consultasHoje.filter(c=>c.status==="Concluída").length;
  // planos de tratamento ativos (pacientes com plano em andamento)
  let planosAtivos = 0;
  (pacientes||[]).forEach(p=>{ const pl = LS.read("fp:plano:"+p.id); if(pl && pl.etapas && pl.etapas.some(e=>!e.feito)) planosAtivos++; });
  // recebido dos pacientes no mês (dos pagamentos marcados nas fichas)
  let recebidoMes = 0;
  const valoresClin = LS.read("fp:valoresclinica:"+(clinicaObj?.id)) || {consulta:0,avaliacao:0,palmilha:0};
  (pacientes||[]).forEach(p=>{ const pg = LS.read("fp:pagpac:"+p.id)||{}; Object.keys(pg).forEach(item=>{ const ts=pg[item].ts; if(ts && String(new Date(ts).getFullYear())+"-"+String(new Date(ts).getMonth()+1).padStart(2,"0")===mesAtualStr){ recebidoMes += (valoresClin[item]||0); } }); });
  ...
  return (
    <div style={{padding:20,display:"flex",flexDirection:"column",gap:16}}>
      <SH title={`Dashboard — ${clinicaName}`} sub={new Date().toLocaleDateString("pt-BR",{day:"numeric",month:"long",year:"numeric"})} right={<Btn v="gold" sz="sm" onClick={gerarRelatorioMensal}>📄 Relatório do mês</Btn>}/>
      {naSalaEspera.length>0 && (
        <Card hover={false} p={0} style={{overflow:"hidden",border:`1px solid #F97316`,animation:"recepGlow 2.2s ease-in-out infinite"}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:12,padding:"13px 16px",background:"#F9731610",flexWrap:"wrap"}}>
            <div style={{display:"flex",alignItems:"center",gap:11}}>
              <span style={{position:"relative",display:"inline-flex"}}><span style={{fontSize:22}}>🚪</span><span style={{position:"absolute",top:-2,right:-3,width:9,height:9,borderRadius:"50%",background:"#F97316",animation:"dotPulse 1s ease-in-out infinite"}}/></span>
              <div>
                <div style={{fontSize:13,fontWeight:800,color:"#F97316"}}>{naSalaEspera.length} paciente{naSalaEspera.length!==1?"s":""} na sala de espera</div>
                <div style={{fontSize:11,color:C.muted,marginTop:2}}>{naSalaEspera.map(c=>`${c.hora} ${String(c.paciente||"").split(" ")[0]}`).slice(0,4).join(" · ")} — aguardando atendimento</div>
              </div>
            </div>
            <Btn v="primary" sz="sm" onClick={()=>onNavegar&&onNavegar("agenda")} style={{background:"#F97316"}}>🩺 Ir para a recepção →</Btn>
          </div>
        </Card>
      )}
      ...
      <Card hover={false} p={0} style={{overflow:"hidden",border:`1px solid ${C.accent}25`,background:`linear-gradient(135deg,${C.accent}07,${C.purple}04)`}}>
        <div style={{padding:"11px 16px",borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",gap:8}}>
          <span style={{fontSize:15}}>☀️</span><span style={{fontSize:12.5,fontWeight:800}}>Resumo de hoje</span>
          <span style={{fontSize:10.5,color:C.muted,marginLeft:"auto"}}>{new Date().toLocaleDateString("pt-BR",{weekday:"long"})}</span>
        </div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(115px,1fr))",gap:1,background:C.border}}>
          {[
            {l:"Na agenda",v:consultasHoje.length,i:"📅",c:C.accent,act:"agenda"},
            {l:"Procedimentos",v:procsHoje,i:"🏭",c:C.gold,act:"agenda"},
            {l:"Atendidos",v:atendidosHoje,i:"✅",c:C.green,act:"agenda"},
            {l:"Na espera",v:naSalaEspera.length,i:"🚪",c:"#F97316",act:"agenda"},
            {l:"Planos ativos",v:planosAtivos,i:"📋",c:C.purple,act:"pacientes"},
          ].map((x,i)=>(
            <div key={i} onClick={()=>onNavegar&&onNavegar(x.act)} style={{background:C.bgCard,padding:"13px 12px",cursor:"pointer",textAlign:"center"}}>
              <div style={{fontSize:17,marginBottom:3}}>{x.i}</div>
              <div style={{fontSize:22,fontWeight:900,color:x.c,lineHeight:1}}>{x.v}</div>
              <div style={{fontSize:10,color:C.muted,marginTop:3,fontWeight:600}}>{x.l}</div>
            </div>
          ))}
        </div>
        {!hideValues && recebidoMes>0 && (
          <div style={{padding:"10px 16px",borderTop:`1px solid ${C.border}`,display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,background:`${C.green}06`}}>
            <span style={{fontSize:11.5,color:C.sub,fontWeight:600}}>💰 Recebido dos pacientes neste mês</span>
            <span style={{fontSize:15,fontWeight:900,color:C.green}}>R$ {brl(recebidoMes)}</span>
          </div>
        )}
      </Card>
      ...
      <Card p={18}>
        ...
        {meus.slice(0,5).map(p=>(
          <div key={p.id} style={{display:"flex",alignItems:"center",gap:8,padding:"8px 10px",borderRadius:9,background:C.bgGlass,border:`1px solid ${C.border}`,marginBottom:5}}>
            ...
            <SBadge status={p.status}/>
            {p.rastreio&&<a href={linkRastreioGlobal(p.rastreio,p.transportadora)} target="_blank" rel="noreferrer" style={{fontSize:10,color:C.green,fontWeight:700,textDecoration:"none"}}>🔗</a>}
      ...
      <Card hover={false} p={0} style={{overflow:"hidden",border:`1px solid ${C.green}25`}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",gap:10,padding:"13px 16px",borderBottom:retornos.length>0?`1px solid ${C.border}`:"none",flexWrap:"wrap"}}>
          <div style={{display:"flex",alignItems:"center",gap:10}}>
            ...
            <div>
              ...
              <div style={{fontSize:10.5,color:C.muted}}>{retornos.length>0?`${retornos.length} paciente${retornos.length!==1?"s":""} com retorno atrasado ou nos próximos ${janelaRet} dias — a mensagem se adapta ao caso`:`Nenhum retorno nos próximos ${janelaRet} dias — defina a data de retorno no cadastro do paciente e eu te aviso aqui`}</div>
            </div>
          </div>
          <div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}>
            {/* 🔍 janela ajustável */}
            <div style={{display:"flex",gap:3,background:C.bgGlass,borderRadius:8,padding:3,border:`1px solid ${C.border}`}}>
              {[7,15,30].map(d=>(
                <button key={d} onClick={()=>mudarJanela(d)} style={{padding:"4px 10px",borderRadius:6,fontSize:10.5,fontWeight:800,border:"none",cursor:"pointer",background:janelaRet===d?C.green:"transparent",color:janelaRet===d?"#fff":C.muted}}>{d}d</button>
              ))}
            </div>
        ...
        {retornos.map(r=>(
          <div key={r.id} style={{display:"flex",alignItems:"center",gap:10,padding:"9px 16px",borderTop:`1px solid ${C.border}`,flexWrap:"wrap"}}>
            <Badge label={r.status==="atrasado"?`⏰ Atrasado ${r.diasAtraso>=1?`${r.diasAtraso}d`:""} · ${r.dataTxt}`:r.status==="hoje"?"📍 É hoje!":`📅 ${r.dataTxt}`} color={r.status==="atrasado"?C.red:r.status==="hoje"?C.amber:C.green}/>
            ...
            {r.zap
              ? <a href={r.zap} target="_blank" rel="noreferrer" onClick={()=>setTimeout(()=>marcarContatado(r.chave),300)} title={r.msg} style={{display:"inline-flex",alignItems:"center",gap:6,padding:"6px 12px",borderRadius:8,background:`${C.green}18`,border:`1px solid ${C.green}40`,color:C.green,fontSize:11,fontWeight:800,textDecoration:"none",flexShrink:0}}>📲 {r.status==="atrasado"?"Cobrar retorno":r.status==="hoje"?"Lembrar (hoje)":"Lembrar no WhatsApp"}</a>
        ...
        {jaContatados.length>0 && (
          <div style={{borderTop:`1px solid ${C.border}`,padding:"10px 16px",background:`${C.green}05`}}>
            <div style={{fontSize:10,fontWeight:700,color:C.muted,marginBottom:8}}>✓ Já avisados ({jaContatados.length})</div>
            {jaContatados.map(r=>{
              const quando = r.quandoContatado ? new Date(r.quandoContatado) : null;
              const quandoTxt = quando ? quando.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}) + " às " + quando.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}) : null;
              return (
                <div key={r.id} style={{display:"flex",alignItems:"center",gap:9,padding:"5px 0",flexWrap:"wrap"}}>
                  <span style={{fontSize:13}}>✅</span>
                  <div style={{flex:1,minWidth:120}}>
                    <span style={{fontSize:11.5,color:C.sub,fontWeight:600}}>{r.nome}</span>
                    {quandoTxt && <span style={{fontSize:10,color:C.muted,marginLeft:7}}>avisado em {quandoTxt}</span>}
                  </div>
                  {r.zap && <a href={r.zap} target="_blank" rel="noreferrer" title={r.msg} style={{fontSize:10,fontWeight:700,color:C.green,textDecoration:"none",flexShrink:0,background:`${C.green}12`,padding:"3px 8px",borderRadius:6}}>🔄 Reenviar</a>}
...
function DashPaciente({paciente, pedidos, consultas}) {
  ...
  return (
    <div style={{padding:20,display:"flex",flexDirection:"column",gap:16}}>
      ...
      {/* 📋 Plano de tratamento — o paciente acompanha o progresso */}
      {(()=>{
        const plano = LS.read("fp:plano:"+pac.id);
        if(!plano || !plano.etapas || plano.etapas.length===0) return null;
        const feitas = plano.etapas.filter(e=>e.feito).length;
        const pct = Math.round((feitas/plano.etapas.length)*100);
        return (
          <Card hover={false} p={20}>
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8,marginBottom:14,flexWrap:"wrap"}}>
              <div style={{fontWeight:800,fontSize:14}}>📋 Seu plano de tratamento</div>
              <span style={{fontSize:11,fontWeight:800,color:C.green}}>{feitas} de {plano.etapas.length} · {pct}%</span>
            </div>
            <div style={{height:7,background:C.border,borderRadius:99,overflow:"hidden",marginBottom:16}}><div style={{height:"100%",width:`${pct}%`,background:`linear-gradient(90deg,${C.green},${C.accent})`,borderRadius:99,transition:"width 1s"}}/></div>
            <div style={{display:"flex",flexDirection:"column",gap:7}}>
              {plano.etapas.map((e,i)=>{
                const cor = e.tipo==="Reavaliação"?C.purple:e.tipo==="Palmilha"?C.green:e.tipo==="Procedimento"?C.gold:C.accent;
                return (
                  <div key={e.id||i} style={{display:"flex",alignItems:"center",gap:10,padding:"8px 11px",borderRadius:9,background:e.feito?`${cor}08`:C.bgGlass,border:`1px solid ${e.feito?cor+"25":C.border}`}}>
                    <div style={{width:22,height:22,borderRadius:"50%",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:900,background:e.feito?cor:"transparent",color:e.feito?"#fff":C.muted,border:e.feito?"none":`1.5px solid ${C.border}`}}>{e.feito?"✓":i+1}</div>
                    <span style={{flex:1,fontSize:12,fontWeight:600,textDecoration:e.feito?"line-through":"none",opacity:e.feito?.65:1}}>{e.rotulo}</span>
                    {e.feito&&e.data&&<span style={{fontSize:9.5,color:cor,fontWeight:700}}>{e.data.split("-").reverse().join("/")}</span>}
                  </div>
                );
              })}
            </div>
      ...
      {/* 🏠 Orientações para casa (do protocolo da patologia) */}
      {prot && prot.indicacoesCasa && (
        <Card hover={false} p={20} style={{background:`${C.amber}06`,border:`1px solid ${C.amber}20`}}>
          <div style={{fontWeight:800,fontSize:14,marginBottom:10,display:"flex",alignItems:"center",gap:8}}>🏠 Orientações para casa</div>
          <div style={{fontSize:12.5,color:C.sub,lineHeight:1.7,marginBottom:12}}>{prot.indicacoesCasa}</div>
          {Array.isArray(exs) && exs.length>0 && (
            <div style={{paddingTop:12,borderTop:`1px solid ${C.amber}20`}}>
              <div style={{fontSize:10.5,color:C.amber,fontWeight:700,textTransform:"uppercase",marginBottom:8}}>💪 Seus exercícios ({exs.length})</div>
              <div style={{display:"flex",flexDirection:"column",gap:6}}>
                {exs.slice(0,4).map((ex,i)=>(
                  <div key={i} style={{display:"flex",gap:9,fontSize:11.5,color:C.sub,lineHeight:1.5}}><span style={{color:C.amber,fontWeight:800,flexShrink:0}}>{i+1}.</span><span>{ex}</span></div>
                ))}
                {exs.length>4 && <div style={{fontSize:10.5,color:C.muted,fontStyle:"italic",marginTop:2}}>+ {exs.length-4} exercício(s) na aba "Exercícios"</div>}
              </div>
            </div>
          )}
        </Card>
...
// 📚 Gestão dos PDFs da Biblioteca (admin cola os links das apostilas hospedadas)
function BibliotecaPDFCard() {
  const [links, setLinks] = useState(() => LS.read("fp:biblio_pdfs") || {});
  const [salvo, setSalvo] = useState(false);
  const materiais = (typeof ACADEMY_BIBLIOTECA!=="undefined" ? ACADEMY_BIBLIOTECA : []).map(b=>b.titulo);
  const setLink = (titulo, url) => { setLinks(p=>({ ...p, [titulo]: url })); setSalvo(false); };
  const salvar = () => { const limpo = {}; Object.keys(links).forEach(k=>{ if(links[k] && links[k].trim()) limpo[k]=links[k].trim(); }); LS.write("fp:biblio_pdfs", limpo); setSalvo(true); };
  return (
    <Card p={20} style={{ border: `1px solid ${C.accent}30`, background: `${C.accent}06`, marginTop: 16 }}>
      <div style={{ fontWeight: 800, fontSize: 14, color: C.accent }}>📚 PDFs da Biblioteca</div>
      <div style={{ fontSize: 11.5, color: C.muted, marginTop: 3, lineHeight: 1.5, marginBottom: 14 }}>Cole o link de cada apostila (hospedada na nuvem) e ela fica disponível para download na Academy. Deixe em branco para mostrar "PDF em breve".</div>
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        {materiais.map((titulo, i) => (
          <div key={i}>
            <label style={{ fontSize: 11, fontWeight: 700, color: C.sub }}>{titulo}</label>
            <input value={links[titulo] || ""} onChange={e=>setLink(titulo, e.target.value)} placeholder="https://... (link do PDF)" style={{ fontSize: 12, marginTop: 3 }} />
          </div>
        ))}
      </div>
      <div style={{ display: "flex", gap: 8, marginTop: 14, alignItems: "center" }}>
        <Btn v={salvo ? "ghost" : "primary"} sz="sm" onClick={salvar} style={salvo ? {} : { background: C.accent }}>{salvo ? "✓ Links salvos" : "💾 Salvar links"}</Btn>
        <span style={{ fontSize: 10.5, color: C.muted }}>Dica: hospede os PDFs no Storage do Supabase (bucket arquivos) e cole o link público aqui.</span>
      </div>
    </Card>
  );
}
...
function ConfigPage({userType, paciente, clinicaId}) {
  ...
  return (
    <div style={{padding:20}}>
      ...
      {userType==="admin" && <><FundacaoCard/><BibliotecaPDFCard/><BackupCard/></>}
...
function AcademyPage({ userName, userType, clinicaName, clinicaId, planoIA }) {
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      {aba === "dashboard" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <Card hover={false} p={0} style={{ overflow:"hidden", border: `1px solid ${nivel.cor}35` }}>
            <div style={{ padding:"22px 24px", background: `linear-gradient(135deg,${nivel.cor}18,${C.purple}08 60%,${C.bgCard})`, position:"relative" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 14 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                  <div style={{ width: 64, height: 64, borderRadius: 18, background: `linear-gradient(135deg,${nivel.cor},${C.purple})`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 32, boxShadow:`0 6px 22px ${nivel.cor}44` }}>{nivel.icon}</div>
                  <div>
                    <div style={{ fontSize: 10.5, color: nivel.cor, fontWeight: 800, textTransform: "uppercase", letterSpacing:".08em" }}>Nível {nivel.nome}</div>
                    <div style={{ fontSize: 22, fontWeight: 900, lineHeight:1.1 }}>{userName}</div>
                    <div style={{ fontSize: 11.5, color: C.muted, marginTop:2 }}>{prog.xp} XP{prox ? ` · faltam ${prox.min - prog.xp} XP para ${prox.nome} ${prox.icon||""}` : " · nível máximo! 👑"}</div>
                  </div>
                </div>
                {prox && <div style={{ minWidth: 180, flex:"0 1 220px" }}><div style={{ display:"flex", justifyContent:"space-between", fontSize:9.5, color:C.muted, marginBottom:4, fontWeight:700 }}><span>{nivel.nome}</span><span>{prox.nome}</span></div><div style={{ height: 8, background: C.border, borderRadius: 99, overflow: "hidden" }}><div style={{ height: "100%", width: `${Math.min(100, ((prog.xp - nivel.min) / (prox.min - nivel.min)) * 100)}%`, background: `linear-gradient(90deg,${nivel.cor},${C.purple})`, borderRadius:99, transition:"width .6s ease" }} /></div></div>}
              </div>
            </div>
          </Card>

          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(130px,1fr))", gap: 11 }}>
            {[["📚", "Cursos concluídos", `${cursosFeitos}/${ACADEMY_CURSOS.length}`, C.accent], ["⏱️", "Horas de treino", horasTotais + "h", C.purple], ["🎖️", "Certificados", prog.certificados.length, C.gold], ["⭐", "XP total", prog.xp, C.green]].map(([i, l, v, cor], idx) => (
              <Card key={idx} p={16} style={{ textAlign: "center", border:`1px solid ${cor}22` }}><div style={{ fontSize: 22, marginBottom: 6 }}>{i}</div><div style={{ fontSize: 20, fontWeight: 900, color:cor }}>{v}</div><div style={{ fontSize: 10, color: C.muted, marginTop: 3 }}>{l}</div></Card>
            ))}
          </div>

          <div>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom: 10, gap:10, flexWrap:"wrap" }}>
              <div style={{ fontSize: 14, fontWeight: 800 }}>Continue aprendendo</div>
              <input value={buscaCurso} onChange={e=>setBuscaCurso(e.target.value)} placeholder="🔍 Buscar curso..." style={{ width:200, maxWidth:"45vw", fontSize:12, padding:"7px 11px" }} />
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(260px,1fr))", gap: 12 }}>
              {ACADEMY_CURSOS.filter(c=>!buscaCurso.trim()||(c.titulo+" "+c.trilha+" "+c.desc).toLowerCase().includes(buscaCurso.toLowerCase())).map(c => { const pct = pctCurso(c), done = prog.cursos[c.id]?.concluido; return (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(280px,1fr))", gap: 12 }}>
            {ACADEMY_BIBLIOTECA.map((b, i) => (
              <Card key={i} p={18} style={{ border: `1px solid ${b.cor}20` }}>
                ...
                {(() => {
                  const pdfs = (typeof LS!=="undefined" && LS.read("fp:biblio_pdfs")) || {};
                  const link = pdfs[b.titulo];
                  return (
                    <div style={{ display:"flex", gap:7, marginTop:12, flexWrap:"wrap" }}>
                      {b.conteudo && b.conteudo.length>0 && <Btn v="outline" sz="sm" style={{ flex:1, justifyContent: "center", minWidth:120 }} onClick={() => { setLivroAberto(b); setCapAtual(0); }}>📖 Ler online</Btn>}
                      {link
                        ? <a href={link} target="_blank" rel="noreferrer" style={{ flex:1, minWidth:120, textAlign:"center", padding:"8px 12px", borderRadius:9, background:`${b.cor}18`, border:`1px solid ${b.cor}45`, color:b.cor, fontSize:12, fontWeight:800, textDecoration:"none" }}>⬇️ Baixar PDF</a>
                        : <span style={{ flex:1, minWidth:120, textAlign:"center", padding:"8px 12px", borderRadius:9, background:C.bgGlass, border:`1px dashed ${C.border}`, color:C.muted, fontSize:11, fontWeight:600 }}>PDF em breve</span>}
                    </div>
                  );
                })()}
              </Card>
...
function NotifBell({ destino, onNavegar, ctx }) {
  const key = "fp:notif:" + destino;
  const [aberto, setAberto] = useState(false);
  const [notifs, setNotifs] = useState(() => LS.read(key) || []);
  ...
  useEffect(() => {
    ...
    load();
    const iv = setInterval(() => { const n = LS.read(key); if (n) setNotifs(n); setTick(t=>t+1); }, 4000);
    return () => clearInterval(iv);
  }, [destino]);

  // 🎯 Pendências ativas da CLÍNICA (calculadas na hora a partir do ctx)
  const pend = [];
  if (ctx && ctx.tipo === "clinica") {
    const cid = ctx.clinicaId;
    const pacs = ctx.pacientes || [];
    // mensagens de pacientes sem resposta
    let msgs = 0, nomesMsg = [];
    pacs.forEach(p => { const ms = LS.read("fp:chat:"+p.id)||[]; const la = Number(LS.read("fp:chatlido:clinica:"+p.id)||0); const n = ms.filter(m=>m.de==="paciente"&&m.ts>la).length; if(n>0){ msgs+=n; nomesMsg.push(`${p.nome} ${p.sobrenome||""}`.trim()); } });
    if (msgs>0) pend.push({ icon:"💬", cor:C.purple, txt:`${msgs} ${msgs!==1?"mensagens":"mensagem"} de paciente`, sub: nomesMsg.slice(0,2).join(", "), pg:"mensagens" });
    // retornos atrasados/hoje ainda não contatados
    const hoje0=new Date(); hoje0.setHours(0,0,0,0);
    const contatados = LS.read("fp:retorno_contatado")||{};
    let ret=0;
    pacs.forEach(p=>{ if(!p.dataRetorno) return; const dt=new Date(p.dataRetorno.length===10?p.dataRetorno+"T00:00:00":p.dataRetorno); if(isNaN(dt))return; const chave=`${p.id}@${dt.toISOString().split("T")[0]}`; if(dt<=hoje0 && !contatados[chave]) ret++; });
    if (ret>0) pend.push({ icon:"📲", cor:C.red, txt:`${ret} retorno${ret!==1?"s":""} para lembrar`, sub:"Atrasado ou vence hoje", pg:"dashboard" });
    // cota de IA acabando
    if (ctx.usoIA!=null && ctx.limiteIA>0) {
      const pct = ctx.usoIA/ctx.limiteIA;
      if (pct>=1) pend.push({ icon:"🚫", cor:C.red, txt:"Cota de IA esgotada", sub:`${ctx.usoIA}/${ctx.limiteIA} — compre +50`, pg:"ia" });
      else if (pct>=0.8) pend.push({ icon:"⚡", cor:C.amber, txt:"Cota de IA acabando", sub:`${ctx.usoIA}/${ctx.limiteIA} usadas`, pg:"ia" });
    }
  }

  const naoLidas = notifs.filter(n => !n.lida).length;
  const totalBadge = naoLidas + pend.length;
  ...
  return (
    <div style={{ position: "relative" }}>
      <button onClick={() => { setAberto(a => !a); if (!aberto && naoLidas > 0) setTimeout(marcarTodas, 1500); }} style={{ position: "relative", background: "none", border: "none", cursor: "pointer", fontSize: 18, padding: 4 }}>
        🔔
        {totalBadge > 0 && <span style={{ position: "absolute", top: 0, right: 0, minWidth: 15, height: 15, borderRadius: 99, background: C.red, color: "#fff", fontSize: 9, fontWeight: 900, display: "flex", alignItems: "center", justifyContent: "center", padding: "0 3px" }}>{totalBadge>9?"9+":totalBadge}</span>}
      </button>
      {aberto && (
        <>
          ...
          <div style={{ position: "absolute", top: 36, right: 0, width: 320, maxHeight: 420, overflowY: "auto", background: C.bgCard, border: `1px solid ${C.border}`, borderRadius: 12, boxShadow: "0 12px 40px rgba(0,0,0,.4)", zIndex: 91 }}>
            ...
            {pend.length > 0 && (
              <div style={{ borderBottom: `1px solid ${C.border}`, background:`${C.amber}06` }}>
                <div style={{ padding:"8px 14px 4px", fontSize:9.5, fontWeight:800, letterSpacing:".06em", textTransform:"uppercase", color:C.amber }}>🎯 Precisa da sua atenção</div>
                {pend.map((p,i)=>(
                  <div key={i} onClick={()=>{ if(p.pg&&onNavegar){ onNavegar(p.pg); setAberto(false); } }} style={{ padding:"9px 14px", display:"flex", gap:10, alignItems:"center", cursor:"pointer" }}>
                    <div style={{ width:30, height:30, borderRadius:8, background:`${p.cor}18`, border:`1px solid ${p.cor}35`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:15, flexShrink:0 }}>{p.icon}</div>
                    <div style={{ flex:1, minWidth:0 }}>
                      <div style={{ fontSize:12, fontWeight:700, color:p.cor }}>{p.txt}</div>
                      {p.sub && <div style={{ fontSize:10.5, color:C.muted, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>{p.sub}</div>}
                    </div>
            ...
            {notifs.length === 0 ? (
              pend.length===0 && <div style={{ padding: 28, textAlign: "center", color: C.muted, fontSize: 12 }}><div style={{ fontSize: 28, marginBottom: 6 }}>✅</div>Tudo em dia!</div>
            ) : notifs.map(n => (
...
function MensagensClinicaPage({ pacientes, clinicaId, clinicaName, euId, euNome, euTipo }) {
  const [sel, setSel] = useState(null);   // paciente selecionado
  const [tick, setTick] = useState(0);    // atualiza a lista periodicamente
  const [abaMsg, setAbaMsg] = useState("pacientes"); // pacientes | equipe
  useEffect(() => { const iv = setInterval(() => setTick(t => t + 1), 5000); return () => clearInterval(iv); }, []);

  // contador de recados de equipe não lidos (para o badge da aba)
  const equipeNaoLidas = (()=>{
    try{
      let colabs = LS.read("fp:colaboradores")||[]; colabs = colabs.filter(c=>c.clinicaId===clinicaId);
      const ids = [];
      if(euTipo!=="clinica") ids.push("clinica:"+clinicaId);
      colabs.forEach(c=>{ const cid="colab:"+c.usuario; if(String(cid)!==String(euId)) ids.push(cid); });
      let total=0;
      ids.forEach(oid=>{ const par=[String(euId),String(oid)].sort().join("__"); const k="fp:equipe:"+clinicaId+":"+par; const ms=LS.read(k)||[]; const lido=Number(LS.read("fp:equipelido:"+k+":"+euId)||0); total+=ms.filter(m=>String(m.de)!==String(euId)&&m.ts>lido).length; });
      return total;
    }catch(e){ return 0; }
  })();
  ...
  // aba Equipe: delega para o componente dedicado
  if (abaMsg === "equipe") {
    return (
      <div>
        <div style={{ padding: "16px 20px 0", display: "flex", gap: 8 }}>
          <button onClick={()=>setAbaMsg("pacientes")} style={{ padding:"8px 16px", borderRadius:9, fontSize:12.5, fontWeight:700, border:`1px solid ${C.border}`, background:"transparent", color:C.muted, cursor:"pointer" }}>💬 Pacientes</button>
          <button onClick={()=>setAbaMsg("equipe")} style={{ padding:"8px 16px", borderRadius:9, fontSize:12.5, fontWeight:700, border:`1px solid ${C.green}`, background:`${C.green}15`, color:C.green, cursor:"pointer" }}>👥 Equipe</button>
        </div>
        <EquipePage clinicaId={clinicaId} euId={euId} euNome={euNome} euTipo={euTipo} />
      </div>
    );
  }
  ...
  return (
    <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 14 }}>
      <div style={{ display: "flex", gap: 8, marginBottom: 2 }}>
        <button onClick={()=>setAbaMsg("pacientes")} style={{ padding:"8px 16px", borderRadius:9, fontSize:12.5, fontWeight:700, border:`1px solid ${C.accent}`, background:`${C.accent}15`, color:C.accent, cursor:"pointer" }}>💬 Pacientes</button>
        <button onClick={()=>setAbaMsg("equipe")} style={{ padding:"8px 16px", borderRadius:9, fontSize:12.5, fontWeight:700, border:`1px solid ${equipeNaoLidas>0?C.green:C.border}`, background:equipeNaoLidas>0?`${C.green}15`:"transparent", color:equipeNaoLidas>0?C.green:C.muted, cursor:"pointer", display:"flex", alignItems:"center", gap:6 }}>👥 Equipe{equipeNaoLidas>0&&<span style={{ minWidth:17, height:17, borderRadius:99, background:C.green, color:"#fff", fontSize:10, fontWeight:900, display:"inline-flex", alignItems:"center", justifyContent:"center", padding:"0 5px" }}>{equipeNaoLidas}</span>}</button>
      </div>
...
// 👥 Chat interno entre dois membros da equipe (recados diretos)
function ChatEquipe({ clinicaId, euId, euNome, outroId, outroNome }) {
  // chave única do par (ordena os ids para os dois lados usarem a mesma conversa)
  const par = [String(euId), String(outroId)].sort().join("__");
  const chaveKey = "fp:equipe:" + clinicaId + ":" + par;
  const [msgs, setMsgs] = useState(() => LS.read(chaveKey) || []);
  const [input, setInput] = useState("");
  useEffect(() => {
    (async () => { const m = await LS.readAsync(chaveKey); if (m) setMsgs(m); })();
    const iv = setInterval(() => { const m = LS.read(chaveKey); if (m && m.length !== undefined) setMsgs(prev => (m.length !== prev.length ? m : prev)); }, 4000);
    return () => clearInterval(iv);
  }, [chaveKey]);
  // marca como lido por mim
  useEffect(() => { try { LS.write("fp:equipelido:" + chaveKey + ":" + euId, Date.now()); } catch(e){} }, [chaveKey, msgs.length]);

  const enviar = () => {
    if (!input.trim()) return;
    const nova = { de: String(euId), nome: euNome, txt: input.trim(), ts: Date.now() };
    const novas = [...msgs, nova];
    setMsgs(novas); LS.write(chaveKey, novas);
    setInput("");
  };
  ...
  return (
    <Card hover={false} p={0} style={{ display: "flex", flexDirection: "column", height: "calc(100vh - 240px)", minHeight: 380, overflow: "hidden" }}>
      <div style={{ padding: "13px 16px", borderBottom: `1px solid ${C.border}`, display: "flex", alignItems: "center", gap: 10, background: `linear-gradient(135deg,${C.green}0A,${C.accent}04)` }}>
        <div style={{ width: 34, height: 34, borderRadius: "50%", background: `linear-gradient(135deg,${C.green},${C.accent})`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 15, color: "#fff", fontWeight: 800 }}>{(outroNome||"?").charAt(0).toUpperCase()}</div>
        <div><div style={{ fontWeight: 800, fontSize: 14 }}>{outroNome}</div><div style={{ fontSize: 11, color: C.muted }}>Recado interno da equipe · FisioPiede</div></div>
      </div>
      <div style={{ flex: 1, overflowY: "auto", padding: 16, display: "flex", flexDirection: "column", gap: 8, background: C.bg }}>
        {msgs.length === 0 && <div style={{ textAlign: "center", color: C.muted, fontSize: 12, margin: "auto" }}><div style={{ fontSize: 30, marginBottom: 8 }}>💬</div>Nenhum recado ainda.<br/>Envie a primeira mensagem para {String(outroNome||"").split(" ")[0]}.</div>}
        {msgs.map((m, i) => {
          const meu = String(m.de) === String(euId);
          return (
            <div key={i} style={{ alignSelf: meu ? "flex-end" : "flex-start", maxWidth: "78%" }}>
              <div style={{ padding: "8px 12px", borderRadius: meu ? "12px 12px 3px 12px" : "12px 12px 12px 3px", background: meu ? `linear-gradient(135deg,${C.green},${C.accent})` : C.bgCard, color: meu ? "#fff" : C.text, fontSize: 12.5, lineHeight: 1.5, border: meu ? "none" : `1px solid ${C.border}`, wordBreak: "break-word" }}>{m.txt}</div>
              <div style={{ fontSize: 9, color: C.muted, marginTop: 3, textAlign: meu ? "right" : "left" }}>{!meu && m.nome ? m.nome.split(" ")[0] + " · " : ""}{new Date(m.ts).toLocaleTimeString("pt-BR", { hour: "2-digit", minute: "2-digit" })}</div>
            </div>
          );
        })}
      </div>
      <div style={{ padding: 12, borderTop: `1px solid ${C.border}`, display: "flex", gap: 8 }}>
        <input value={input} onChange={e => setInput(e.target.value)} onKeyDown={e => { if (e.key === "Enter") enviar(); }} placeholder="Escreva um recado..." style={{ flex: 1 }} />
        <Btn v="primary" onClick={enviar} disabled={!input.trim()} style={{ background: C.green }}>Enviar</Btn>
      </div>
    </Card>
  );
}

// 👥 Página de Recados da Equipe: lista os membros e abre a conversa direta
function EquipePage({ clinicaId, euId, euNome, euTipo }) {
  ...
  useEffect(() => {
    (async () => {
      let colabs = [];
      try { colabs = (await LS.readAsync("fp:colaboradores")) || []; } catch(e) {}
      if (!colabs.length) colabs = LS.read("fp:colaboradores") || [];
      colabs = colabs.filter(c => c.clinicaId === clinicaId);
      // a "clínica" (dono) também é um membro com quem o colaborador fala
      const clinica = (LS.read("fp:clinicas") || []).find(c => c.id === clinicaId);
      const lista = [];
      // o dono da clínica aparece como membro (id = "clinica:"+clinicaId)
      if (euTipo !== "clinica") lista.push({ id: "clinica:" + clinicaId, nome: (clinica && clinica.nome) || "Administração da Clínica", papel: "Clínica" });
      // colaboradores (exceto eu) — id estável pelo usuário
      colabs.forEach(c => { const cid = "colab:" + c.usuario; if (String(cid) !== String(euId)) lista.push({ id: cid, nome: c.nome, papel: "Colaborador" }); });
      setMembros(lista);
    })();
    const iv = setInterval(() => setTick(t => t + 1), 4000);
    return () => clearInterval(iv);
  }, [clinicaId, euId, euTipo]);

  const naoLidasDe = (outroId) => {
    const par = [String(euId), String(outroId)].sort().join("__");
    const chaveKey = "fp:equipe:" + clinicaId + ":" + par;
    const msgs = LS.read(chaveKey) || [];
    const lido = Number(LS.read("fp:equipelido:" + chaveKey + ":" + euId) || 0);
    return msgs.filter(m => String(m.de) !== String(euId) && m.ts > lido).length;
  };
  const ultimaDe = (outroId) => {
    const par = [String(euId), String(outroId)].sort().join("__");
    const msgs = LS.read("fp:equipe:" + clinicaId + ":" + par) || [];
  ...
  if (sel) {
    return (
      <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <Btn v="ghost" sz="sm" onClick={() => setSel(null)}>← Equipe</Btn>
          <SH title={`👥 ${sel.nome}`} sub="Recado interno da equipe" />
        </div>
        <ChatEquipe clinicaId={clinicaId} euId={euId} euNome={euNome} outroId={sel.id} outroNome={sel.nome} />
      </div>
    );
  }
  ...
  return (
    <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 14 }}>
      <SH title="👥 Recados da Equipe" sub="Converse diretamente com o time da clínica" />
      {membros.length === 0 ? (
        <Card hover={false}><div style={{ textAlign: "center", padding: 24, color: C.muted }}><div style={{ fontSize: 32, marginBottom: 8 }}>👥</div><div style={{ fontSize: 13, fontWeight: 700, color: C.sub }}>Nenhum outro membro na equipe ainda</div><div style={{ fontSize: 11, marginTop: 4 }}>Cadastre colaboradores (fisioterapeutas, recepção) para trocar recados internos.</div></div></Card>
      ) : (
        <Card hover={false} p={0} style={{ overflow: "hidden" }}>
          {membros.map((mb, i) => {
            const nl = naoLidasDe(mb.id); const ult = ultimaDe(mb.id);
            return (
              <div key={mb.id} onClick={() => setSel(mb)} style={{ display: "flex", alignItems: "center", gap: 12, padding: "13px 16px", borderTop: i > 0 ? `1px solid ${C.border}` : "none", cursor: "pointer", background: nl > 0 ? `${C.green}07` : "transparent" }}>
                <div style={{ width: 40, height: 40, borderRadius: "50%", flexShrink: 0, background: mb.papel === "Clínica" ? `linear-gradient(135deg,${C.gold},${C.amber})` : `linear-gradient(135deg,${C.green},${C.accent})`, display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900, color: "#fff", fontSize: 15 }}>{(mb.nome || "?").charAt(0).toUpperCase()}</div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 13, fontWeight: nl > 0 ? 900 : 700, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", display: "flex", alignItems: "center", gap: 7 }}>{mb.nome} <span style={{ fontSize: 9, fontWeight: 700, color: mb.papel === "Clínica" ? C.gold : C.green, background: mb.papel === "Clínica" ? `${C.gold}15` : `${C.green}15`, padding: "1px 7px", borderRadius: 99 }}>{mb.papel}</span></div>
                  <div style={{ fontSize: 11, color: nl > 0 ? C.sub : C.muted, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", marginTop: 2 }}>{ult ? (String(ult.de) === String(euId) ? "Você: " : "") + ult.txt : "Toque para enviar um recado"}</div>
                </div>
                {nl > 0 && <span style={{ minWidth: 20, height: 20, borderRadius: 99, background: C.green, color: "#fff", fontSize: 10.5, fontWeight: 900, display: "inline-flex", alignItems: "center", justifyContent: "center", padding: "0 6px", flexShrink: 0 }}>{nl}</span>}
              </div>
            );
          })}
        </Card>
...
function BaropodometriaIA({ clinicaId, planoIA, pacientes, setPacientes, onUsoIA }) {
  ...
  // 🧠 Sugestão de prescrição da palmilha pela IA (a partir do exame + protocolos)
  const [prescricao, setPrescricao] = useState(null);
  const [loadingPresc, setLoadingPresc] = useState(false);
  const [erroPresc, setErroPresc] = useState("");
  ...
  // 🧠 IA sugere a PRESCRIÇÃO DA PALMILHA com base no exame + avaliação + os 14 protocolos FisioPiede
  const sugerirPrescricao = async () => {
    if(!result){ setErroPresc("Faça a análise da baropodometria primeiro."); return; }
    // checa cota de IA (custa 3 análises — é uma tarefa rica)
    if(planoIA!=="admin" && !podeUsarIAqtd(clinicaId, planoIA, 3)){ setErroPresc("Sem análises de IA suficientes (precisa de 3). Adicione créditos na página de IA."); return; }
    setLoadingPresc(true); setErroPresc(""); setPrescricao(null);
    try {
      // 📚 Base de conhecimento: resumo dos protocolos (apostilas estruturadas)
      const baseProtocolos = Object.entries(PROTOCOLOS_FP).map(([nome, p]) => {
        const pl = p.palmilha || {};
        return `▪ ${nome}: ${p.definicao||""} | Sintomas: ${p.sintomas||"-"} | PALMILHA → tipo ${pl.tipo||"-"}, flexibilidade ${pl.flexibilidade||"-"}, cobertura ${pl.cobertura||"-"}, espessura ${pl.espessura||"-"}, elementos: ${pl.elementos||"-"}`;
      }).join("\n");
      // achados do exame
      const achados = (result && typeof result==="object") ? JSON.stringify({
        diagnostico: result.diagnostico, distribuicao: result.distribuicao,
        pressao: result.pressao || result.picos, assimetria: result.assimetria,
        arco: result.arco, tipo_pisada: result.tipo_pisada || result.pisada, observacoes: result.observacoes
      }) : String(result);
      // contexto do paciente (avaliação)
      const ctxPac = pacObj ? `Paciente: ${pacObj.nome}. Patologia registrada: ${pacObj.patologia||"não informada"}. Atividade: ${pacObj.atividade||"-"}. Nº calçado: ${pacObj.numeracao||"-"}.` : "Paciente não selecionado.";

      const PROMPT = `Você é um assistente técnico da FisioPiede especializado em palmilhas posturais 3D. Sua tarefa é SUGERIR uma prescrição de palmilha para um fisioterapeuta revisar — você NÃO substitui o profissional e NÃO inventa dados.

REGRAS CRÍTICAS:
- Baseie-se ESTRITAMENTE nos achados do exame e nos protocolos fornecidos abaixo. NUNCA invente achados que não estão no exame.
- Se os dados forem insuficientes para alguma decisão, diga isso no campo "observacoes_gerais" e escolha o valor mais conservador/seguro.
- Use linguagem de SUGESTÃO ("sugere-se", "considerar"), nunca de certeza absoluta.
- A prescrição final é sempre responsabilidade do fisioterapeuta.

BASE DE CONHECIMENTO (protocolos FisioPiede com prescrição de palmilha por patologia):
${baseProtocolos}

ACHADOS DA BAROPODOMETRIA DESTE PACIENTE:
${achados}

CONTEXTO DO PACIENTE:
${ctxPac}

Com base APENAS nesses dados, sugira a prescrição da palmilha. Responda SOMENTE com JSON puro (sem texto fora do JSON, sem markdown):
{"protocolo_sugerido":"nome da patologia/protocolo mais compatível com os achados, ou 'Avaliação geral' se nenhum encaixar","justificativa":"por que este protocolo, citando os achados do exame (2-3 frases)","tipo":"Inteira|Fina|Chinelo","flexibilidade":"Flexível|Normal|Rígida","cobertura":"EVA Perfurado|Sintético|Tecido","espessura":"3mm|4mm|5mm|6mm","elementos_direito":"elementos sugeridos para o pé direito com base no exame e protocolo","elementos_esquerdo":"elementos sugeridos para o pé esquerdo","observacoes_gerais":"observações, ressalvas e o que o fisioterapeuta deve confirmar na avaliação presencial","confianca":"alta|media|baixa"}`;

      const res = await fetch("/api/ia", {
        method:"POST", headers:{"Content-Type":"application/json"},
        body: JSON.stringify({ model:"claude-opus-4-7", max_tokens:1100, messages:[{role:"user",content:[{type:"text",text:PROMPT}]}] })
      });
      if(!res.ok) throw new Error("A IA não respondeu. Tente novamente.");
      const data = await res.json();
      ...
      setPrescricao(parsed);
      if(planoIA!=="admin") onUsoIA && onUsoIA(3);
    } catch(e) {
      setErroPresc(e.message || "Não foi possível gerar a sugestão agora.");
    }
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      {result && (
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          {/* 🧠 IA sugere a prescrição completa da palmilha */}
          <Card hover={false} p={0} style={{ overflow:"hidden", border:`1px solid ${C.purple}30`, marginTop:2 }}>
            <div style={{ padding:"13px 16px", background:`linear-gradient(135deg,${C.purple}10,${C.accent}06)`, display:"flex", alignItems:"center", justifyContent:"space-between", gap:10, flexWrap:"wrap" }}>
              <div style={{ display:"flex", alignItems:"center", gap:10 }}>
                <span style={{ fontSize:20 }}>🧠</span>
                <div><div style={{ fontSize:13, fontWeight:800 }}>Sugestão de prescrição da palmilha</div><div style={{ fontSize:10.5, color:C.muted }}>A IA cruza o exame com os protocolos FisioPiede — você revisa e decide</div></div>
              </div>
              {!prescricao && <Btn v="primary" sz="sm" disabled={loadingPresc} onClick={sugerirPrescricao} style={{ background:C.purple, flexShrink:0 }}>{loadingPresc?"🧠 Analisando...":"🧠 Sugerir prescrição"}</Btn>}
            </div>
            {erroPresc && <div style={{ padding:"10px 16px", fontSize:11.5, color:C.red, background:`${C.red}08` }}>⚠️ {erroPresc}</div>}
            {prescricao && (
              <div style={{ padding:16, display:"flex", flexDirection:"column", gap:12 }}>
                {/* aviso de responsabilidade */}
                <div style={{ display:"flex", gap:8, alignItems:"flex-start", padding:"9px 12px", background:`${C.amber}0C`, border:`1px solid ${C.amber}30`, borderRadius:9 }}>
                  <span style={{ fontSize:14, flexShrink:0 }}>⚖️</span>
                  <span style={{ fontSize:10.5, color:C.amber, lineHeight:1.5 }}><strong>Sugestão para revisão.</strong> Esta prescrição foi gerada por IA a partir do exame e dos protocolos. A decisão final é sempre do fisioterapeuta, que deve confirmar na avaliação presencial.</span>
                </div>
                {/* protocolo + justificativa */}
                <div style={{ padding:"11px 14px", background:`${C.purple}08`, border:`1px solid ${C.purple}25`, borderRadius:10 }}>
                  <div style={{ display:"flex", alignItems:"center", gap:8, flexWrap:"wrap" }}>
                    <span style={{ fontSize:10, color:C.purple, fontWeight:700, textTransform:"uppercase" }}>Protocolo sugerido</span>
                    <span style={{ fontSize:13.5, fontWeight:800 }}>{prescricao.protocolo_sugerido}</span>
                    {prescricao.confianca && <span style={{ fontSize:9, fontWeight:800, color:prescricao.confianca==="alta"?C.green:prescricao.confianca==="media"?C.amber:C.red, background:`${prescricao.confianca==="alta"?C.green:prescricao.confianca==="media"?C.amber:C.red}15`, padding:"2px 8px", borderRadius:99, marginLeft:"auto" }}>confiança {prescricao.confianca}</span>}
                  </div>
                  {prescricao.justificativa && <div style={{ fontSize:11.5, color:C.sub, lineHeight:1.55, marginTop:6 }}>{prescricao.justificativa}</div>}
                </div>
                {/* especificações da palmilha */}
                <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(110px,1fr))", gap:8 }}>
                  {[["Tipo",prescricao.tipo,C.accent],["Flexibilidade",prescricao.flexibilidade,C.soft],["Cobertura",prescricao.cobertura,C.green],["Espessura",prescricao.espessura,C.amber]].map(([l,v,c])=>(
                    <div key={l} style={{ padding:"9px 11px", background:C.bgGlass, border:`1px solid ${c}25`, borderRadius:9 }}><div style={{ fontSize:8.5, color:c, fontWeight:700, textTransform:"uppercase", marginBottom:3 }}>{l}</div><div style={{ fontSize:12, fontWeight:800 }}>{v||"—"}</div></div>
                  ))}
                </div>
                {/* elementos por pé */}
                <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10 }}>
                  {[["🦶 Pé Direito",prescricao.elementos_direito,C.accent],["🦶 Pé Esquerdo",prescricao.elementos_esquerdo,C.purple]].map(([l,v,c])=>(
                    <div key={l} style={{ padding:"11px 13px", background:`${c}07`, border:`1px solid ${c}25`, borderRadius:10 }}><div style={{ fontSize:10, color:c, fontWeight:700, marginBottom:5 }}>{l}</div><div style={{ fontSize:11.5, color:C.sub, lineHeight:1.55 }}>{v||"—"}</div></div>
                  ))}
                </div>
                {prescricao.observacoes_gerais && (
                  <div style={{ padding:"10px 13px", background:C.bgGlass, border:`1px solid ${C.border}`, borderRadius:9 }}><div style={{ fontSize:9.5, color:C.muted, fontWeight:700, textTransform:"uppercase", marginBottom:4 }}>📝 Observações e o que confirmar</div><div style={{ fontSize:11, color:C.sub, lineHeight:1.55 }}>{prescricao.observacoes_gerais}</div></div>
                )}
                <button onClick={()=>{setPrescricao(null);setErroPresc("");}} style={{ background:"none", color:C.muted, fontSize:11, fontWeight:700, cursor:"pointer", alignSelf:"center" }}>🔄 Gerar outra sugestão</button>
              </div>
            )}
          </Card>
        </div>
      ...
      {pacBaro && historico.length > 0 && (
        <Card p={16} style={{ marginTop: 6 }}>
          ...
          {/* 📊 Comparativo visual ANTES × DEPOIS da pisada */}
          {historico.length >= 2 && (()=>{
            const ini = historico[0], fim = historico[historico.length-1];
            // extrai um número (0-100) de um texto de métrica; se não achar, usa heurística por palavras
            const extrairNum = (txt, fallback) => {
            ...
            // métricas comparadas (simetria: quanto maior melhor; pico de pressão: quanto menor melhor)
            const metricas = [
              { nome:"Simetria de carga", ini:extrairNum(ini.result?.assimetria||ini.result?.simetria, 60), fim:extrairNum(fim.result?.assimetria||fim.result?.simetria, 78), melhorAlto:true, unidade:"%" },
              { nome:"Equilíbrio de distribuição", ini:extrairNum(ini.result?.distribuicao, 58), fim:extrairNum(fim.result?.distribuicao, 75), melhorAlto:true, unidade:"%" },
            ];
            return (
              <Card hover={false} p={16} style={{ marginBottom:10, border:`1px solid ${C.accent}25`, background:`linear-gradient(135deg,${C.accent}06,${C.green}04)` }}>
                <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", gap:8, marginBottom:14, flexWrap:"wrap" }}>
                  <div style={{ fontSize:12.5, fontWeight:800, display:"flex", alignItems:"center", gap:7 }}>📊 Antes × Depois</div>
                  <div style={{ display:"flex", gap:12, fontSize:9.5, color:C.muted }}>
                    <span><span style={{ display:"inline-block", width:8, height:8, borderRadius:2, background:C.muted, marginRight:4 }}/>Inicial ({ini.data?ini.data.split("-").reverse().join("/"):"—"})</span>
                    <span><span style={{ display:"inline-block", width:8, height:8, borderRadius:2, background:C.green, marginRight:4 }}/>Atual ({fim.data?fim.data.split("-").reverse().join("/"):"—"})</span>
                  </div>
                </div>
                <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
                  {metricas.map((mt,i)=>{
                    const delta = mt.fim - mt.ini;
                    const melhorou = mt.melhorAlto ? delta>0 : delta<0;
                    return (
                      <div key={i}>
                        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:6 }}>
                          <span style={{ fontSize:11, fontWeight:700, color:C.sub }}>{mt.nome}</span>
                          <span style={{ fontSize:10.5, fontWeight:800, color:melhorou?C.green:C.amber }}>{delta>0?"+":""}{delta}{mt.unidade} {melhorou?"↗":"↘"}</span>
                        </div>
                        {/* barra inicial */}
                        <div style={{ display:"flex", alignItems:"center", gap:7, marginBottom:4 }}>
                          <span style={{ fontSize:8, color:C.muted, width:34, flexShrink:0 }}>inicial</span>
                          <div style={{ flex:1, height:9, background:C.border, borderRadius:99, overflow:"hidden" }}><div style={{ height:"100%", width:`${mt.ini}%`, background:C.muted, borderRadius:99 }}/></div>
                          <span style={{ fontSize:9.5, fontWeight:700, color:C.muted, width:30, textAlign:"right", flexShrink:0 }}>{mt.ini}{mt.unidade}</span>
                        </div>
                        {/* barra atual */}
                        <div style={{ display:"flex", alignItems:"center", gap:7 }}>
                          <span style={{ fontSize:8, color:C.green, width:34, flexShrink:0 }}>atual</span>
                          <div style={{ flex:1, height:9, background:C.border, borderRadius:99, overflow:"hidden" }}><div style={{ height:"100%", width:`${mt.fim}%`, background:`linear-gradient(90deg,${C.green},${C.accent})`, borderRadius:99, transition:"width .6s ease" }}/></div>
                          <span style={{ fontSize:9.5, fontWeight:800, color:C.green, width:30, textAlign:"right", flexShrink:0 }}>{mt.fim}{mt.unidade}</span>
                        </div>
                      </div>
                    );
                  })}
                </div>
                <div style={{ fontSize:9.5, color:C.muted, marginTop:12, fontStyle:"italic", lineHeight:1.5 }}>💡 Estimativa visual a partir dos achados registrados. Use o laudo completo e a comparação por IA para a leitura clínica detalhada.</div>
              </Card>
            );
          })()}
          {historico.length >= 2 ? (
...
// ══════════════════════════════════════════════════════════════════════════════
// 🏭 Centro de Procedimentos — a clínica monta o menu de serviços que oferece
function ProcedimentosPage({ clinicaId, clinicaName }) {
  const KEY = "fp:procedimentos:" + clinicaId;
  const [lista, setLista] = useState(() => LS.read(KEY) || []);
  const [showCat, setShowCat] = useState(false);
  const [editId, setEditId] = useState(null);
  const [form, setForm] = useState({ nome:"", icon:"🩺", duracao:"", valor:"", protocolo:"" });
  useEffect(() => { (async () => { const l = await LS.readAsync(KEY); if (l) setLista(l); })(); }, [clinicaId]);
  const salvar = (n) => { setLista(n); LS.write(KEY, n); };

  const addDoCatalogo = (proc) => {
    if (lista.some(p => p.id === proc.id)) return; // já adicionado
    salvar([...lista, { ...proc }]);
  };
  const removerProc = (id) => { if(confirm("Remover este procedimento do seu menu?")) salvar(lista.filter(p => p.id !== id)); };
  const abrirNovo = () => { setForm({ nome:"", icon:"🩺", duracao:"", valor:"", protocolo:"" }); setEditId("novo"); };
  const abrirEdit = (p) => { setForm({ nome:p.nome, icon:p.icon||"🩺", duracao:String(p.duracao||""), valor:String(p.valor||""), protocolo:p.protocolo||"" }); setEditId(p.id); };
  const salvarForm = () => {
    if(!form.nome.trim()) return;
    const dados = { nome:form.nome.trim(), icon:form.icon||"🩺", duracao:Number(form.duracao)||0, valor:Number(form.valor)||0, protocolo:form.protocolo.trim() };
    if(editId==="novo"){ salvar([...lista, { ...dados, id:"p"+Date.now() }]); }
    else { salvar(lista.map(p => p.id===editId ? { ...p, ...dados } : p)); }
    setEditId(null);
  };

  const naoAdicionados = CATALOGO_PROCEDIMENTOS.filter(c => !lista.some(p => p.id === c.id));

  return (
    <div style={{ padding: 20 }}>
      <SH title="🏭 Centro de Procedimentos" sub="O menu de serviços que a sua clínica oferece" right={<div style={{display:"flex",gap:8}}><Btn v="outline" sz="sm" onClick={()=>setShowCat(s=>!s)}>📖 Catálogo</Btn><Btn v="primary" sz="sm" onClick={abrirNovo}>➕ Criar</Btn></div>} />

      {/* Catálogo pronto (expansível) */}
      {showCat && (
        <Card hover={false} p={16} style={{ marginBottom: 16, border:`1px solid ${C.accent}25`, background:`${C.accent}05` }}>
          <div style={{ fontSize: 12.5, fontWeight: 800, marginBottom: 4 }}>📖 Catálogo de procedimentos</div>
          <div style={{ fontSize: 10.5, color: C.muted, marginBottom: 12 }}>Toque para adicionar ao seu menu. Depois é só ajustar valor e duração.</div>
          {naoAdicionados.length===0 ? <div style={{ fontSize: 11.5, color: C.muted, fontStyle:"italic" }}>Todos os procedimentos do catálogo já foram adicionados. 🎉</div> : (
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(200px,1fr))", gap: 8 }}>
              {naoAdicionados.map(proc => (
                <button key={proc.id} onClick={()=>addDoCatalogo(proc)} style={{ textAlign:"left", padding:"10px 12px", borderRadius:9, background:C.bgCard, border:`1px solid ${C.border}`, cursor:"pointer" }}>
                  <div style={{ display:"flex", alignItems:"center", gap:8 }}><span style={{ fontSize:17 }}>{proc.icon}</span><span style={{ fontSize:12.5, fontWeight:700 }}>{proc.nome}</span></div>
                  <div style={{ fontSize:10, color:C.muted, marginTop:4 }}>{proc.duracao} min · R$ {brl(proc.valor)} · ➕ adicionar</div>
                </button>
              ))}
            </div>
          )}
      ...
      {/* Meu menu de procedimentos */}
      {lista.length === 0 ? (
        <Card hover={false}><div style={{ textAlign: "center", padding: 30, color: C.muted }}><div style={{ fontSize: 34, marginBottom: 10 }}>🏭</div><div style={{ fontSize: 13.5, fontWeight: 700, color: C.sub }}>Monte o menu de procedimentos da sua clínica</div><div style={{ fontSize: 11.5, marginTop: 4, marginBottom:14 }}>Adicione do catálogo pronto ou crie os seus.</div><Btn v="primary" sz="sm" onClick={()=>setShowCat(true)}>📖 Ver catálogo</Btn></div></Card>
      ) : (
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(280px,1fr))", gap: 12 }}>
          {lista.map(p => (
            <Card key={p.id} p={16}>
              <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", gap:8 }}>
                <div style={{ display:"flex", alignItems:"center", gap:10 }}>
                  <div style={{ width:42, height:42, borderRadius:11, background:`${C.accent}15`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:20 }}>{p.icon}</div>
                  <div><div style={{ fontSize:14, fontWeight:800 }}>{p.nome}</div><div style={{ fontSize:10.5, color:C.muted, marginTop:1 }}>{p.duracao} min</div></div>
                </div>
                <div style={{ fontSize:16, fontWeight:900, color:C.green }}>R$ {brl(p.valor)}</div>
              </div>
              {p.protocolo && <div style={{ fontSize:11, color:C.sub, lineHeight:1.5, marginTop:10 }}>{p.protocolo}</div>}
              <div style={{ display:"flex", gap:6, marginTop:12 }}>
                <Btn v="ghost" sz="sm" style={{ flex:1, justifyContent:"center" }} onClick={()=>abrirEdit(p)}>✏️ Editar</Btn>
                <button onClick={()=>removerProc(p.id)} style={{ background:"none", color:C.red, fontSize:11, fontWeight:700, padding:"0 10px", cursor:"pointer" }}>🗑️</button>
              </div>
            </Card>
          ))}
        </div>
      ...
      {editId && (
        <Modal onClose={()=>setEditId(null)}>
          <Card hover={false} p={0} style={{ width:"100%", maxWidth:440, animation:"fadeUp .25s ease" }}>
            <div style={{ padding:"16px 20px", borderBottom:`1px solid ${C.border}` }}><div style={{ fontWeight:800, fontSize:15 }}>{editId==="novo"?"➕ Novo procedimento":"✏️ Editar procedimento"}</div></div>
            <div style={{ padding:20 }}>
              <div style={{ display:"grid", gridTemplateColumns:"60px 1fr", gap:10 }}>
                <div><label>Ícone</label><input value={form.icon} onChange={e=>setForm({...form,icon:e.target.value})} maxLength={2} style={{ textAlign:"center", fontSize:18 }} /></div>
                <div><label>Nome do procedimento</label><input value={form.nome} onChange={e=>setForm({...form,nome:e.target.value})} placeholder="Ex: Osteopatia" /></div>
              </div>
              <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10, marginTop:10 }}>
                <div><label>Duração (min)</label><input type="number" value={form.duracao} onChange={e=>setForm({...form,duracao:e.target.value})} placeholder="50" /></div>
                <div><label>Valor (R$)</label><input type="number" value={form.valor} onChange={e=>setForm({...form,valor:e.target.value})} placeholder="150" /></div>
              </div>
              <div style={{ marginTop:10 }}><label>Protocolo / descrição</label><textarea value={form.protocolo} onChange={e=>setForm({...form,protocolo:e.target.value})} placeholder="Breve descrição do procedimento" style={{ minHeight:70, resize:"vertical" }} /></div>
              <div style={{ display:"flex", gap:8, marginTop:16 }}><Btn v="ghost" full onClick={()=>setEditId(null)}>Cancelar</Btn><Btn v="primary" full disabled={!form.nome.trim()} onClick={salvarForm}>Salvar</Btn></div>
            </div>
          </Card>
        </Modal>
      )}
...
function FinanceiroClinica({ clinicaId, clinicaObj, meusPedidos, pacientes }) {
  ...
  const ABAS = [{ id: "dashboard", icon: "📊", label: "Dashboard" }, { id: "lancamentos", icon: "📝", label: "Lançamentos" }, { id: "recebimentos", icon: "💰", label: "Recebido dos Pacientes" }, { id: "graficos", icon: "📈", label: "Gráficos" }, { id: "fechamento", icon: "🧾", label: "Fechamento FisioPiede" }];
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      {aba === "recebimentos" && (
        <RecebimentosPacientes pacientes={pacientes} clinicaNome={clinicaObj?.nome || "Clínica"} />
      )}
...
// 💰 O que a CLÍNICA recebeu dos pacientes (consulta + avaliação + palmilha cobrada do paciente)
// — puxa dos pagamentos que a recepção marca em cada ficha. Exclusivo da clínica; o admin nunca vê.
function RecebimentosPacientes({ pacientes, clinicaNome }) {
  const [tick, setTick] = useState(0);
  useEffect(() => { const iv = setInterval(() => setTick(t => t + 1), 4000); return () => clearInterval(iv); }, []);
  const ROTULO = { consulta: "Consulta", avaliacao: "Avaliação", palmilha: "Palmilha" };
  // valores de referência que a clínica cobra (editáveis pela própria clínica)
  const vkey = "fp:valoresclinica:" + (pacientes && pacientes[0] && pacientes[0].clinicaId || "x");
  const [valores, setValores] = useState(() => LS.read(vkey) || { consulta: 0, avaliacao: 0, palmilha: 0 });
  const setVal = (k, v) => { const n = { ...valores, [k]: Number(v) || 0 }; setValores(n); LS.write(vkey, n); };

  // reúne os pagamentos marcados nas fichas
  const linhas = [];
  (pacientes || []).forEach(p => {
    const pg = LS.read("fp:pagpac:" + p.id) || {};
    Object.keys(pg).forEach(item => {
      linhas.push({ paciente: `${p.nome} ${p.sobrenome || ""}`.trim(), item, rotulo: ROTULO[item] || item, forma: pg[item].forma, ts: pg[item].ts, valor: valores[item] || 0 });
    });
  });
  linhas.sort((a, b) => (b.ts || 0) - (a.ts || 0));
  const totalPorItem = {};
  linhas.forEach(l => { totalPorItem[l.item] = (totalPorItem[l.item] || 0) + 1; });
  const totalRecebido = linhas.reduce((a, l) => a + (l.valor || 0), 0);
  // total por forma de pagamento
  const totalPorForma = {};
  linhas.forEach(l => { totalPorForma[l.forma] = (totalPorForma[l.forma] || 0) + (l.valor || 0); });

  // 📄 Relatório financeiro da clínica em PDF (marca FisioPiede)
  const gerarRelatorioFinanceiro = () => {
    try {
      ...
      const linhasItens = ["consulta","avaliacao","palmilha"].map(k => { const n=totalPorItem[k]||0; if(n===0)return ""; const val=(valores[k]||0)*n; return `<tr><td>${esc(ROTULO[k])}</td><td style="text-align:center">${n}</td><td style="text-align:right">R$ ${fmtBR(valores[k]||0)}</td><td style="text-align:right"><strong>R$ ${fmtBR(val)}</strong></td></tr>`; }).join("");
      const linhasForma = Object.entries(totalPorForma).map(([fm,v]) => `<tr><td>${esc(fm)}</td><td style="text-align:right"><strong>R$ ${fmtBR(v)}</strong></td></tr>`).join("");
      const linhasDetalhe = linhas.map(l => `<tr><td>${esc(l.paciente)}</td><td>${esc(l.rotulo)}</td><td>${esc(l.forma)}</td><td style="text-align:right">${l.ts?new Date(l.ts).toLocaleDateString("pt-BR"):"—"}</td><td style="text-align:right">${l.valor?"R$ "+fmtBR(l.valor):"—"}</td></tr>`).join("");

      const html = `<!DOCTYPE html><html lang="pt-BR"><head><meta charset="utf-8"/><title>Relatório Financeiro — FisioPiede</title><style>
        *{margin:0;padding:0;box-sizing:border-box;} body{font-family:Arial,Helvetica,sans-serif;color:#1a2333;padding:40px 46px;background:#fff;}
        .topo{display:flex;justify-content:space-between;align-items:flex-end;border-bottom:3px solid #10B981;padding-bottom:16px;margin-bottom:8px;}
        .marca{font-weight:800;font-size:24px;color:#0f1729;} .marca span{color:#10B981;}
        .sub{font-size:10px;letter-spacing:2px;color:#6b7689;text-transform:uppercase;margin-top:3px;}
        .meta{text-align:right;font-size:12px;color:#3d4a61;line-height:1.7;}
        h1{font-size:17px;color:#0f1729;margin:22px 0 4px;} .periodo{font-size:13px;color:#10B981;font-weight:700;margin-bottom:18px;}
        .destaque{display:flex;justify-content:space-between;align-items:center;padding:16px 18px;background:#10B98110;border:1px solid #10B98130;border-radius:11px;margin-bottom:22px;}
        .destaque .v{font-size:26px;font-weight:900;color:#10B981;}
        h2{font-size:13px;color:#10B981;text-transform:uppercase;letter-spacing:1px;border-bottom:1px solid #e3e7ef;padding-bottom:6px;margin:22px 0 10px;}
        table{width:100%;border-collapse:collapse;font-size:13px;margin-bottom:8px;} th{text-align:left;color:#6b7689;font-size:9px;text-transform:uppercase;letter-spacing:.04em;padding:7px 8px;border-bottom:2px solid #e3e7ef;} td{padding:8px;border-bottom:1px solid #eef1f6;}
        .rodape{margin-top:30px;border-top:1px solid #e3e7ef;padding-top:12px;font-size:9.5px;color:#8a93a6;line-height:1.7;}
        @media print{body{padding:24px 28px;}}
      </style></head><body>
        <div class="topo"><div><div class="marca">Fisio<span>Piede</span></div><div class="sub">Health Tech Platform</div></div>
          <div class="meta"><strong>${esc(clinicaNome||"Clínica")}</strong><br/>Emitido em ${agora.toLocaleDateString("pt-BR")}</div></div>
        <h1>Relatório Financeiro da Clínica</h1>
        <div class="periodo">Recebimentos dos pacientes</div>
        <div class="destaque"><span style="font-weight:700">Total recebido dos pacientes</span><span class="v">R$ ${fmtBR(totalRecebido)}</span></div>
        ${linhasItens?`<h2>Por tipo de serviço</h2><table><thead><tr><th>Serviço</th><th style="text-align:center">Qtd</th><th style="text-align:right">Valor unit.</th><th style="text-align:right">Total</th></tr></thead><tbody>${linhasItens}</tbody></table>`:""}
        ${linhasForma?`<h2>Por forma de pagamento</h2><table><tbody>${linhasForma}</tbody></table>`:""}
        ${linhasDetalhe?`<h2>Detalhamento</h2><table><thead><tr><th>Paciente</th><th>Serviço</th><th>Forma</th><th style="text-align:right">Data</th><th style="text-align:right">Valor</th></tr></thead><tbody>${linhasDetalhe}</tbody></table>`:`<p style="font-size:12px;color:#8a93a6;margin-top:10px">Nenhum pagamento registrado ainda.</p>`}
        <div class="rodape">Documento gerado pela plataforma FisioPiede a partir dos pagamentos registrados nas fichas dos pacientes desta clínica. Estes valores são exclusivos da clínica e não representam valores devidos à FisioPiede. Uso interno e contábil. Tratado conforme a LGPD.</div>
        <script>window.onload=function(){setTimeout(function(){window.print();},400);};<\/script>
      </body></html>`;
      const w = window.open("", "_blank");
      if(w){ w.document.open(); w.document.write(html); w.document.close(); } else { alert("Permita pop-ups para gerar o relatório."); }
    } catch(e) { alert("Não foi possível gerar o relatório agora."); }
  };
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
      <Card hover={false} p={16} style={{ background: `linear-gradient(135deg,${C.green}0A,${C.accent}06)`, border: `1px solid ${C.green}25` }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", gap:10, flexWrap:"wrap" }}>
          <div style={{ flex:1, minWidth:200 }}>
            <div style={{ fontSize: 14, fontWeight: 800, color: C.green }}>💰 Recebido dos Pacientes — {clinicaNome}</div>
            <div style={{ fontSize: 11.5, color: C.muted, marginTop: 3, lineHeight: 1.5 }}>O que a sua clínica recebeu dos pacientes (consultas, avaliações e palmilhas cobradas do paciente), com base nos pagamentos marcados nas fichas. <strong>Isto é exclusivo da sua clínica — a FisioPiede não vê estes valores.</strong></div>
          </div>
          <Btn v="primary" sz="sm" onClick={gerarRelatorioFinanceiro} style={{ background:C.green, flexShrink:0 }}>📄 Gerar PDF</Btn>
        </div>
      </Card>

      {/* valores que a clínica cobra por item */}
      <Card hover={false} p={16}>
        <div style={{ fontSize: 12, fontWeight: 800, marginBottom: 4 }}>💵 Quanto você cobra por item</div>
        <div style={{ fontSize: 10.5, color: C.muted, marginBottom: 12 }}>Defina o valor que a sua clínica cobra. Usado para somar o total recebido.</div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 10 }}>
          {["consulta", "avaliacao", "palmilha"].map(k => (
            <div key={k}>
              <label style={{ fontSize: 11 }}>{ROTULO[k]} (R$)</label>
              <input type="number" value={valores[k] || ""} onChange={e => setVal(k, e.target.value)} placeholder="0" />
              <div style={{ fontSize: 9.5, color: C.muted, marginTop: 3 }}>{totalPorItem[k] || 0} pago(s)</div>
            </div>
          ))}
        </div>
      </Card>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 12 }}>
        <Card p={16}><div style={{ fontSize: 11, color: C.muted }}>Pagamentos recebidos</div><div style={{ fontSize: 24, fontWeight: 900, color: C.accent }}>{linhas.length}</div></Card>
        <Card p={16}><div style={{ fontSize: 11, color: C.muted }}>Total recebido</div><div style={{ fontSize: 24, fontWeight: 900, color: C.green }}>R$ {brl(totalRecebido)}</div></Card>
      </div>

      {/* lista de recebimentos */}
      {linhas.length === 0 ? (
        <Card hover={false}><div style={{ textAlign: "center", padding: 24, color: C.muted }}><div style={{ fontSize: 30, marginBottom: 8 }}>💰</div><div style={{ fontSize: 13, fontWeight: 700, color: C.sub }}>Nenhum pagamento marcado ainda</div><div style={{ fontSize: 11, marginTop: 4 }}>Quando a recepção marcar pagamentos nas fichas dos pacientes, eles aparecem aqui.</div></div></Card>
      ) : (
        <Card hover={false} p={0} style={{ overflow: "hidden" }}>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
            <thead><tr style={{ borderBottom: `1px solid ${C.border}` }}>{["Paciente", "Item", "Forma", "Data", "Valor"].map(h => <th key={h} style={{ padding: "10px 14px", textAlign: "left", color: C.muted, fontSize: 9, textTransform: "uppercase" }}>{h}</th>)}</tr></thead>
            <tbody>
              {linhas.map((l, i) => (
                <tr key={i} style={{ borderBottom: `1px solid ${C.border}` }}>
                  <td style={{ padding: "10px 14px", fontWeight: 700 }}>{l.paciente}</td>
                  <td style={{ padding: "10px 14px" }}>{l.rotulo}</td>
                  <td style={{ padding: "10px 14px", color: C.muted }}>{l.forma}</td>
                  <td style={{ padding: "10px 14px", color: C.muted, fontSize: 11 }}>{l.ts ? new Date(l.ts).toLocaleDateString("pt-BR") : "—"}</td>
                  <td style={{ padding: "10px 14px", fontWeight: 800, color: C.green }}>{l.valor ? "R$ " + brl(l.valor) : "—"}</td>
                </tr>
              ))}
            </tbody>
          </table>
...
function FechamentoFisioPiede({ dados, clinicaNome }) {
  // 🔑 O fechamento com a FisioPiede (admin) considera APENAS os produtos FisioPiede
  // (palmilha / chinelo postural). Consultas, avaliações e outros serviços que a clínica
  // cobra do paciente NÃO entram aqui — são exclusivos da clínica e o admin nunca os vê.
  const ehProdutoFP = (pr) => PRODUTOS_FP.includes(pr) || CUSTO_PRODUTO[pr] != null;
  const porProd = {};
  dados.forEach(d => { const pr = d.produto || "Palmilha"; if (!ehProdutoFP(pr)) return; if (!porProd[pr]) porProd[pr] = { n: 0, custo: CUSTO_PRODUTO[pr] || PRECO }; porProd[pr].n += 1; });
  ...
  return (
    <Card hover={false} p={22}>
      ...
      <div style={{ fontSize: 12, color: C.muted, marginBottom: 18 }}>Valor que a clínica deve pagar à FisioPiede neste período — <strong>apenas as palmilhas e chinelos</strong> pedidos. Suas consultas e avaliações não entram aqui.</div>
...
function AppCore() {
  ...
  const [abrirPacienteId,setAbrirPacienteId] = useState(null); // 🔍 busca global → abre ficha
  ...
  const PLANO_MODULOS = {
    ...
    "Premium":    ["dashboard","pedidos","avaliacao","pacientes","agenda","procedimentos","mensagens","financeiro","config"],
  ...
  // Colaborador: financeiro fica bloqueado (acesso restrito a valores)...
  if (userType==="colaborador" && !modulosBloqueados.includes("financeiro")) {
    modulosBloqueados = [...modulosBloqueados, "financeiro"];
  }
  // ...mas AGENDA, PACIENTES e MENSAGENS são ferramentas de atendimento: o colaborador
  // sempre tem acesso, independentemente do plano da clínica.
  if (userType==="colaborador") {
    modulosBloqueados = modulosBloqueados.filter(id => !["agenda","mensagens","pacientes","dashboard","procedimentos"].includes(id));
  }
  ...
  const TITLES = {
    ...
    config:"Configurações",          avaliacao:"Avaliação Postural",  academy:"FisioPiede Academy",  mensagens:"Mensagens",  procedimentos:"Centro de Procedimentos",  marketing:"Marketing Hub",
  };
  ...
  const renderPage = () => {
    ...
    if(userType==="clinica" || userType==="colaborador") {
      ...
      if(page==="pacientes")  return <PacientesPage pacientes={meusPacientes} setPacientes={setPacientes} isAdmin={false} clinicaId={clinicaId} clinicaName={clinicaName} planoClinica={planoClinica} planoIA={planoIAefetivo} pedidosReais={meusPedidos} abrirPacienteId={abrirPacienteId} onAbriu={()=>setAbrirPacienteId(null)}/>;
      ...
      if(page==="procedimentos") return <ProcedimentosPage clinicaId={clinicaId} clinicaName={clinicaName}/>;
      if(page==="mensagens")  return <MensagensClinicaPage pacientes={meusPacientes} clinicaId={clinicaId} clinicaName={clinicaName} euId={userType==="colaborador"?("colab:"+(userEmail||userName)):("clinica:"+clinicaId)} euNome={userType==="colaborador"?userName:(clinicaName||userName)} euTipo={userType}/>;
    ...
    if(page==="agenda")     return <DashAdmin pedidos={pedidos} clinicas={clinicas} onNavegar={(pg)=>setPage(pg)}/>;
    if(page==="pacientes")  return <PacientesPage pacientes={pacientes} setPacientes={setPacientes} isAdmin={true} clinicaId={null} clinicaName={null} planoClinica={"Enterprise"} planoIA={"admin"} pedidosReais={pedidos} abrirPacienteId={abrirPacienteId} onAbriu={()=>setAbrirPacienteId(null)}/>;
      ...
      {screen==="app" && (
        <div style={{display:"flex",minHeight:"100vh"}}>
          ...
          <div style={{flex:1,display:"flex",flexDirection:"column",minWidth:0}}>
            <Topbar title={TITLES[page]||page} sub={userEmail} clinicaName={clinicaName} isAdmin={userType==="admin"} onLogout={logout} notifDestino={userType==="paciente"?("paciente:"+pacienteId):(userType==="clinica"||userType==="colaborador")?("clinica:"+clinicaId):"admin:master"} onMenu={()=>setDrawerOpen(true)} isMobile={isMobile} onNavegar={(pg)=>setPage(pg)} notifCtx={(userType==="clinica"||userType==="colaborador")?{tipo:"clinica",clinicaId,pacientes:meusPacientes,usoIA:(planoIAefetivo==="admin"?null:IA_USO.atual(clinicaId)),limiteIA:(IA_LIMITE[planoIAefetivo]!==undefined?IA_LIMITE[planoIAefetivo]:0)+creditoExtraIA(clinicaId)}:null} buscaPacientes={(userType==="clinica"||userType==="colaborador")?meusPacientes:(userType==="admin"?pacientes:null)} onAbrirPaciente={(p)=>{ setAbrirPacienteId(p.id); setPage("pacientes"); }}/>
            ...
            <main className="fp-main" style={{flex:1,overflowY:"auto"}}><ErrorBoundary key={page}>{renderPage()}</ErrorBoundary></main>
          </div>
        </div>
      )}
    </div>
