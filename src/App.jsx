...
function ProntuarioModal({paciente,onClose,clinicaId,planoIA,pedidosReais}) {
  ...
  const ABAS = [{id:"timeline",icon:"🕒",label:"Timeline 360°"},{id:"resumo",icon:"⬡",label:"Resumo"},{id:"plano",icon:"📋",label:"Plano de Tratamento"},{id:"avaliacoes",icon:"🩺",label:"Avaliações"},{id:"evolucao",icon:"📋",label:"Evolução"},{id:"dor",icon:"📈",label:"Evolução da Dor"},{id:"pedidos",icon:"📦",label:"Pedidos"},{id:"pagamentos",icon:"💰",label:"Pagamentos"},{id:"exames",icon:"🔬",label:"Exames"},{id:"chat",icon:"💬",label:"Chat"},{id:"prescricoes",icon:"💊",label:"Prescrições"}];
