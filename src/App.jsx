...
function Topbar({title,sub,onLogout,clinicaName,isAdmin,notifDestino,onMenu,isMobile}) {
  return (
...
export default function App() {
  ...
  const renderPage = () => {
    ...
    if(userType==="clinica" || userType==="colaborador") {
      ...
      if(page==="planos") {
        return <UpgradePlano plano={planoClinica} modulo={null} clinicaNome={clinicaName}/>;
      }
      ...
      {screen==="app" && (
        <div style={{display:"flex",minHeight:"100vh"}}>
          ...
          <div style={{flex:1,display:"flex",flexDirection:"column",minWidth:0}}>
            <Topbar title={TITLES[page]||page} sub={userEmail} clinicaName={clinicaName} isAdmin={userType==="admin"} onLogout={logout} notifDestino={userType==="paciente"?("paciente:"+pacienteId):(userType==="clinica"||userType==="colaborador")?("clinica:"+clinicaId):"admin:master"} onMenu={()=>setDrawerOpen(true)} isMobile={isMobile}/>
